# Paperclip Model Benchmark — `run-20260725-214141`

_Generated 2026-07-25T20:45:59+00:00. Judge: **claude-opus** (blind, uniform). 10 runs, 0 failures._
...
|---|---|---|---|---|---|
| Grok 4.5 | 0.987 | 2.915 | 26,315 | 807 | 100% |

**→ Recommended for `ops`: Grok 4.5** — peak quality Grok 4.5 (0.987) is also the cheapest near-peak  
...
- Environment: `Paperclip benchmark harness; neutralized temp CWD; finished 2026-07-25T20:45:59+00:00`
- Records path: `benchmark/results/run-20260725-214141/report.md`, `benchmark/results/run-20260725-214141/runs.json`
- Suite hash(es): `ops=af81fcc8c8acf9b45aac20aa118d2e0116e4e875fd9b8b4e4f07df614a7bef25`
