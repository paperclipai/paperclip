# CV Review Operator File - Lean Zero-Skill R2
...
- Match the recommendation to the evidence:
  ...
  - When the CV shows adjacent relevant work but ownership or impact is unclear, choose `clarify` with targeted checks instead of `reject`; do not turn uncertainty into a negative fact.
