...
npm view aiteamcorp@canary version
```
...
```bash
AITEAMCORP_VERSION=canary ./scripts/docker-onboard-smoke.sh
```

Useful isolated variant:

```bash
HOST_PORT=3232 DATA_DIR=./data/release-smoke-canary AITEAMCORP_VERSION=canary ./scripts/docker-onboard-smoke.sh
```
