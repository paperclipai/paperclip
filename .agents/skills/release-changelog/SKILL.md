...
description: >
  Generate the stable AiTeamCorp release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** AiTeamCorp release.

## Versioning Model

AiTeamCorp uses **calendar versioning (calver)**:
