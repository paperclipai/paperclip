---
name: sprint-report-protocol
description: System runbook for company daily summaries, CEO sprint-report routine issues, and C-suite daily-delta verdict rails. Use when filing or consuming a sprint report, resolving the latest `SPRINT-REPORT CONFIRMED` source, deciding whether a routine report needs board review, or synthesizing daily role deltas into CEO verdicts.
---
