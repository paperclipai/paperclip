...
- `references/ats-data-sources.md` — local mirror of `TSKB0489` (canonical: `~/TSKB/KB/`), the verified ATS data-source cheat sheet. Check this before live web research in STEP 0 liveness verification.
