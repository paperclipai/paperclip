...
2. Use the personal company and Generalist pinned by `setup-delegate`. Never guess among companies or create infrastructure from the planning conversation. If the pinned profile is missing, tell the user to run `./setup-delegate`.
