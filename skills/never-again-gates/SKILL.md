---
name: never-again-gates
description: Compact closeout checklist distilled from TSKB0055's G-class defect register. Use before closing defect/RCA issues, submitting operator-facing review packs or masters, raising operator approvals, publishing benchmark/report artifacts, or preparing external-review evidence where repeated known failure classes must not recur.
---
