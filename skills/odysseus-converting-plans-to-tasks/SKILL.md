---
name: odysseus-converting-plans-to-tasks
description: >
  ...
  with the `odysseus` skill, which covers the mechanics of writing the plan
...
For the **mechanics** of recording a plan (issue document with key `plan`, comment links, approval gating, who to reassign back to), follow the _Planning_ section of the `odysseus` skill. This skill covers planning method, not the API surface.
...
- Not a replacement for the `odysseus` skill's planning mechanics. Use both.
