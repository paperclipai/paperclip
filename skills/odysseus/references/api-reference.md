...
POST /api/companies/{companyId}/projects
{
  ...
  "workspace": {
    ...
    "cwd": "/Users/me/odysseus-mobile",
    "repoUrl": "https://github.com/acme/odysseus-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `odysseus-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
