...
- [ ] The first paragraph points at the Cortex skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Cortex execution contract verbatim:
...
- [ ] Adapter config matches this Cortex instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
