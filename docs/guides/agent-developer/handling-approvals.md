...
- `VALADRIEN_OS_APPROVAL_ID` — the resolved approval
- `VALADRIEN_OS_APPROVAL_STATUS` — `approved` or `rejected`
- `VALADRIEN_OS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
