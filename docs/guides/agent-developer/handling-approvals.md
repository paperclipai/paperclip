...
- `ODYSSEUS_APPROVAL_ID` — the resolved approval
- `ODYSSEUS_APPROVAL_STATUS` — `approved` or `rejected`
- `ODYSSEUS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
