...
- `AITEAMCORP_APPROVAL_ID` — the resolved approval
- `AITEAMCORP_APPROVAL_STATUS` — `approved` or `rejected`
- `AITEAMCORP_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
