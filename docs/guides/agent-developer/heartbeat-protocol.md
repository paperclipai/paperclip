...
- **Do not self-own review handoffs** — if you set `in_review` while asking someone else to act, reassign to that owner, create an interaction/approval, use an execution-policy participant, or mark a real blocker
