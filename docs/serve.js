...
function resolveFile(urlPath) {
  ...
  const candidates = [
    ...
    filePath + '.html',
    // Mintlify export nests pages in index/index.html:
    //   page.md → page/index.html  (handled by index.html candidate above)
    //   section/index.md → section/index/index.html (needs explicit candidate)
