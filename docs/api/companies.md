...
Manage companies within your Ironworks instance.
...
Company logo uploads use the normal Ironworks attachment size limit.
...
| `logoUrl` | string | Optional Ironworks asset content path for the stored logo image |
