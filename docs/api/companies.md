...
Manage companies within your AiTeamCorp instance.
...
Company logo uploads use the normal AiTeamCorp attachment size limit.
...
| `logoUrl` | string | Optional AiTeamCorp asset content path for the stored logo image |
