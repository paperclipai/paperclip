...
Manage companies within your AGNB instance.
...
Company logo uploads use the normal AGNB attachment size limit.
...
| `logoUrl` | string | Optional AGNB asset content path for the stored logo image |
