...
AiTeamCorp uses PostgreSQL via Drizzle ORM. There are three ways to run the database.
...
Data persists across restarts. To reset: `rm -rf ~/.aiteamcorp/instances/default/db`.
