...
Ironworks supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Ironworks?** Use `local_trusted` (the default)
