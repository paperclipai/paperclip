...
AiTeamCorp stores uploaded files (issue attachments, images) using a configurable storage provider.
...
```
~/.aiteamcorp/instances/default/data/storage
```
...
```
~/.aiteamcorp/instances/default/config.json
```
