...
- later cleanup also covered live update toasts, workspace status chips, and activity-chart status legends so those surfaces no longer fall back to raw English status strings
