...
- `docs/ko/deploy/*.md` ✅
- `docs/ko/api/*.md` ✅
- `docs/ko/guides/{execution-policy,openclaw-docker-setup}.md` ✅
- `docs/ko/{agents-runtime,feedback-voting}.md` ✅
- `docs/ko/companies/companies-spec.md` ✅
- `docs/ko/specs/*.md` ✅
- `docs/ko/plans/2026-03-13-issue-documents-plan.md` ✅
- Root/package READMEs: `CONTRIBUTING.ko.md`, `SECURITY.ko.md`, `ROADMAP.ko.md`, `cli/README.ko.md`, `ui/README.ko.md`, `packages/mcp-server/README.ko.md`, `evals/README.ko.md` ✅
- `skills/paperclip/SKILL.ko.md` ✅
- `skills/paperclip-create-agent/SKILL.ko.md` ✅
- Remaining top-level skills `*.ko.md` ✅
