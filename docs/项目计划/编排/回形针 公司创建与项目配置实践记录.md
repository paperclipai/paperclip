...
curl -s "http://localhost:3100/api/companies/b274a212.../live-runs"
...
```
1. 确保服务器运行中 → curl localhost:3100/api/health
...
```powershell
# 查询公司全部技能配置
curl -s "http://localhost:3100/api/companies/b274a212-8add-4b6e-8e34-ff5ced668aa4/skills"
