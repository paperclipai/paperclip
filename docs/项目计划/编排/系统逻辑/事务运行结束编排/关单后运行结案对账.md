...
**代码现状：** 仍走 `cancelRunInternal` + `cancelled`（`reconcileTerminalIssueRunningRuns`，注释 HB-010）——**待按本文改造**
...
API 取证顺序仍见 [`../../../最佳实践/004-实践-工单心跳与僵尸run排障.md`](../../../最佳实践/004-实践-工单心跳与僵尸run排障.md)。
