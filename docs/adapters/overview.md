...
| [MiniMax Local](/adapters/minimax-local) | `minimax_local` | Calls the MiniMax OpenAI-compatible API directly |
...
- **Need a direct MiniMax API heartbeat?** Use `minimax_local`
