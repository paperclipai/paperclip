...
- Running a Python script that calls the AiTeamCorp API
...
1. AiTeamCorp spawns the configured command as a child process
2. Standard AiTeamCorp environment variables are injected (`AITEAMCORP_AGENT_ID`, `AITEAMCORP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the AiTeamCorp API and perform work.
