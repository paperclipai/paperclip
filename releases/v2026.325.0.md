...
- **Operator CLI authentication** — Browser-based auth flow for the CLI so operator users can authenticate without manually copying API keys. ([#1635](https://github.com/paperclipai/paperclip/pull/1635))
...
- **Migration 0044** adds operator API keys and CLI auth challenge tables for browser-based CLI auth.
