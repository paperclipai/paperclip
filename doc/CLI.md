...
cancel. Malformed IDs return HTTP 400 before database access. Unknown challenges
or incorrect challenge secrets still return HTTP 404. Approving a challenge
still requires board authentication.
