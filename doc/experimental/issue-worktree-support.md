...
- project settings:
  - [ProjectProperties.tsx](/Users/nmurray/paperclip-features-worktree-workspace-runtime-support/ui/src/components/ProjectProperties.tsx)
  - execution workspace policy controls
  - git worktree base ref / branch template / parent dir
  - provision / teardown command inputs

- issue creation:
  - [NewIssueDialog.tsx](/Users/nmurray/paperclip-features-worktree-workspace-runtime-support/ui/src/components/NewIssueDialog.tsx)
  - isolated issue checkout toggle
  - defaulting issue execution workspace settings from project policy

- issue editing:
  - [IssueProperties.tsx](/Users/nmurray/paperclip-features-worktree-workspace-runtime-support/ui/src/components/IssueProperties.tsx)
  - issue-level workspace mode toggle
  - defaulting issue execution workspace settings when project changes

- agent/runtime settings:
  - [runtime-json-fields.tsx](/Users/nmurray/paperclip-features-worktree-workspace-runtime-support/ui/src/adapters/runtime-json-fields.tsx)
