...
Low-level reference for how Ironworks packages are prepared and published to npm.
...
Ironworks no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `ironworksai`, imports code from workspace packages such as:
...
Ironworks uses calendar versions:
...
- `ironworksai@2026.318.1-canary.2`
