...
- `adapter_type` text; built-ins include `process`, `http`, `claude_local`, `codex_local`, `copilot_local`, `gemini_local`, `opencode_local`, `pi_local`, `cursor`, `hermes_local`, `hermes_gateway`, and `openclaw_gateway`
