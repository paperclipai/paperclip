...
Historical ambiguous executions were retained, not force-replayed or manually marked successful. Their old task statuses were not backfilled. Automatic crash replacement was proven only for the narrowly verified local Codex case; remote crash recovery and Claude controller-restart recovery are not claimed. Simple Claude Daytona responses remained slow in this sample. The report and selected evidence are attached as artifact work products to [FRE-8](http://127.0.0.1:3100/FRE/issues/FRE-8), with explicit limits and before/after observations. Disposable Daytona sandbox cleanup was completed.
