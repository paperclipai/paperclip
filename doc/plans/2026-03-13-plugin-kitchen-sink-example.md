...
- package: `@valadrien-os/plugin-kitchen-sink-example`
- plugin id: `valadrien-os.kitchen-sink-example` or `valadrien-os-kitchen-sink-example`

Recommendation: use `valadrien-os-kitchen-sink-example` to match current in-repo example naming style.
