...
Valadrien OS already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Valadrien OS should implement next.

## Product Goals

Valadrien OS should let operators:
...
For the next implementation pass, Valadrien OS should enforce these defaults:
...
Valadrien OS should separate subscription-included usage from billed spend:
...
Valadrien OS should have two threshold classes:
...
Valadrien OS must know that a project is budget-paused and enforce it.
...
Valadrien OS must also block execution before new work starts.
