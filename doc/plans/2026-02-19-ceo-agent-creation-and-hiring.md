...
## 8. New Skill: `valadrien-os-create-agent`

Create new skill directory:

- `skills/valadrien-os-create-agent/SKILL.md`
- `skills/valadrien-os-create-agent/references/api-reference.md`
...
Also update `skills/valadrien-os/SKILL.md` to reference this skill for hiring workflows.
...
- `valadrien-os-create-agent` skill + docs updates
