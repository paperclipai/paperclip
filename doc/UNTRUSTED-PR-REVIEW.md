...
This is intentionally separate from the normal PrivateClip dev image.
...
## Preview the PrivateClip app from the PR
...
- PrivateClip's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.paperclip-review`.
