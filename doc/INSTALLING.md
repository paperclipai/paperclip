...
After onboarding installs and starts the service, it prints the dashboard URL.
Interactive terminals wait for the service health check and then open that URL
in the default browser; headless and non-interactive runs print the URL without
