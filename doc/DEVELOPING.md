...
For company-package, agent-instruction, project, routine, and operating-process
changes, use the [company improvement verification checklist](./COMPANY-IMPROVEMENT-VERIFICATION.md)
to record what passed, what failed, and what remains risky.
