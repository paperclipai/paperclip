...
name: design-guide
description: >
  Valadrien OS UI design system guide for building consistent, reusable frontend
...
# Valadrien OS Design Guide

Valadrien OS's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Valadrien OS-specific design language.
