...
await page.goto("http://127.0.0.1:8085/#Account/list", { waitUntil: "networkidle", timeout: 30000 }).catch((e)=>errs.push(String(e)));
await page.waitForTimeout(4000);
await page.screenshot({ path: "/work/.ckshots/crm-accounts.png", fullPage: false });
