...
| v2.7 | 릴리즈 호스트 검증 및 런타임 신뢰도 | Planning | 2026-04-29 | - | Phase 44-47 planned. v2.6에서 수용한 full-suite timeout, Windows embedded Postgres skip, stale validation metadata, legacy UAT closure inconsistency를 release-host confidence gate로 닫는 milestone |
...
| Phase | Name | Requirements | Status |
|-------|------|--------------|--------|
| 44 | Release Host Verification Harness | REL-01, REL-02, REL-03 | Planned |
| 45 | Embedded Postgres Runtime Coverage | PG-01, PG-02, PG-03 | Planned |
| 46 | Artifact and UAT Truth Alignment | ART-01, ART-02, ART-03 | Planned |
| 47 | Runtime Confidence Operations Surface | CONF-01, CONF-02 | Planned |
