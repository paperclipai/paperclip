...
export PC_TEST_ROOT="${PC_TEST_ROOT:-$(mktemp -d /tmp/valadrien-os-clean-ref.XXXXXX)}"
export PC_HOME="${PC_HOME:-$PC_TEST_ROOT/home}"
export PC_CACHE="${PC_CACHE:-$PC_TEST_ROOT/npm-cache}"
export PC_DATA="${PC_DATA:-$PC_TEST_ROOT/valadrien-os-data}"
export PC_REPO="${PC_REPO:-$PC_TEST_ROOT/repo}"
export VALADRIEN_OS_HOST="${VALADRIEN_OS_HOST:-127.0.0.1}"
export VALADRIEN_OS_PORT="${VALADRIEN_OS_PORT:-3100}"
export VALADRIEN_OS_OPEN_ON_LISTEN="${VALADRIEN_OS_OPEN_ON_LISTEN:-false}"
...
echo "VALADRIEN_OS_HOST: $VALADRIEN_OS_HOST"
echo "VALADRIEN_OS_PORT: $VALADRIEN_OS_PORT"
...
env \
  ...
  HOST="$VALADRIEN_OS_HOST" \
  PORT="$VALADRIEN_OS_PORT" \
  VALADRIEN_OS_OPEN_ON_LISTEN="$VALADRIEN_OS_OPEN_ON_LISTEN" \
