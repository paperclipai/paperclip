...
cmd_candidate_tests() {
  ...
  _cand_group packages/adapter-utils src/token-budget.test.ts src/acpx-engine/execute.test.ts src/disposition-marker.test.ts src/citation-verification.test.ts
