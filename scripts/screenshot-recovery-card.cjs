...
const STORIES = [
  {
    id: "valadrien-os-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "valadrien-os-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "valadrien-os-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "valadrien-os-source-issue-recovery--active-run-panel-recovery-chips",
