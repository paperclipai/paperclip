-- Exact unique-index statement from packages/db/src/migrations/0200_fallback_monitor_terminal_guard.sql
-- Kept here so the disposable smoke proves the constraint path without loading drizzle.
