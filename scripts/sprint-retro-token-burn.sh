#!/usr/bin/env bash
# TSMC-21193 runbook wrapper — sprint-retro token-burn table (0 LLM).
# Canonical implementation: CTO scripts/deterministic-reports.py
set -euo pipefail
