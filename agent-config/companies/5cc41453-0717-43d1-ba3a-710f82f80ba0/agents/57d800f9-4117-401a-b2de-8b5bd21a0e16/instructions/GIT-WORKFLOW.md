...
```
main
  ג””ג”€ג”€ feature/ALL-XXX-brief-description   (one per parent issue)
  |     ג””ג”€ג”€ feature/ALL-YYY-child-task       (optional sub-branch for parallel child work)
  ג””ג”€ג”€ fix/ALL-XXX-brief-description        (bug fixes)
```
...
Start simple: feature branches ג†’ main. Add a `develop` integration branch only if:
