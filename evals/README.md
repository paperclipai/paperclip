...
Eval framework for testing AiTeamCorp agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the AiTeamCorp heartbeat skill:
