...
Eval framework for testing Ironworks agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Ironworks heartbeat skill:
