...
| [BUG-008](BUG-008-a4g-project-selection-and-remote-cwd.md) | A4/G | MEDIUM | Pilot scripts can wire the wrong project / silently misconfigure a remote worktree | Fixed | _this commit_ |
