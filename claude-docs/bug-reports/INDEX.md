...
| [BUG-007](BUG-007-a2-diff-only-reviewer-blind-spot.md) | A2 | LOW | Diff-only reviewer scope creates cross-file auth/concurrency blind spot | Fixed | `2a5de007` (code-reviewer, concurrent) + `054ee75e` (wiring-expert) |
| [BUG-008](BUG-008-a4g-project-selection-and-remote-cwd.md) | A4/G | MEDIUM | Pilot scripts can wire the wrong project / silently misconfigure a remote worktree | Fixed | `139ed1eb` |
| [BUG-009](BUG-009-fix-review-error-handling-hardening.md) | review | MEDIUM | Error-handling hardening from adversarial re-review of the fix set | Fixed | _this commit_ |
