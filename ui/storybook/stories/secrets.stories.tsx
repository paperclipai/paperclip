...
import type { CompanySecret, EnvBinding } from "@odysseus/shared";
...
import { storybookCompanies, storybookSecrets } from "../fixtures/odysseusData";

const COMPANY_ID = "company-storybook";

// Seed localStorage before CompanyContext mounts so its `useState` initializer reads the right id.
if (typeof window !== "undefined") {
  window.localStorage.setItem("odysseus.selectedCompanyId", COMPANY_ID);
}
