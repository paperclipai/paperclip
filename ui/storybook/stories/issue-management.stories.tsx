...
import type { Issue } from "@odysseus/shared";
...
function Section({
  ...
  return (
    <section className="odysseus-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="odysseus-story__label">{eyebrow}</div>
...
function IssueManagementStories() {
  return (
    <StorybookData>
      <div className="odysseus-story">
        <main className="odysseus-story__inner space-y-6">
          <section className="odysseus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="odysseus-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="odysseus-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="odysseus-story">
        <main className="odysseus-story__inner space-y-6">
          <section className="odysseus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="odysseus-story__label">IssueRunLedger</div>
