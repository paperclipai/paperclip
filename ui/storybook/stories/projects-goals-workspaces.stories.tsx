      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="odysseus-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="odysseus-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("odysseus-worktree-enabled", "true");
  setWorktreeMeta("odysseus-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("odysseus-worktree-color", "#0f766e");
  setWorktreeMeta("odysseus-worktree-text-color", "#ecfeff");
        ...
        <main className="odysseus-story__inner space-y-6">
          <section className="odysseus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="odysseus-story__label">Projects, goals, and workspaces</div>
