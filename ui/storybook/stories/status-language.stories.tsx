...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@odysseus/shared";
import type {
...
import { createIssue } from "../fixtures/odysseusData";
    ...
    <div className="odysseus-story">
      <main className="odysseus-story__inner space-y-6">
        <section className="odysseus-story__frame p-6">
          <div className="odysseus-story__label">Language</div>
