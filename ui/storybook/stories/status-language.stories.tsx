...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@valadrien-os/shared";
import type {
...
import { createIssue } from "../fixtures/valadrienOsData";
    ...
    <div className="valadrien-os-story">
      <main className="valadrien-os-story__inner space-y-6">
        <section className="valadrien-os-story__frame p-6">
          <div className="valadrien-os-story__label">Language</div>
