...
const foldCurtainLongMarkdown = [
  ...
  "",
  "- a **runner** that executes tasks in isolated worktrees",
  "- a **scorer** that grades outputs against ground truth",
  "- a **dashboard** that trends metrics over time",
  "",
  "## Task format",
  "",
  "Each task is a directory containing a `task.md`, an optional `setup.sh`, and an `expected/` fixture. The runner mounts the task, executes the agent, and diffs the resulting worktree against `expected/`.",
  "",
  "```ts",
  "type TaskResult = {",
  "  taskId: string;",
