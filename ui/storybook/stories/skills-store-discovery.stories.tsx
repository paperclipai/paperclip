...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    ...
    author: "Paperclip",
    version: "v2.4.1",
    tagline: "Develop and operate a local Paperclip instance.",
  ...
  },
  {
    ...
    author: "Paperclip",
    version: "v1.0.3",
    tagline: "Verify a code change works by running the app.",
  ...
  },
  {
    ...
    author: "you",
    version: "v0.1.0",
    tagline: "Generate design language skills, prosumer remix.",
  ...
  },
  {
    ...
    author: "Anthropic",
    version: "v1.6.0",
    tagline: "Build, debug and optimize Claude API apps.",
  ...
  },
  {
    ...
    author: "Paperclip",
    version: "v1.1.0",
    tagline: "Security review of pending changes on a branch.",
  ...
  },
  {
    ...
    author: "Yuki",
    version: "v3.0.1",
    tagline: "Polish commits and PR titles before review.",
  ...
  },
  {
    ...
    author: "Paperclip",
    version: "core",
    tagline: "Control plane API for tasks, routines, and coordination.",
  ...
  },
  {
    ...
    author: "Paperclip",
    version: "core",
    tagline: "Forensics for stalled or looping work trees.",
