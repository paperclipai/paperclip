...
const SELECTED_COMPANY_STORAGE_KEY = "odysseus.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "odysseus:issue-draft";
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .odysseus/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/odysseus",
    workspacePath: "/Users/dotta/odysseus/.odysseus/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/PossibLaw/odysseus");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/odysseus/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Odysseus creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
