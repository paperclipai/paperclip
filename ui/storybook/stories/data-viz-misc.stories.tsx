...
import type { HeartbeatRun, Issue } from "@odysseus/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Odysseus Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII odysseus field"}>
