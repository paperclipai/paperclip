...
import type { CompanySearchResult, CompanySearchResponse } from "@odysseus/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/odysseusData";
    ...
    <div className="odysseus-story">
      <main className="odysseus-story__inner max-w-[1320px] space-y-6">
        <section className="odysseus-story__frame p-6">
          <div className="odysseus-story__label">Search</div>
        ...
        <section className="odysseus-story__frame overflow-hidden">
          <div className="odysseus-story__title-block">
            <div className="odysseus-story__label">/search</div>
        ...
        <section className="odysseus-story__frame overflow-hidden p-4">
          <div className="odysseus-story__title-block">
            <div className="odysseus-story__label">Match-source chips</div>
        ...
        <section className="odysseus-story__frame overflow-hidden p-4">
          <div className="odysseus-story__title-block">
            <div className="odysseus-story__label">Cmd+K palette</div>
        ...
        <section className="odysseus-story__frame overflow-hidden p-4">
          <div className="odysseus-story__title-block">
            <div className="odysseus-story__label">Search result row</div>
