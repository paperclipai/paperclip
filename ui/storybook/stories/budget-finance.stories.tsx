  ...
  anthropic: [
    {
      ...
      subscriptionCacheWriteTokens: 24_000,
      subscriptionRateCardCents: 42_280,
    },
    {
      provider: "anthropic",
      biller: "anthropic",
  ...
  openai: [
    {
      ...
      subscriptionCacheWriteTokens: 18_000,
      subscriptionRateCardCents: 32_400,
    },
    {
      provider: "openai",
      biller: "openai",
      ...
      subscriptionCacheWriteTokens: 12_000,
      subscriptionRateCardCents: 37_800,
    },
  ],
  openrouter: [
    {
...
const providerWindowRows: Record<string, CostWindowSpendRow[]> = {
  anthropic: [
    { provider: "anthropic", biller: "anthropic", window: "5h", windowHours: 5, costCents: 1_240, inputTokens: 82_000, cachedInputTokens: 11_000, outputTokens: 19_000, cacheWriteTokens: 1_300, rateCardCents: 5_900 },
    { provider: "anthropic", biller: "anthropic", window: "24h", windowHours: 24, costCents: 3_870, inputTokens: 218_000, cachedInputTokens: 32_000, outputTokens: 64_000, cacheWriteTokens: 3_600, rateCardCents: 18_420 },
    { provider: "anthropic", biller: "anthropic", window: "7d", windowHours: 168, costCents: 11_240, inputTokens: 1_700_000, cachedInputTokens: 245_000, outputTokens: 477_000, cacheWriteTokens: 28_200, rateCardCents: 53_520 },
  ],
  openai: [
    { provider: "openai", biller: "openai", window: "5h", windowHours: 5, costCents: 4_920, inputTokens: 148_000, cachedInputTokens: 18_000, outputTokens: 56_000, cacheWriteTokens: 2_000, rateCardCents: 23_180 },
    { provider: "openai", biller: "openai", window: "24h", windowHours: 24, costCents: 10_430, inputTokens: 398_000, cachedInputTokens: 52_000, outputTokens: 130_000, cacheWriteTokens: 5_800, rateCardCents: 49_150 },
    { provider: "openai", biller: "openai", window: "7d", windowHours: 168, costCents: 18_900, inputTokens: 1_670_000, cachedInputTokens: 255_000, outputTokens: 568_000, cacheWriteTokens: 30_000, rateCardCents: 89_100 },
  ],
  openrouter: [
    { provider: "openrouter", biller: "openrouter", window: "5h", windowHours: 5, costCents: 7_880, inputTokens: 210_000, cachedInputTokens: 20_000, outputTokens: 73_000, cacheWriteTokens: 2_200, rateCardCents: 7_880 },
    { provider: "openrouter", biller: "openrouter", window: "24h", windowHours: 24, costCents: 14_630, inputTokens: 506_000, cachedInputTokens: 51_000, outputTokens: 150_000, cacheWriteTokens: 5_600, rateCardCents: 14_630 },
    { provider: "openrouter", biller: "openrouter", window: "7d", windowHours: 168, costCents: 31_560, inputTokens: 1_190_000, cachedInputTokens: 164_000, outputTokens: 338_000, cacheWriteTokens: 19_200, rateCardCents: 31_560 },
  ],
};
...
const billerSpendRows: Array<{
...
}> = [
  {
    ...
    row: {
      ...
      cacheWriteTokens: 28_200,
      rateCardCents: 53_520,
      apiRunCount: 7,
      subscriptionRunCount: 38,
      subscriptionCachedInputTokens: 210_000,
      subscriptionInputTokens: 1_420_000,
  ...
  },
  {
    ...
    row: {
      ...
      cacheWriteTokens: 19_200,
      rateCardCents: 31_560,
      apiRunCount: 30,
      subscriptionRunCount: 0,
      subscriptionCachedInputTokens: 0,
      subscriptionInputTokens: 0,
