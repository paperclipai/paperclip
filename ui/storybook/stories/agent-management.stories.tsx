...
import { storybookAgents, storybookIssues } from "../fixtures/odysseusData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        ODYSSEUS_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "odysseus-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="odysseus-story__inner space-y-6">
          <section className="odysseus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="odysseus-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Odysseus fixtures.",
      },
    },
  },
