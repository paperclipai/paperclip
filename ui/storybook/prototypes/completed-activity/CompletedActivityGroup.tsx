// Storybook-only proposal. Production task UI remains unchanged.
import { useId, useState } from "react";
import { completedActivitySummary } from "./completed-summary";
import {
  Brain,
  ChevronDown,
  ChevronRight,
...
import { useTaskChatExpansion } from "@/components/task-chat/expansion-state";
...
} from "@/components/task-chat/task-chat-activity-presentation";
import {
  TaskChatProtocolActivityDetails,
  hasTaskChatProtocolActivityDetails,
} from "@/components/task-chat/TaskChatProtocolActivityRow";
import { TaskChatUsageReadout } from "@/components/task-chat/TaskChatUsageReadout";
...
export function CompletedActivityGroup({
  item,
