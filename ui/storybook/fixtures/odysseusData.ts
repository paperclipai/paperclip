...
const storybookRepoRoot = "~/odysseus";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.odysseus/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.odysseus/worktrees`;

export const storybookCompanies: Company[] = [
  {
    id: "company-storybook",
    name: "Odysseus Storybook",
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Odysseus product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: "company-storybook",
    title: "Build Odysseus",
    description: "Make Odysseus the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @odysseus/ui typecheck",
      cwd: ".",
    },
  ],
};
...
export const storybookProjectWorkspaces: Project["workspaces"] = [
  {
    ...
    repoUrl: "https://github.com/PossibLaw/odysseus",
    repoRef: "master",
    defaultRef: "master",
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://odysseus-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".odysseus/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/odysseusData.ts`.",
  ].join("\n"),
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:odysseus/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
...
export const storybookSecretBindings: CompanySecretBinding[] = [
  ...
  },
  {
    ...
    versionSelector: "latest",
    required: true,
    label: "Odysseus App project env",
    createdAt: new Date("2026-03-02T09:00:00.000Z"),
    updatedAt: new Date("2026-03-02T09:00:00.000Z"),
  },
  {
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.odysseus/instances/default/secrets/key separately from the database."],
    },
    {
