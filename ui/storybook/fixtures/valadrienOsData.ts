...
const storybookRepoRoot = "~/valadrien-os";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.valadrien-os/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.valadrien-os/worktrees`;

export const storybookCompanies: Company[] = [
  {
    id: "company-storybook",
    name: "ValadrienOs Storybook",
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack ValadrienOs product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make ValadrienOs the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @valadrien-os/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://valadrien-os-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".valadrien-os/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/valadrienOsData.ts`.",
  ].join("\n"),
...
export const storybookSecretProviderDiscoveryPreview: SecretProviderConfigDiscoveryPreviewResult = {
  ...
  warnings: ["Skipped 1 ValadrienOs-managed AWS secret from a different deployment namespace."],
  candidates: [
    {
      provider: "aws_secrets_manager",
      displayName: "AWS production",
      ...
      samples: [
        {
          name: "valadrien-os/prod-use1/company-storybook/openai_api_key",
          hasKmsKey: true,
          tagKeys: ["valadrien-os:managed-by", "valadrien-os:environment", "valadrien-os:provider-owner"],
        },
      ],
      signals: {
        namespace: "prod-use1",
        ...
        hasKmsKey: true,
        sampleCount: 5,
        valadrienOsManagedSampleCount: 5,
        skippedForeignValadrienOsSampleCount: 1,
      },
      warnings: [],
    },
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:valadrien-os/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
...
export const storybookSecretBindings: CompanySecretBinding[] = [
  ...
  },
  {
    ...
    versionSelector: "latest",
    required: true,
    label: "ValadrienOs App project env",
    createdAt: new Date("2026-03-02T09:00:00.000Z"),
    updatedAt: new Date("2026-03-02T09:00:00.000Z"),
  },
  {
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.valadrien-os/instances/default/secrets/key separately from the database."],
    },
    {
