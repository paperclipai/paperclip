...
function createRuntimeService(
  ...
  return {
    ...
    startedByAgentId: overrides.startedByAgentId ?? "agent-codex",
    startedByUserId: overrides.startedByUserId ?? null,
    responsibleUserId: overrides.responsibleUserId ?? "user-storybook",
    lastControlledByAgentId: overrides.lastControlledByAgentId ?? "agent-codex",
    lastControlledByUserId: overrides.lastControlledByUserId ?? null,
    lastControlledByRunId: overrides.lastControlledByRunId ?? "run-storybook",
    lastControlledAt: overrides.lastControlledAt ?? recent(4),
