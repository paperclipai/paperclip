                            ...
                            {dashboardData.recentJobRuns.map((run) => (
                              ...
                              >
                                ...
                                <div className="flex shrink-0 items-center gap-2 text-xs text-muted-foreground">
                                  ...
                                  <span title={run.createdAt}>{fmtRelativeTime(getActiveLocale(), run.createdAt)}</span>
                                </div>
                              </div>
                            ))}
                          </div>
                            ...
                            {dashboardData.recentWebhookDeliveries.map((delivery) => (
                              ...
                              >
                                ...
                                <div className="flex shrink-0 items-center gap-2 text-xs text-muted-foreground">
                                  ...
                                  <span title={delivery.createdAt}>{fmtRelativeTime(getActiveLocale(), delivery.createdAt)}</span>
                                </div>
                              </div>
                            ))}
                          </div>
