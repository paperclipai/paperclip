...
const PROJECT_SORT_OPTIONS: Array<{ field: ProjectSortField; labelKey: string }> = [
  ...
  { field: "updated", labelKey: "common.updated" },
  { field: "created", labelKey: "common.created" },
  { field: "targetDate", labelKey: "common.targetDate" },
];
...
export function Projects() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("navigation.projects") }]);
  }, [setBreadcrumbs, t]);
  ...
  const sortLabel = t(PROJECT_SORT_OPTIONS.find((option) => option.field === sortField)?.labelKey ?? "common.name");
