              ...
              <section key={label} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {t(sectionProjects.length === 1 ? "projects.projectCountOne" : "projects.projectCountMany", { count: sectionProjects.length })}
                  </span>
                </div>
                        ...
                        trailing={
                          <div className="flex items-center gap-3">
                            <span
                              ...
                              title={t((project.taskCount ?? 0) === 1 ? "projects.taskCountOne" : "projects.taskCountMany", { count: formatNumber(project.taskCount ?? 0) })}
                            >
                              {t((project.taskCount ?? 0) === 1 ? "projects.taskCountOne" : "projects.taskCountMany", { count: formatNumber(project.taskCount ?? 0) })}
                            </span>
                            {project.budget && (
