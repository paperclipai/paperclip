...
import { formatCents, statusDisplayName } from "../lib/utils";
...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("nav.company") }]);
  }, [setBreadcrumbs, t]);
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                  {isEditing ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {statusDisplayName(company.status)}
                      </span>
                      <Button
                        variant="ghost"
                        size="icon-xs"
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t(agentCount === 1 ? "companies.agent_count_one" : "companies.agent_count_other", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t(issueCount === 1 ? "companies.issue_count_one" : "companies.issue_count_other", { count: issueCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("common.unlimited_budget")}</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>{t("common.created_at_relative", { value: formatRelativeTime(company.createdAt) })}</span>
                </div>
              </div>
