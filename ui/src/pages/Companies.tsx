            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("companies.agent_count", {
                      count: agentCount,
                      label: agentCount === 1 ? t("companies.agent.singular") : t("companies.agent.plural"),
                    })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("companies.issue_count", {
                      count: issueCount,
                      label: issueCount === 1 ? t("companies.issue.singular") : t("companies.issue.plural"),
                    })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.created", { relative: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
