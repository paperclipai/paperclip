...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.companies.breadcrumb", { defaultValue: "Companies" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("pages.companies.loading", { defaultValue: "Loading companies..." })}</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("pages.companies.agentCount", { count: agentCount, defaultValue: "{{count}} agent" })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t("pages.companies.taskCount", { count: issueCount, defaultValue: "{{count}} task" })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("pages.companies.created", { time: relativeTime(company.createdAt), defaultValue: "Created {{time}}" })}</span>
                </div>
              </div>
