            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("companies.agentCount", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t("companies.issueCount", { count: issueCount })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.createdAt", { relativeTime: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
