            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t(agentCount === 1 ? "companies.agentOne" : "companies.agentMany", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t(issueCount === 1 ? "companies.taskOne" : "companies.taskMany", { count: issueCount })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.created", { time: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
