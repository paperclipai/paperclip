    ...
    <div className="mx-auto max-w-xl rounded-2xl border border-border bg-card p-8">
      ...
      <div className="mt-8">
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          The token is part of the URL. Cortex stores it securely and checks the connection before enabling actions.
        </p>
        ...
        {filtered.map((app) => {
          ...
          return (
            <button
              ...
              title={
                unavailable
                  ? `${app.name} isn't configured on this instance yet. Ask your Cortex admin.`
                  : undefined
              }
              onClick={() => onPick(app)}
              className={cn(
      ...
      <div className="border-t border-border pt-5">
        ...
        <div className="mt-3 flex flex-col gap-2">
          <ConnectMethodRow
            icon={TerminalSquare}
            title="Run your own"
            description="Register a command Cortex runs in your workspace for a tool that isn’t listed."
        ...
        <div className="mt-6 space-y-3">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Anyone you’ve added to Cortex can use {appName} in their tasks. This is what most teams want.
              </p>
            </div>
          </button>
