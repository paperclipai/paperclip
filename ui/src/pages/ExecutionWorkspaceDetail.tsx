  ...
  return (
    <div className="max-w-2xl space-y-4">
      <div className="space-y-1">
        <div className="text-xs text-muted-foreground">{t("executionWorkspace.subtitle")}</div>
      ...
      <div className="rounded-lg border border-border p-4">
        <DetailRow label={t("executionWorkspace.projectLabel")}>
        ...
        <DetailRow label={t("executionWorkspace.sourceIssueLabel")}>
        ...
        <DetailRow label={t("executionWorkspace.branchLabel")}>{workspace.branchName ?? t("executionWorkspace.none")}</DetailRow>
        <DetailRow label={t("executionWorkspace.baseRefLabel")}>{workspace.baseRef ?? t("executionWorkspace.none")}</DetailRow>
        <DetailRow label={t("executionWorkspace.workingDirLabel")}>
          <span className="break-all font-mono text-xs">{workspace.cwd ?? t("executionWorkspace.none")}</span>
        </DetailRow>
        <DetailRow label={t("executionWorkspace.providerRefLabel")}>
          <span className="break-all font-mono text-xs">{workspace.providerRef ?? t("executionWorkspace.none")}</span>
        </DetailRow>
        <DetailRow label={t("executionWorkspace.repoUrlLabel")}>
        ...
        <DetailRow label={t("executionWorkspace.openedLabel")}>{new Date(workspace.openedAt).toLocaleString()}</DetailRow>
        <DetailRow label={t("executionWorkspace.lastUsedLabel")}>{new Date(workspace.lastUsedAt).toLocaleString()}</DetailRow>
        <DetailRow label={t("executionWorkspace.cleanupLabel")}>
