...
import type { CompanySecret, EnvBinding, McpServersConfig } from "@paperclipai/shared";
import {
  BookOpen,
  Bot,
  Check,
          ...
          <SubSection title="App components">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                "PropertiesPanel", "Sidebar", "CommandPalette", "McpServersEditor", "EnvironmentVariablesEditor",
