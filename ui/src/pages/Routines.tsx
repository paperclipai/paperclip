      ...
      <div className="min-w-0 flex-1 space-y-1.5">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
          ...
          <span>
            ...
            {routine.lastRun ? ` · ${formatRoutineRunStatusLabel(routine.lastRun.status)}` : ""}
          </span>
        </div>
      </div>
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Orchestrero could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Orchestrero could not start the routine run.",
        tone: "error",
      });
    },
  });
  ...
  const deleteRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Orchestrero could not delete the routine.",
        tone: "error",
      });
    },
  });
        ...
        >
                ...
                <CollapsibleContent className="pt-3">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">{ROUTINE_CONCURRENCY_POLICY_DESCRIPTIONS[draft.concurrencyPolicy]}</p>
                    </div>
                    <div className="space-y-2">
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, Orchestrero takes you straight to trigger setup for schedules, webhooks, or internal runs.
            </div>
