          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {logoUrl && (
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {clearLogoMutation.isPending ? t("common.removing") : t("settings.removeLogo")}
                      </Button>
                    </div>
                  )}
              ...
              <Field
                ...
                hint={t("settings.attachmentLimitHint", { max: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
              >
                <div className="flex flex-col gap-1.5">
                  ...
                  {!attachmentMaxValid && (
                    <span className="text-xs text-destructive">
                      {t("settings.attachmentLimitInvalid", { max: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
                    </span>
                  )}
                </div>
              </Field>
      ...
      <div className="space-y-4" data-testid="company-settings-invites-section">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            ...
            <HintIcon text={t("settings.invitesHint")} />
          </div>
            ...
            >
              ...
              <div className="mt-1 space-y-1.5">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {snippetCopied ? t("common.copiedSnippet") : t("common.copySnippet")}
                  </Button>
                </div>
              </div>
            </div>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("settings.packagesMoveNotice")}{" "}
            <a href="/org" className="underline hover:text-foreground">{t("orgChart.title")}</a> {t("settings.packagesMoveNoticeSuffix")}.
          </p>
            ...
            {archiveMutation.isError && (
              <span className="text-xs text-destructive">
                {archiveMutation.error instanceof Error
                  ...
                  : t("common.failedToArchiveCompany")}
              </span>
            )}
          </div>
        </div>
