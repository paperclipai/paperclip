    ...
    onSuccess: (result, request) => {
      ...
      setRuntimeActionMessage(
        request.action === "run"
          ...
          : request.action === "stop"
            ? t("page.projectWorkspaceDetail.runtimeAction.serviceStopped")
            : request.action === "restart"
              ? t("page.projectWorkspaceDetail.runtimeAction.serviceRestarted")
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="inline-flex items-center rounded-full border border-border bg-background px-2.5 py-1 text-xs text-muted-foreground">
          {workspace.isPrimary ? t("page.projectWorkspaceDetail.primaryWorkspace") : t("page.projectWorkspaceDetail.secondaryWorkspace")}
        </div>
      </div>
