...
function LiveRunIndicator({
  ...
  return (
    <Link
      ...
      className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-(--status-task-in_progress)/10 hover:bg-(--status-task-in_progress)/20 transition-colors no-underline"
    ...
    >
      ...
      <span className="text-(length:--text-micro) font-medium text-(--status-task-in_progress)">
