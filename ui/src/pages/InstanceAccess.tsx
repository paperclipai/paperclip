...
export function InstanceAccess() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("instanceNav.title"), href: "/instance/settings/general" },
      { label: t("instanceAccess.breadcrumb") },
    ]);
  }, [setBreadcrumbs, t]);
  ...
  const setAdminMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("instanceAccess.roleUpdated"), tone: "success" });
    },
  });
    ...
    const message =
      usersQuery.error instanceof ApiError && usersQuery.error.status === 403
        ...
        : usersQuery.error instanceof Error
          ...
          : t("instanceAccess.loadUsersFailed");
        ...
        <section className="space-y-4 rounded-xl border border-border bg-card p-5">
          {!selectedUserId ? (
            ...
            <div className="text-sm text-destructive">
              {userAccessQuery.error instanceof Error ? userAccessQuery.error.message : t("instanceAccess.loadUserAccessFailed")}
            </div>
          ) : (
            <>
              ...
              <div className="space-y-3">
                <div>
                  <h2 className="text-sm font-semibold">{t("instanceAccess.companyAccessTitle")}</h2>
