...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Odysseus secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a odysseus secret already uses this");
  ...
  it("renders sanitized preview provider errors without raw AWS exception text", async () => {
    const rawProviderMessage =
      "AccessDeniedException: User: arn:aws:sts::123456789012:assumed-role/prod/Odysseus is not authorized";
