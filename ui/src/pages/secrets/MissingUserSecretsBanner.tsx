      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
            ...
            {missing.map((entry) => (
              ...
              >
                <span className="min-w-0 truncate">
                  ...
                  <code className="text-(length:--fs-11) text-muted-foreground">{entry.definition.key}</code>
                </span>
          ...
          {secretsPath ? (
            <Link
              to={secretsPath}
              className="mt-2 inline-block text-(length:--fs-11) font-medium underline underline-offset-2"
            >
