    ...
    >
      <div className="min-w-0 flex-1">
        <div className="flex min-w-0 flex-wrap items-center gap-2">
          ...
          {disabledDefinition ? (
            <Badge variant="outline" className="text-(length:--fs-10)">
              {definition.status}
            </Badge>
          ) : null}
        </div>
        ...
        {definition.usageGuidance ? (
          <p className="mt-1 text-(length:--fs-11) text-muted-foreground/80">{definition.usageGuidance}</p>
        ) : null}
      </div>

      <div className="flex shrink-0 items-center gap-2">
        <Badge variant="outline" className={cn("text-(length:--fs-11)", myValueTone(state))}>
          {myValueLabel(state)}
        </Badge>
        {!disabledDefinition ? (
