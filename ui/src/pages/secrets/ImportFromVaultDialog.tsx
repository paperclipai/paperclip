    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {grouped.created.length > 0 && (
          <ResultGroup label={t("secrets.importStates.created")} rows={grouped.created} draftLookup={draftLookup} />
        )}
        {grouped.skipped.length > 0 && (
          <ResultGroup label={t("secrets.importStates.skipped")} rows={grouped.skipped} draftLookup={draftLookup} />
        )}
        {grouped.failed.length > 0 && (
          <ResultGroup label={t("secrets.importStates.failed")} rows={grouped.failed} draftLookup={draftLookup} />
        )}
      </div>
    </div>
  );
