...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("pages.goalDetail.breadcrumbGoals", { defaultValue: "Goals" }), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("pages.goalDetail.breadcrumbGoal", { defaultValue: "Goal" }) }
    ]);
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <InlineEditor
          ...
          placeholder={t("pages.goalDetail.descriptionPlaceholder", { defaultValue: "Add a description..." })}
          multiline
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("pages.goalDetail.tabSubGoals", { count: childGoals.length, defaultValue: "Sub-Goals ({{count}})" })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("pages.goalDetail.tabProjects", { count: linkedProjects.length, defaultValue: "Projects ({{count}})" })}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          <div className="flex items-center justify-start">
            ...
            >
              ...
              {t("pages.goalDetail.addSubGoal", { defaultValue: "Sub Goal" })}
            </Button>
          </div>
          {childGoals.length === 0 ? (
