...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: goal?.title ?? goalId ?? t("pages.goalDetail.goal", { defaultValue: "Goal" }) }
    ]);
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <InlineEditor
          ...
          placeholder={t("pages.goalDetail.addDescriptionPlaceholder", { defaultValue: "Add a description..." })}
          multiline
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("pages.goalDetail.subGoals", { defaultValue: "Sub-Goals ({{count}})", count: childGoals.length })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("pages.goalDetail.projects", { defaultValue: "Projects ({{count}})", count: linkedProjects.length })}
          </TabsTrigger>
        </TabsList>
