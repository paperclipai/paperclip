...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Toca da IA](https://tocadaia.ai) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Toca da IA](https://tocadaia.ai) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
