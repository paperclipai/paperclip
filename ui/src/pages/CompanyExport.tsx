...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [All Gas No Brakes](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [All Gas No Brakes](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
