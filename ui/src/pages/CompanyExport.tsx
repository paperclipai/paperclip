 ...
 * renderYamlBlock.
 */
function filterIronworksYaml(yaml: string, checkedFiles: Set<string>): string {
...
export function CompanyExport() {
  ...
  // Recompute .ironworks.yaml and README.md content whenever checked files
