    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full gap-0 p-0 sm:max-w-xl">
        <SheetHeader className="border-b border-border">
          ...
          <SheetDescription>Pick an agent and an action to see what Cortex would do.</SheetDescription>
        </SheetHeader>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">When you approve an Ask-first request, Cortex can remember the decision.</p>
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                {confirm.kind === "delete-rule"
                  ...
                  : "Cortex will ask again the next time this action needs approval."}
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
