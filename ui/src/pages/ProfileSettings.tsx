...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@aiteamcorp/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in AiTeamCorp file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into AiTeamCorp storage.";
