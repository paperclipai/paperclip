...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.orgChart.breadcrumb", { defaultValue: "Org Chart" }) }]);
  }, [setBreadcrumbs, t]);
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {t("pages.orgChart.importCompany", { defaultValue: "Import company" })}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {t("pages.orgChart.exportCompany", { defaultValue: "Export company" })}
          </Button>
        </Link>
      </div>
      <div
