...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("selectCompanyOrgChart", { defaultValue: "Select a company to view the org chart." })} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("noOrgHierarchy", { defaultValue: "No organizational hierarchy defined." })} />;
  }
    ...
    <div className="mb-2 flex items-center justify-start gap-2 shrink-0">
      <Link to="/company/import">
        <Button variant="outline" size="sm">
          ...
          {t("importCompany", { defaultValue: "Import company" })}
        </Button>
      </Link>
      <Link to="/company/export">
        <Button variant="outline" size="sm">
          <Download className="mr-1.5 h-3.5 w-3.5" />
          {t("exportCompany", { defaultValue: "Export company" })}
        </Button>
      </Link>
    </div>
    <div
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-1">
        ...
        <button
          ...
          title={t("fitToScreen", { defaultValue: "Fit to screen" })}
          aria-label={t("fitChartToScreen", { defaultValue: "Fit chart to screen" })}
        >
