...
export function Issues() {
  ...
  const issuesLabel = t("sidebar.issues", { defaultValue: "Issues" });
  const issueLinkState = useMemo(
    ...
    [location.pathname, location.search, location.hash, issuesLabel],
  );

  useEffect(() => {
    setBreadcrumbs([{ label: issuesLabel }]);
  }, [setBreadcrumbs, issuesLabel]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={CircleDot} message={t("issues.selectCompany", { defaultValue: "Select a company to view issues." })} />;
  }
