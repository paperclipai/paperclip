...
export function Issues() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("app.pages.tasks", { defaultValue: "Tasks" }) }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={CircleDot} message={t("app.issues.selectCompany", { defaultValue: "Select a company to view tasks." })} />;
  }
