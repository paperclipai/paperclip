    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-2 text-(length:--fs-10) font-semibold uppercase tracking-(--ls-0_18) text-muted-foreground">
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-3 text-(length:--fs-10) font-semibold uppercase tracking-(--ls-0_18) text-muted-foreground">
              Active run — shimmer
            </div>
