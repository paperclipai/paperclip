...
export function Dashboard() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("dashboard.dashboardTitle") }]);
  }, [setBreadcrumbs]);
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-900/70 dark:text-red-100/70">
                    {t("dashboard.agentsPausedDetail", { agents: data.budgets.pausedAgents, projects: data.budgets.pausedProjects, approvals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
