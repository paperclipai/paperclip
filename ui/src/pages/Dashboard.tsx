    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={t("dashboard.welcomeTitle")}
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.budgetStatus", { agents: data.budgets.pausedAgents, projects: data.budgets.pausedProjects, approvals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.agentsStatus", { running: data.agents.running, paused: data.agents.paused, error: data.agents.error })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.tasksStatus", { open: data.tasks.open, blocked: data.tasks.blocked })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? t("dashboard.overridesAwaiting", { count: data.budgets.pendingApprovals })
