        ...
        <>
                  ...
                  <p className="text-sm font-medium text-red-50">
                    {t(
                      data.budgets.activeIncidents === 1
                        ? "dashboard.active_budget_incidents_one"
                        : "dashboard.active_budget_incidents_other",
                      { count: data.budgets.activeIncidents },
                    )}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.paused_agents_projects", {
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.running_paused_errors", {
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? t("dashboard.budget_overrides_pending", { count: data.budgets.pendingApprovals })
