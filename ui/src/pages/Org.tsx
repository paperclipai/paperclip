...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("pages.org.breadcrumbOrgChart", { defaultValue: "Org Chart" }) },
    ]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return (
      <EmptyState
        icon={GitBranch}
        message={t("pages.org.selectCompany", {
          defaultValue: "Select a company to view org chart.",
        })}
      />
    );
  }
