...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("org.breadcrumb", "Org Chart") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("org.empty.selectCompany", "Select a company to view org chart.")} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("org.empty.none", "No agents in the organization. Create agents to build your org chart.")}
        />
      )}
