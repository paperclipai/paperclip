...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("app.org.selectCompanyOrgChart", { defaultValue: "Select a company to view org chart." })} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("app.org.noAgentsOrgChart", { defaultValue: "No agents in the organization. Create agents to build your org chart." })}
        />
      )}
