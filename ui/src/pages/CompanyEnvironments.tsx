    ...
    <div className="mt-3 rounded-md border border-border/70 bg-background" data-testid={`custom-image-terminal-${sessionId}`}>
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border/60 px-3 py-2">
        <div className="flex min-w-0 items-center gap-2 text-xs">
          ...
          <span className="font-medium">{t("company-environments.browser-terminal-oth")}</span>
        ...
        <div className="flex items-center gap-2">
          {terminalInteractive ? (
            <Button size="sm" variant="ghost" onClick={disconnectTerminal}>
              {t("company-environments.disconnect-1om")}
            </Button>
          ) : (
            <Button
              size="sm"
      ...
      <div className="bg-neutral-950 p-2 focus-within:ring-2 focus-within:ring-ring">
        <div
          ...
          aria-label={t("company-environments.custom-image-browser-terminal-1ui")}
          role="application"
          tabIndex={0}
  ...
  if (overviewQuery.isLoading) {
    return (
      <div className="mt-3 border-t border-border/60 pt-3 text-xs text-muted-foreground">
        {t("company-environments.loading-template-setup-9wx")}
      </div>
    );
  }
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              {t("company-environments.finished-1aj")}
            </Button>
            <Button
              size="sm"
              variant="ghost"
            ...
            >
              ...
              {t("company-environments.cancel-ew9")}
            </Button>
          </div>
        </div>
        {isCapturing ? (
          <div className="mt-2 text-xs text-muted-foreground">
            {t("company-environments.capture-is-in-progress-if-this-state-dlo")}
          </div>
        ) : null}
        ...
        {session.status === "waiting_for_user" && connectionCommand ? (
          <details className="mt-2 rounded-md border border-border/60 bg-muted/20 px-3 py-2 text-xs text-muted-foreground">
            <summary className="cursor-pointer select-none font-medium text-foreground">
              {t("company-environments.ssh-command-fallback-1ux")}
            </summary>
  ...
  if (activeTemplate) {
    ...
    return (
      <div className="mt-3 border-t border-border/60 pt-3" data-testid={`custom-image-template-state-${environment.id}`}>
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0 space-y-1">
            <div className="text-xs font-medium">{t("company-environments.active-template-v61")}</div>
            <div className="text-xs text-muted-foreground">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              {t("company-environments.refresh-28r")}
            </Button>
            <Button
              size="sm"
              variant="outline"
            ...
            >
              ...
              {t("company-environments.relink-1xh")}
            </Button>
            <Button
              size="sm"
              variant="ghost"
            ...
            >
              ...
              {t("company-environments.rollback-wwr")}
            </Button>
            <Button
              size="sm"
              variant="ghost"
            ...
            >
              ...
              {t("company-environments.disable-1yk")}
            </Button>
          </div>
        </div>
      </div>
    ...
    <div className="mt-3 border-t border-border/60 pt-3" data-testid={`custom-image-template-state-${environment.id}`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          <div className="text-xs font-medium">{t("company-environments.not-configured-4tq")}</div>
          <div className="text-xs text-muted-foreground">
            {latestSession
        ...
        >
          ...
          {t("company-environments.configure-image-1nu")}
        </Button>
      </div>
    </div>
  );
...
export function CompanyEnvironments({ mode = "list" }: CompanyEnvironmentsProps) {
  ...
  if (!selectedCompanyId) {
    return <div className="text-sm text-muted-foreground">{t("company-environments.select-an-organization-context-to-ma-ciw")}</div>;
  }
    ...
    return (
      <div className="max-w-6xl space-y-4">
        <div className="text-sm text-muted-foreground">
          {t("company-environments.enable-environments-in-instance-expe-4ne")}
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl space-y-6" data-testid="instance-settings-environments-section">
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <label className="flex flex-wrap items-center gap-3 text-sm font-medium">
            <span>{t("company-environments.default-76b")}</span>
            <span>
              <select
                aria-label={t("company-environments.default-environment-1h4")}
                ...
                {managedSandboxOnly ? (
                  ...
                  instanceDefaultEnvironmentId === "" ? (
                    <option value="" disabled>
                      {t("company-environments.select-environment-11f")}
                    </option>
                  ) : null
                ) : (
                  <option value="">{t("company-environments.local-bah")}</option>
                )}
          ...
          <Button size="icon-sm" variant="ghost" asChild>
            <Link to={`${ENVIRONMENTS_PATH}/new`} aria-label={t("company-environments.add-environment-m83")} title={t("company-environments.add-environment-m83")}>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="space-y-1">
                    <div className="flex flex-wrap items-center gap-2 text-sm font-medium">
                      ...
                      {isPlatformManagedEnvironment(environment) ? (
                        <span className="inline-flex items-center gap-1 rounded-full bg-muted px-2 py-0.5 text-xs font-normal text-muted-foreground">
                          ...
                          {t("company-environments.managed-by-paperclip-17x")}
                        </span>
                      ) : null}
                    </div>
                    ...
                    {environment.driver === "ssh" ? (
                      ...
                      <div className="text-xs text-muted-foreground">{t("company-environments.runs-on-this-paperclip-host-qks")}</div>
                    )}
                  </div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Button size="sm" variant="ghost" asChild>
                      <Link to={environmentEditPath(environment.id)}>{t("company-environments.edit-1i1")}</Link>
                    </Button>
                  </div>
                </div>
                {probe ? (
      ...
      {isEnvironmentFormPage && mode === "edit" && environments === undefined ? (
        <div className="text-sm text-muted-foreground">
          {t("company-environments.loading-environment-t1g")}
        </div>
      ) : null}

      {isEnvironmentFormPage && mode === "edit" && environments !== undefined && !editingEnvironment ? (
        <div className="space-y-3 text-sm">
          <div className="font-medium">{t("company-environments.environment-not-found-1qf")}</div>
          <div className="text-muted-foreground">{t("company-environments.the-environment-may-have-been-remove-1f0")}</div>
          <Button size="sm" variant="outline" asChild>
            <Link to={ENVIRONMENTS_PATH}>{t("company-environments.back-to-environments-1oa")}</Link>
          </Button>
        </div>
      ) : null}
        ...
        <div data-testid="managed-environment-form-page">
          <div className="pb-4">
            <div className="mb-4">
              <Button size="sm" variant="ghost" asChild>
                <Link to={ENVIRONMENTS_PATH}>
                  ...
                  {t("company-environments.environments-avv")}
                </Link>
              </Button>
            </div>
            <div className="flex flex-wrap items-center gap-2">
            ...
            <p className="mt-1 max-w-3xl text-xs text-muted-foreground">
              {t("company-environments.this-environment-is-provisioned-and-111")}
            </p>
          </div>
          <div className="py-4">
            <Field
              label={t("company-environments.environment-variables-178")}
      ...
      (mode === "create" || (editingEnvironment && !isPlatformManagedEnvironment(editingEnvironment))) ? (
        ...
        <div data-testid="environment-form-page">
          <div className="pb-4">
            <div className="mb-4 flex items-center justify-between gap-2">
              ...
              {editingEnvironment ? (
                <Button
                  ...
                  title={t("company-environments.delete-environment-1n3")}
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              {t("company-environments.configure-a-reusable-execution-targe-oc8")}
            </p>
          </div>

          <div className="py-4">
            <div className="space-y-4">
              <Field label={t("company-environments.name-4el")} hint="Operator-facing name for this execution target.">
                <input
              ...
              <Field label={t("company-environments.description-sjj")} hint="Optional note about what this machine is for.">
                <input
                  className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                  type="text"
              ...
              <Field label={t("company-environments.driver-1n5")} hint="Sandbox stores plugin-backed provider config on the shared environment seam. SSH stores a remote machine target.">
                <select
                  className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                ...
                >
                  {sandboxCreationEnabled || environmentForm.driver === "sandbox" ? (
                    <option value="sandbox">{t("company-environments.sandbox-1v0")}</option>
                  ) : null}
                  <option value="ssh">SSH</option>
                  {environmentForm.driver === "local" ? (
                    <option value="local">{t("company-environments.local-bah")}</option>
                  ) : null}
                </select>
              </Field>
              ...
              {environmentForm.driver === "ssh" ? (
                <div className="grid gap-3 md:grid-cols-2">
                  <Field label={t("company-environments.host-dd4")} hint="DNS name or IP address for the remote machine.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="text"
                  ...
                  <Field label={t("company-environments.port-1qx")} hint="Defaults to 22.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="number"
                      min={1}
                  ...
                  <Field label={t("company-environments.username-7s1")} hint="SSH username.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="text"
                  ...
                  */}
                  <Field label={t("company-environments.remote-workspace-path-19s")} hint="Absolute path that Paperclip will verify during SSH connection tests.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="text"
                  ...
                  <Field label={t("company-environments.private-key-d57")} hint="Optional PEM private key. Leave blank to rely on the server's SSH agent or default keychain.">
                    <div className="space-y-2">
                      ...
                      >
                        <option value="">{t("company-environments.no-saved-secret-1zp")}</option>
                        {(secrets ?? []).map((secret) => (
                  ...
                  <Field label={t("company-environments.known-hosts-1ju")} hint="Optional known_hosts block used when strict host key checking is enabled.">
                    <textarea
                      className="h-32 w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-xs font-mono outline-none"
                  ...
                  <div className="md:col-span-2">
                    <ToggleField
                      label={t("company-environments.strict-host-key-checking-ruz")}
              ...
              {environmentForm.driver === "sandbox" ? (
                <div className="space-y-3">
                  <Field label={t("company-environments.provider-evz")} hint="Installed run-capable sandbox provider plugins appear here.">
                    <select
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                  ...
                  {selectedSandboxSchema ? (
                    ...
                    <div className="text-xs text-muted-foreground">
                      {t("company-environments.this-provider-does-not-declare-addit-1ws")}
                    </div>
                  )}
                  <ToggleField
                    label={t("company-environments.stream-run-logs-1ch")}
              ...
              selectedCompanyId ? (
                <div className="space-y-2 py-3">
                  <div className="text-sm font-medium">{t("company-environments.custom-image-1wr")}</div>
                  <div className="text-xs text-muted-foreground">
                    {t("company-environments.start-a-setup-sandbox-ssh-in-to-cust-sfb")}
                  </div>
          ...
          {editingEnvironment ? (
            ...
            >
              <AlertDialogContent data-testid="environment-delete-dialog">
                <AlertDialogHeader>
                  <AlertDialogTitle>{t("company-environments.delete-oay")} {editingEnvironment.name}?</AlertDialogTitle>
                  <AlertDialogDescription>
                    {deleteUsageLoading
                ...
                {reusableLeaseHolderGroups.length > 0 ? (
                  <div className="space-y-1.5" data-testid="environment-delete-lease-holders">
                    <div className="text-xs font-medium text-muted-foreground">{t("company-environments.sandbox-leases-held-by-1ry")}</div>
                    ...
                    {agentsUsingEnvironment.length > 0 ? (
                      <label className="block space-y-1.5 text-sm">
                        <span className="font-medium">
                          {t("company-environments.reassign-14w")} {agentsUsingEnvironment.length === 1 ? "agent" : "agents"} to
                        </span>
                        <select
                          aria-label={t("company-environments.reassign-agents-to-environment-18k")}
                        ...
                        >
                          <option value="">
                            {t("company-environments.default-1x9")} {instanceDefaultEnvironment
                        ...
                        <span className="block text-xs text-muted-foreground">
                          {t("company-environments.affected-yxb")} {agentsUsingEnvironment.map((agent) => agent.name).join(", ")}
                        </span>
                      </label>
                    ) : null}
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel disabled={deleteEnvironmentMutation.isPending}>{t("company-environments.cancel-ew9")}</AlertDialogCancel>
                  <AlertDialogAction
