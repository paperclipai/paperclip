...
export function NewAgent() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("pages.newAgent.breadcrumbAgents", { defaultValue: "Agents" }), href: "/agents" },
      { label: t("pages.newAgent.breadcrumbNewAgent", { defaultValue: "New Agent" }) },
    ]);
  }, [setBreadcrumbs, t]);
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-lg font-semibold">{t("pages.newAgent.heading", { defaultValue: "New Agent" })}</h1>
      ...
      <div className="border border-border">
        ...
        <div className="px-4 pt-4 pb-2">
          <input
            ...
            placeholder={t("pages.newAgent.namePlaceholder", { defaultValue: "Agent name" })}
            value={name}
        ...
        <div className="border-t border-border px-4 py-4">
          <div className="space-y-3">
            <div>
              <h2 className="text-sm font-medium">{t("pages.newAgent.companySkillsHeading", { defaultValue: "Company skills" })}</h2>
              <p className="mt-1 text-xs text-muted-foreground">
                {t("pages.newAgent.companySkillsDescription", { defaultValue: "Optional skills from the company library. Built-in Paperclip runtime skills are added automatically." })}
              </p>
            </div>
            {availableSkills.length === 0 ? (
              <p className="text-xs text-muted-foreground">
                {t("pages.newAgent.noCompanySkills", { defaultValue: "No optional company skills installed yet." })}
              </p>
            ) : (
              <div className="space-y-3">
