...
export function NewAgent() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("newAgent.tabs.agents"), href: "/agents" },
      { label: t("newAgent.tabs.newAgent") },
    ]);
  }, [setBreadcrumbs]);
  ...
  const createAgent = useMutation({
    ...
    onError: (error) => {
      setFormError(error instanceof Error ? error.message : t("newAgent.errors.create"));
    },
  });
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-lg font-semibold">{t("newAgent.text.newAgent")}</h1>
      ...
      <div className="border border-border">
        ...
        <div className="px-4 pt-4 pb-2">
          <input
            ...
            placeholder={t("newAgent.placeholders.agentName")}
            value={name}
        ...
        <div className="px-4 pb-2">
          <input
            ...
            placeholder={t("newAgent.placeholders.title")}
            value={title}
        ...
        <div className="border-t border-border px-4 py-4">
          <div className="space-y-3">
            <div>
              <h2 className="text-sm font-medium">{t("newAgent.text.companySkills")}</h2>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">{t("newAgent.text.defaultNameHint")}</p>
          )}
          {formError && (
