...
export function formatJoinRequestInboxLabel(
  ...
  if (joinRequest.requestType !== "human") {
    return joinRequest.agentName
      ? i18n.t("inbox:agentJoinRequestNamed", { defaultValue: "Agent join request: {{name}}", name: joinRequest.agentName })
      : i18n.t("inbox:agentJoinRequest", { defaultValue: "Agent join request" });
  }
  ...
  return i18n.t("inbox:humanJoinRequest", { defaultValue: "Human join request" });
}
