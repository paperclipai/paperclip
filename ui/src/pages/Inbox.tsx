...
import { INBOX_MINE_ISSUE_STATUS_FILTER } from "../../../packages/shared/src/constants.js";
            ...
            <PopoverContent align="end" className="w-40 p-2">
              <div className="space-y-0.5">
                {([
                  ...
                  ...(isolatedWorkspacesEnabled ? ([["workspace", t("common.workspace")]] as const) : []),
            ...
            <div ref={listRef} className="overflow-hidden rounded-xl border border-border bg-card">
              {(() => {
                ...
                return groupedSections.flatMap((group, groupIndex) => {
                  ...
                  if (group.label) {
                    const groupHeaderLabel = inboxGroupLabel(t, group.key, group.label) ?? group.label;
                    elements.push(
                      <div
                        key={`group-${group.key}`}
                        className={cn(
