...
const concurrencyPolicies = ["coalesce_if_active", "always_enqueue", "skip_if_active", "skip_if_ran_today"];
...
const concurrencyPolicyDescriptions: Record<string, string> = {
  ...
  skip_if_ran_today: "Create at most one scheduled issue per calendar day, even across multiple schedules. Manual runs remain available.",
};
