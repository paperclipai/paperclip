...
import type { Agent, Issue, IssueTreeControlPreview, IssueTreeHold } from "@valadrien-os/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "ValadrienOs", issuePrefix: "PAP", status: "active" }],
    selectedCompanyId: "company-1",
    selectedCompany: { id: "company-1", name: "ValadrienOs", issuePrefix: "PAP", status: "active" },
...
describe("IssueDetail", () => {
  ...
  it("forwards composer work mode changes to the issues API", async () => {
    ...
    localStorage.setItem("valadrien-os:issue-comment-draft:issue-1", "Draft follow-up message");
    ...
    expect(localStorage.getItem("valadrien-os:issue-comment-draft:issue-1")).toBe("Draft follow-up message");
    expect(container.textContent).toContain("planning-notes.txt");
    localStorage.removeItem("valadrien-os:issue-comment-draft:issue-1");
  });
