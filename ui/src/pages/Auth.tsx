...
export function AuthPage() {
  ...
  const mutation = useMutation({
    ...
    onError: (err) => {
      setError(err instanceof Error ? err.message : t("pages.auth.authenticationFailed"));
    },
  });
        ...
        <div className="w-full max-w-md mx-auto my-auto px-8 py-12">
          ...
          <form
            ...
            onSubmit={(event) => {
              ...
              if (!canSubmit) {
                setError(t("pages.auth.requiredFields"));
                return;
              }
              mutation.mutate();
            }}
          ...
          <div className="mt-5 text-sm text-muted-foreground">
            {mode === "sign_in" ? t("pages.auth.needAccount") : t("pages.auth.alreadyHaveAccount")}{" "}
            <button
              type="button"
