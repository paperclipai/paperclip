...
function RunDetailHeader({ onBehalfOf, denial }: { onBehalfOf?: string | null; denial?: ReactNode }) {
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap items-center gap-1.5 font-mono text-(length:--fs-11) text-muted-foreground">
        <span className="rounded bg-muted px-1.5 py-0.5 text-(length:--fs-10) font-medium uppercase tracking-wide">
          codex local
        </span>
  ...
  return (
    <div className="min-h-screen bg-muted/20 p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <p className={cn("text-center text-(length:--fs-11) text-muted-foreground")}>
