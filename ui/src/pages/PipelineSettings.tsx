...
const STAGE_NAV_GROUPS: Array<{
  ...
  {
    label: t("app.pipelineSettings.stage", { defaultValue: "Stage" }),
    items: [
      { id: "instructions", label: t("app.pipelineSettings.automation", { defaultValue: "Automation" }), icon: LayoutGrid },
      { id: "advanced", label: t("app.pipelineSettings.advanced", { defaultValue: "Advanced" }), icon: SlidersHorizontal },
      { id: "secrets", label: t("app.pipelineSettings.secrets", { defaultValue: "Secrets" }), icon: KeyRound },
    ],
  },
  {
    label: t("app.pipelineSettings.operate", { defaultValue: "Operate" }),
    items: [
      { id: "activity", label: t("app.pipelineSettings.activity", { defaultValue: "Activity" }), icon: ActivityIcon },
      { id: "history", label: t("app.pipelineSettings.history", { defaultValue: "History" }), icon: HistoryIcon },
    ],
  },
];
...
const STAGE_KIND_OPTIONS: Array<{
  ...
  {
    value: "working",
    label: t("app.pipelineSettings.working", { defaultValue: "Working" }),
    description: t("app.pipelineSettings.itemsWaitHereWhileWorkHappensAnAgentOrAPersonMovesThemForward", { defaultValue: "Items wait here while work happens. An agent or a person moves them forward." }),
    icon: Hammer,
  },
  {
    value: "review",
    label: t("app.pipelineSettings.review", { defaultValue: "Review" }),
    description: t("app.pipelineSettings.someoneHasToApproveBeforeItemsLeaveUseThisWhenAPersonOrAnAgentHasToSayYesOrNo", { defaultValue: "Someone has to approve before items leave. Use this when a person or an agent has to say yes or no." }),
    icon: BadgeCheck,
  },
  {
    value: "done",
    label: t("app.pipelineSettings.done", { defaultValue: "Done" }),
    description: t("app.pipelineSettings.theFinalStepItemsThatReachHereAreFinished", { defaultValue: "The final step. Items that reach here are finished." }),
    icon: CircleCheck,
  },
  {
    value: "cancelled",
    label: t("app.pipelineSettings.cancelled", { defaultValue: "Cancelled" }),
    description: t("app.pipelineSettings.theDeadEndItemsThatReachHereAreDroppedOrRejected", { defaultValue: "The dead end. Items that reach here are dropped or rejected." }),
    icon: Ban,
  },
];
...
const STAGE_EXECUTION_WORKSPACE_OPTIONS = [
  { value: "shared_workspace", label: t("app.pipelineSettings.projectDefault", { defaultValue: "Project default" }) },
  { value: "isolated_workspace", label: t("app.pipelineSettings.newIsolatedWorkspace", { defaultValue: "New isolated workspace" }) },
  { value: "reuse_existing", label: t("app.pipelineSettings.reuseExistingWorkspace", { defaultValue: "Reuse existing workspace" }) },
] as const;
...
function buildAutomationVariableGroups(input: {
  ...
  const pipelineVariables: AutomationVariableOption[] = [
    {
      key: "pipeline_id",
      label: t("app.pipelineSettings.pipelineId", { defaultValue: "Pipeline ID" }),
      description: t("app.pipelineSettings.idOfThePipelineThisAutomationRunsIn", { defaultValue: "ID of the pipeline this automation runs in." }),
      example: input.pipeline.id,
      exampleSource: null,
    },
    {
      key: "pipeline_key",
      label: t("app.pipelineSettings.pipelineKey", { defaultValue: "Pipeline key" }),
      description: t("app.pipelineSettings.stableKeyOfThePipelineThisAutomationRunsIn", { defaultValue: "Stable key of the pipeline this automation runs in." }),
      example: input.pipeline.key,
      exampleSource: null,
    },
    {
      key: "pipeline_name",
      label: t("app.pipelineSettings.pipelineName", { defaultValue: "Pipeline name" }),
      description: t("app.pipelineSettings.displayNameOfThePipelineThisAutomationRunsIn", { defaultValue: "Display name of the pipeline this automation runs in." }),
      example: input.pipeline.name,
      exampleSource: null,
    },
    {
      key: "stage_id",
      label: t("app.pipelineSettings.stageId", { defaultValue: "Stage ID" }),
      description: t("app.pipelineSettings.idOfThisAutomationStage", { defaultValue: "ID of this automation stage." }),
      example: input.stage.id,
      exampleSource: null,
    },
    {
      key: "stage_key",
      label: t("app.pipelineSettings.stageKey", { defaultValue: "Stage key" }),
      description: t("app.pipelineSettings.stableKeyOfThisAutomationStage", { defaultValue: "Stable key of this automation stage." }),
      example: input.stage.key,
      exampleSource: null,
    },
    {
      key: "stage_name",
      label: t("app.pipelineSettings.stageName", { defaultValue: "Stage name" }),
      description: t("app.pipelineSettings.displayNameOfThisAutomationStage", { defaultValue: "Display name of this automation stage." }),
  ...
  const itemVariables: AutomationVariableOption[] = [
    {
      key: "title",
      label: t("app.pipelineSettings.itemTitle", { defaultValue: "Item title" }),
      description: t("app.pipelineSettings.titleOfTheItemBeingAutomated", { defaultValue: "Title of the item being automated." }),
      example: sampleCase?.title ?? "",
      exampleSource,
    },
    {
      key: "body",
      label: t("app.pipelineSettings.itemBody", { defaultValue: "Item body" }),
      description: t("app.pipelineSettings.bodyTextOfTheItemBeingAutomated", { defaultValue: "Body text of the item being automated." }),
      example: sampleCase?.summary ?? "",
      exampleSource,
    },
    {
      key: "case_id",
      label: t("app.pipelineSettings.itemId", { defaultValue: "Item ID" }),
      description: t("app.pipelineSettings.idOfTheItemBeingAutomated", { defaultValue: "ID of the item being automated." }),
      example: sampleCase?.id ?? "",
      exampleSource,
    },
    {
      key: "case_key",
      label: t("app.pipelineSettings.itemKey", { defaultValue: "Item key" }),
      description: t("app.pipelineSettings.stableKeyOfTheItemBeingAutomated", { defaultValue: "Stable key of the item being automated." }),
      example: sampleCase?.caseKey ?? "",
      exampleSource,
    },
    {
      key: "case_title",
      label: t("app.pipelineSettings.itemTitleAlias", { defaultValue: "Item title alias" }),
      description: t("app.pipelineSettings.compatibilityAliasForTheItemTitle", { defaultValue: "Compatibility alias for the item title." }),
      example: sampleCase?.title ?? "",
      exampleSource,
    },
    {
      key: "case_version",
      label: t("app.pipelineSettings.itemVersion", { defaultValue: "Item version" }),
      description: t("app.pipelineSettings.currentItemVersionWhenTheAutomationRuns", { defaultValue: "Current item version when the automation runs." }),
  ...
  const groups: AutomationVariableGroup[] = [
    { id: "pipeline", label: t("app.pipelineSettings.pipelineAndStage", { defaultValue: "Pipeline and stage" }), variables: pipelineVariables },
    { id: "item", label: t("app.pipelineSettings.currentItem", { defaultValue: "Current item" }), variables: itemVariables },
  ];
  if (fieldVariables.length > 0) {
    groups.push({ id: "fields", label: t("app.pipelineSettings.itemFields", { defaultValue: "Item fields" }), variables: fieldVariables });
  }
  return groups;
}
    ...
    <div className="rounded-md border border-dashed border-border bg-muted/25 px-3 py-2">
      <div className="mb-2 flex flex-wrap items-center gap-2">
        <span className="text-xs font-semibold uppercase text-muted-foreground">
          {t("app.pipelineSettings.alreadyAvailableOnChildItems", { defaultValue: "Already available on child items" })}</span>
      </div>
        ...
        {groups.map((group) => (
          <div key={group.id} className="space-y-1">
            <p className="text-xs text-muted-foreground">
              ...
              {group.description ? <span> {t("app.pipelineSettings.text", { defaultValue: "· " })}{group.description}</span> : null}
            </p>
  ...
  return (
    <>
      <div className="md:hidden">
        <label className="sr-only" htmlFor="stage-section-picker">{t("app.pipelineSettings.stageSection", { defaultValue: "Stage section" })}</label>
        <select
      ...
      <nav
        aria-label={t("app.pipelineSettings.stageSections", { defaultValue: "Stage sections" })}
...
export function PipelineSettings() {
  ...
  useEffect(() => {
    if (!pipeline) return;
    setBreadcrumbs([
      { label: t("app.pages.pipelines", { defaultValue: "Pipelines" }), href: "/pipelines" },
      { label: pipeline.name, href: `/pipelines/${pipeline.id}` },
      { label: t("app.pipelineSettings.settings", { defaultValue: "Settings" }) },
    ]);
  ...
  const saveStage = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("app.pipelineSettings.stageSaved", { defaultValue: "Stage saved" }), tone: "success" });
    },
    onError: async (error) => {
      pushToast({
        title: t("app.pipelineSettings.failedToSaveStage", { defaultValue: "Failed to save stage" }),
        body: error instanceof Error ? error.message : t("app.pipelineSettings.paperclipCouldNotSaveTheStage", { defaultValue: "Paperclip could not save the stage." }),
        tone: "error",
      });
    },
  });
  ...
  const saveStageEnv = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("app.pipelineSettings.stageSecretsSaved", { defaultValue: "Stage secrets saved" }), tone: "success" });
    },
    onError: async (error) => {
      pushToast({
        title: t("app.pipelineSettings.failedToSaveSecrets", { defaultValue: "Failed to save secrets" }),
        body: error instanceof ApiError
          ? error.message
          : error instanceof Error
            ? error.message
            : t("app.pipelineSettings.paperclipCouldNotSaveTheStageSecrets", { defaultValue: "Paperclip could not save the stage secrets." }),
        tone: "error",
      });
    },
  });
  ...
  const addStage = useMutation({
    ...
    onSuccess: async (created) => {
      ...
      pushToast({ title: t("app.pipelineSettings.stageAdded", { defaultValue: "Stage added" }), tone: "success" });
    },
  });
  ...
  const deleteStage = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("app.pipelineSettings.stageDeleted", { defaultValue: "Stage deleted" }), tone: "success" });
    },
    onError: (error) => {
      pushToast({
        title: t("app.pipelineSettings.failedToDeleteStage", { defaultValue: "Failed to delete stage" }),
        body: error instanceof Error ? error.message : t("app.pipelineSettings.paperclipCouldNotDeleteTheStage", { defaultValue: "Paperclip could not delete the stage." }),
        tone: "error",
      });
    },
  });
  ...
  const savePipelineDetails = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("app.pipelineSettings.pipelineUpdated", { defaultValue: "Pipeline updated" }), tone: "success" });
    },
  });
  ...
  const saveStrictTransitions = useMutation({
    ...
    onSuccess: async () => {
      await refreshPipeline();
      pushToast({ title: t("app.pipelineSettings.transitionRulesUpdated", { defaultValue: "Transition rules updated" }), tone: "success" });
    },
    onError: (error) => {
      setStrictTransitionsEnabled(pipeline?.enforceTransitions ?? false);
      pushToast({
        title: t("app.pipelineSettings.failedToUpdateTransitionRules", { defaultValue: "Failed to update transition rules" }),
        body: error instanceof Error ? error.message : t("app.pipelineSettings.paperclipCouldNotUpdateTransitionRules", { defaultValue: "Paperclip could not update transition rules." }),
        tone: "error",
      });
    },
  });
  ...
  const archivePipeline = useMutation({
    ...
    onSuccess: async (_result, archived) => {
      ...
      if (archived) {
        ...
        await refreshPipeline();
        pushToast({ title: t("app.pipelineSettings.pipelineRestored", { defaultValue: "Pipeline restored" }), tone: "success" });
      }
    },
  });
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Hexagon} message={t("app.pipelineSettings.selectACompanyToEditPipelineSettings", { defaultValue: "Select a company to edit pipeline settings." })} />;
  }

  if (!pipelineId) {
    return <EmptyState icon={Hexagon} message={t("app.pipelineSettings.noPipelineSelected", { defaultValue: "No pipeline selected." })} />;
  }
  ...
  if (!pipeline) {
    return <EmptyState icon={Hexagon} message={t("app.pipelineSettings.pipelineNotFound", { defaultValue: "Pipeline not found." })} />;
  }
  ...
  const transitionTargetsControl = !isReviewStage && !isPipelineTerminalStageKind(stageKind) ? (
    <FieldRow label={t("app.pipelineSettings.allowedNextSteps", { defaultValue: "Allowed next steps" })}>
      <div className="space-y-2">
        {otherStages.map((stage) => {
          ...
          return (
            ...
            >
              ...
              {isCancelled ? (
                <span className="text-xs text-muted-foreground">{t("app.pipelineSettings.alwaysAvailable", { defaultValue: "Always available" })}</span>
              ) : null}
            </label>
          );
        })}
    ...
    <div className="rounded-lg border border-border">
      <div className="flex items-start justify-between gap-4 border-b border-border p-4">
        <div className="space-y-1">
          <h3 className="text-sm font-semibold text-foreground">{t("app.pipelineSettings.breakIntoSmallerPieces", { defaultValue: "Break into smaller pieces" })}</h3>
          <p className="max-w-md text-sm text-muted-foreground">
            {t("app.pipelineSettings.theAgentDecidesWhatThePiecesArePaperclipCreatesAndTracksThem", { defaultValue: "The agent decides what the pieces are. Paperclip creates and tracks them." })}</p>
        </div>
        <ToggleSwitch
          aria-label={t("app.pipelineSettings.breakIntoSmallerPieces", { defaultValue: "Break into smaller pieces" })}
      ...
      {breakdownEnabled ? (
        <div className="divide-y divide-border px-4">
          <FieldRow label={t("app.pipelineSettings.createEachPieceIn", { defaultValue: "Create each piece in" })}>
            <div className="space-y-1">
              <div className="flex w-full max-w-sm items-center">
                <select
                  aria-label={t("app.pipelineSettings.createEachPieceIn", { defaultValue: "Create each piece in" })}
                ...
                >
                  <option value="">{t("app.pipelineSettings.chooseAPipeline", { defaultValue: "Choose a pipeline" })}</option>
              ...
              {!breakdownTargetPipelineId ? (
                <p className="text-xs text-muted-foreground">{t("app.pipelineSettings.aPipelineInThisWorkspace", { defaultValue: "A pipeline in this workspace" })}</p>
              ) : null}
            </div>
          </FieldRow>
          <FieldRow label={t("app.pipelineSettings.startingAt", { defaultValue: "starting at" })}>
            <div className="space-y-1">
              <select
                aria-label={t("app.pipelineSettings.startingStageForEachPiece", { defaultValue: "Starting stage for each piece" })}
              ...
              >
                <option value="">{t("app.pipelineSettings.chooseAStage", { defaultValue: "Choose a stage" })}</option>
                {breakdownTargetStages.map((stage) => (
                  <option key={stage.id} value={stage.key}>{stage.name}</option>
                ))}
              </select>
              <p className="text-xs text-muted-foreground">{t("app.pipelineSettings.theStageEveryNewPieceStartsIn", { defaultValue: "The stage every new piece starts in" })}</p>
            </div>
          </FieldRow>
          <FieldRow label={t("app.pipelineSettings.callEachPieceA", { defaultValue: "Call each piece a" })}>
            <div className="space-y-1">
              <Input
                aria-label={t("app.pipelineSettings.callEachPieceA", { defaultValue: "Call each piece a" })}
              ...
              />
              <p className="text-xs text-muted-foreground">
                {t("app.pipelineSettings.drivesCopyOnThisCaseEG3Of5", { defaultValue: "Drives copy on this case (e.g. “3 of 5 " })}{breakdownPieceNounPlural} finished”)
              </p>
            </div>
          </FieldRow>
          <FieldRow label={t("app.pipelineSettings.carryOver", { defaultValue: "Carry over" })}>
            <div className="space-y-2">
              <div className="space-y-1 rounded-md border border-dashed border-border bg-muted/30 px-3 py-2 text-xs">
                <p className="text-muted-foreground">
                  {t("app.pipelineSettings.valuesAreCopiedFromThisItemAndItsAncestorsNewEligibleFieldsStayOnUnlessYouUncheckThem", { defaultValue: "Values are copied from this item and its ancestors. New eligible fields stay on unless you uncheck them." })}</p>
                {breakdownTargetPipelineId ? (
                  <div className="flex flex-wrap items-center gap-1 text-muted-foreground">
                    <span>{t("app.pipelineSettings.destinationValidation", { defaultValue: "Destination validation:" })}</span>
                    <span className="font-medium text-foreground">
                      {breakdownTargetPipeline?.name ?? t("app.pipelineSettings.selectedPipeline", { defaultValue: "selected pipeline" })}
                    </span>
                ...
                {breakdownIntakeSettingsHref ? (
                  ...
                  >
                    {t("app.pipelineSettings.reviewDestinationFields", { defaultValue: "Review destination fields" })}<ArrowUpRight className="h-3 w-3" />
                  </Link>
                ) : null}
                {breakdownTargetArchived ? (
                  <p className="flex items-center gap-1 text-amber-700 dark:text-amber-300">
                    <Archive className="h-3 w-3 shrink-0" />
                    {t("app.pipelineSettings.thisDestinationPipelineIsArchivedSoItsValidationFieldsCanTBeEditedUntilItSRestored", { defaultValue: "This destination pipeline is archived, so its validation fields can't be edited until it's restored." })}</p>
                ) : null}
              </div>
                  ...
                  {breakdownCarryOverFieldGroups.map((group) => (
                    <div key={group.id} className="space-y-1.5">
                      <div className="text-xs font-medium text-muted-foreground">
                        {group.label}
                        {group.description ? (
                          <span className="ml-1 font-normal">{t("app.pipelineSettings.text", { defaultValue: "· " })}{group.description}</span>
                        ) : null}
                      </div>
                            ...
                            >
                              ...
                              {targetField?.required ? (
                                <span className="text-xs text-muted-foreground">
                                  {t("app.pipelineSettings.requiredBy", { defaultValue: "Required by " })}{breakdownTargetPipeline?.name ?? "destination"}
                                </span>
                              ) : targetField ? (
                                <span className="text-xs text-muted-foreground">
                                  {t("app.pipelineSettings.validatedBy", { defaultValue: "Validated by " })}{breakdownTargetPipeline?.name ?? "destination"}
                                </span>
                              ) : null}
                            </label>
                          );
              ...
              {breakdownCarryOverFieldGroups.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  {t("app.pipelineSettings.thisPipelineAndItsAncestorsDoNotDefineAnyFieldsThatCanBeCarriedOverYet", { defaultValue: "This pipeline and its ancestors do not define any fields that can be carried over yet." })}</p>
              ) : null}
              <p className="text-xs text-muted-foreground">
                {t("app.pipelineSettings.nameAndTitleFieldsAreKeptUniqueForEachNew", { defaultValue: "Name and title fields are kept unique for each new " })}{breakdownPieceNoun.trim() || "piece"}.
              </p>
            </div>
          </FieldRow>
          <FieldRow label={t("app.pipelineSettings.thenMoveThisCaseTo", { defaultValue: "Then move this case to" })}>
            <div className="space-y-1">
              <select
                aria-label={t("app.pipelineSettings.thenMoveThisCaseTo", { defaultValue: "Then move this case to" })}
              ...
              >
                <option value="">{t("app.pipelineSettings.stayOnThisStep", { defaultValue: "Stay on this step" })}</option>
                {otherStages.map((stage) => (
                  <option key={stage.id} value={stage.key}>{stage.name}</option>
                ))}
              </select>
              <p className="text-xs text-muted-foreground">{t("app.pipelineSettings.asSoonAsThePiecesAreCreated", { defaultValue: "As soon as the pieces are created" })}</p>
            </div>
          </FieldRow>
          <FieldRow label={t("app.pipelineSettings.wait", { defaultValue: "Wait" })}>
            <div className="space-y-2">
              <label className="flex items-start gap-2 text-sm">
                ...
                />
                <span className="font-medium text-foreground">
                  {t("app.pipelineSettings.waitUntilAll", { defaultValue: "Wait until all " })}{breakdownPieceNounPlural} {t("app.pipelineSettings.areFinishedThenMoveItTo", { defaultValue: "are finished, then move it to" })}</span>
              </label>
              <select
                aria-label={t("app.pipelineSettings.moveThisCaseWhenAllPiecesFinish", { defaultValue: "Move this case when all pieces finish" })}
              ...
              {breakdownAdvanceTo ? (
                <p className="text-xs text-muted-foreground">
                  {t("app.pipelineSettings.ifNothingIsWorthSplittingThisCaseStillMovesTo", { defaultValue: "If nothing is worth splitting, this case still moves to " })}{breakdownCopyNames.advanceToName}.
                </p>
              ) : null}
            </div>
          </FieldRow>
    ...
    <div className="space-y-6">
      ...
      >
        <div className="mb-3 flex items-start justify-between gap-3">
          <Link to={`/pipelines/${pipeline.id}`} className="text-sm text-muted-foreground hover:text-foreground">
            {t("app.pipelineSettings.backToBoard", { defaultValue: "Back to board" })}</Link>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button type="button" variant="outline" size="icon" className="h-8 w-8" title={t("app.pipelineSettings.pipelineActions", { defaultValue: "Pipeline actions" })}>
            ...
            <DropdownMenuContent align="end">
              {isArchived ? (
                <DropdownMenuItem onSelect={() => archivePipeline.mutate(false)}>
                  ...
                  {t("app.pipelineSettings.restorePipeline", { defaultValue: "Restore pipeline" })}</DropdownMenuItem>
              ) : (
                <DropdownMenuItem variant="destructive" onSelect={() => setArchiveDialogOpen(true)}>
                  <Archive className="h-4 w-4" />
                  {t("app.pipelineSettings.archivePipeline", { defaultValue: "Archive pipeline" })}</DropdownMenuItem>
              )}
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
        <div className="grid gap-3 md:grid-cols-(--gtc-13) md:items-end">
          <div className="space-y-3">
            <label className="block space-y-1.5 text-sm font-medium">
              <span className="sr-only">{t("app.pipelineSettings.pipelineName", { defaultValue: "Pipeline name" })}</span>
              <Input
                aria-label={t("app.pipelineSettings.pipelineName", { defaultValue: "Pipeline name" })}
                value={pipelineName}
            ...
            <label className="block space-y-1.5 text-sm font-medium">
              <span className="sr-only">{t("app.pipelineSettings.pipelineDescription", { defaultValue: "Pipeline description" })}</span>
              <Textarea
                aria-label={t("app.pipelineSettings.pipelineDescription", { defaultValue: "Pipeline description" })}
                value={pipelineDescription}
                onChange={(event) => setPipelineDescription(event.target.value)}
                rows={2}
                placeholder={t("app.pipelineSettings.addADescription", { defaultValue: "Add a description" })}
          ...
          {detailsDirty || savePipelineDetails.isPending ? (
            <Button type="submit" disabled={savePipelineDetails.isPending || !pipelineName.trim()}>
              ...
              {savePipelineDetails.isPending ? t("app.pipelineSettings.saving", { defaultValue: "Saving..." }) : t("app.pipelineSettings.saveDetails", { defaultValue: "Save details" })}
            </Button>
          ) : null}
        </div>
      ...
      <div className="space-y-6">
          {stages.length === 0 ? (
            <EmptyState
              icon={GitBranch}
              message={t("app.pipelineSettings.noStagesConfigured", { defaultValue: "No stages configured." })}
                    ...
                    <div key={stage.id} className="flex items-center gap-2">
                      <div className="flex flex-col items-start gap-1">
                        ...
                        >
                          ...
                          <span className="mt-1 block text-xs text-muted-foreground">{t("app.pipelineSettings.step", { defaultValue: "Step " })}{index + 1}</span>
                          {stageNewEntriesDisabled(stage) ? (
                            <span className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-amber-700 dark:text-amber-300">
                              ...
                              {t("app.pipelineSettings.newEntriesPaused", { defaultValue: "New entries paused" })}</span>
                          ) : null}
                        </button>
                        <Link
                        ...
                        >
                          {t("app.pipelineSettings.viewQueue", { defaultValue: "View queue" })}<ArrowUpRight className="h-3 w-3" aria-hidden="true" />
                        </Link>
                      </div>
                      {canInsertAfter ? (
                        <button
                ...
                <div className="min-w-0 flex-1 md:px-8">
                    ...
                    {activeStageSection === "instructions" ? (
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          title={newEntriesDisabled ? t("app.pipelineSettings.resumeNewEntries", { defaultValue: "Resume new entries" }) : t("app.pipelineSettings.pauseNewEntries", { defaultValue: "Pause new entries" })}
                          aria-label={newEntriesDisabled ? t("app.pipelineSettings.resumeNewEntries", { defaultValue: "Resume new entries" }) : t("app.pipelineSettings.pauseNewEntries", { defaultValue: "Pause new entries" })}
                  ...
                  {activeStageSection === "instructions" ? (
                    <div className="w-full max-w-3xl">
                      <div className="divide-y divide-border border-b border-border">
                        <FieldRow label={t("app.pipelineSettings.name", { defaultValue: "Name" })}>
                          <Input value={stageName} onChange={(event) => setStageName(event.target.value)} required />
                        </FieldRow>
                        <FieldRow label={t("app.pipelineSettings.stepType", { defaultValue: "Step type" })}>
                            ...
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <Button
                                  type="button"
                                  variant="outline"
                                  aria-label={t("app.pipelineSettings.stepType", { defaultValue: "Step type" })}
                        ...
                        {stageKind === "review" ? (
                          <FieldRow label={t("app.pipelineSettings.approver", { defaultValue: "Approver" })}>
                            <InlineEntitySelector
                              ...
                              renderTriggerValue={(option) => {
                                if (!option) return <span className="text-muted-foreground">{t("app.pipelineSettings.anyHuman", { defaultValue: "Any human" })}</span>;
                        ...
                        {stageKind === "review" ? (
                          <FieldRow label={t("app.pipelineSettings.reviewOutcomes", { defaultValue: "Review outcomes" })}>
                            <div className="space-y-2">
                              {([
                              ...
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-42)">
                                <span className="text-sm font-medium">{t("app.pipelineSettings.askForANoteWhenRequestingChanges", { defaultValue: "Ask for a note when requesting changes" })}</span>
                                <div className="sm:justify-self-start">
                                  <ToggleSwitch checked={requireRequestChangesReason} onCheckedChange={setRequireRequestChangesReason} />
                                </div>
                              </div>
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-42)">
                                <span className="text-sm font-medium">{t("app.pipelineSettings.askForANoteWhenDeclining", { defaultValue: "Ask for a note when declining" })}</span>
                                <div className="sm:justify-self-start">
                            ...
                            {reviewTargetsMissing ? (
                              <p className="mt-2 text-sm text-muted-foreground">
                                {t("app.pipelineSettings.pickWhereApprovedAndDeclinedItemsShouldGoBeforeSaving", { defaultValue: "Pick where approved and declined items should go before saving." })}</p>
                            ) : null}
                          </FieldRow>
                        ) : null}
                    ...
                    <div className="mt-8 w-full max-w-3xl space-y-6">
                      <div className="overflow-x-auto overscroll-x-contain">
                        <div className="inline-flex min-w-full flex-wrap items-center gap-2 text-sm text-muted-foreground sm:min-w-max sm:flex-nowrap">
                          <span>{t("app.pipelineSettings.whenAnItemEntersThisStep", { defaultValue: "When an item enters this step" })}</span>
                          <InlineEntitySelector
                            ...
                            renderTriggerValue={(option) => {
                              if (!option) return <span className="text-muted-foreground">{t("app.pipelineSettings.pickAgent", { defaultValue: "Pick agent" })}</span>;
                          ...
                          />
                          <span>{t("app.pipelineSettings.runsTheseInstructionsThenMovesTheItemToTheNextStep", { defaultValue: "runs these instructions, then moves the item to the next step." })}</span>
                        </div>
                      </div>
                      ...
                      {selectedAutomationAgent ? (
                        <>
                          <div className="divide-y divide-border border-y border-border">
                            <FieldRow label={t("app.pipelineSettings.projectContext", { defaultValue: "Project context" })}>
                              <div className="grid gap-2 sm:grid-cols-(--gtc-43)">
                                <InlineEntitySelector
                                  ...
                                  renderTriggerValue={(option) =>
                                    option && selectedAutomationProject ? (
                                      ...
                                      <span className="text-muted-foreground">{t("app.pipelineSettings.project", { defaultValue: "Project" })}</span>
                                    )
                                  }
                                  renderOption={(option) => {
                                    if (!option.id) return <span className="truncate">{option.label}</span>;
                                ...
                                {selectedAutomationProject ? (
                                  <select
                                    aria-label={t("app.pipelineSettings.projectWorkspace", { defaultValue: "Project workspace" })}
                                    value={stageProjectWorkspaceId}
                                    onChange={(event) => handleAutomationProjectWorkspaceChange(event.target.value)}
                                    className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm"
                                  >
                                    <option value="">{t("app.pipelineSettings.projectFallback", { defaultValue: "Project fallback" })}</option>
                                    {(selectedAutomationProject.workspaces ?? []).map((workspace) => (
                                      <option key={workspace.id} value={workspace.id}>
                                        {workspace.name}{workspace.isPrimary ? t("app.pipelineSettings.primary", { defaultValue: " · primary" }) : ""}
                                      </option>
                                    ))}
                                  </select>
                                ) : (
                                  <div className="flex h-10 items-center rounded-md border border-dashed border-border px-3 text-sm text-muted-foreground">
                                    {t("app.pipelineSettings.projectWorkspace", { defaultValue: "Project workspace" })}</div>
                                )}
                              </div>
                              {selectedAutomationProject && !selectedAutomationProjectWorkspace ? (
                                <p className="mt-2 text-xs text-muted-foreground">
                                  {t("app.pipelineSettings.thisProjectHasNoSavedWorkspaceDefaultPaperclipWillUseTheProjectFallbackWhenAutomationRuns", { defaultValue: "This project has no saved workspace default. Paperclip will use the project fallback when automation runs." })}</p>
                              ) : null}
                            </FieldRow>

                            {selectedAutomationProject && selectedProjectSupportsExecutionWorkspace ? (
                              <FieldRow label={t("app.pipelineSettings.executionWorkspace", { defaultValue: "Execution workspace" })}>
                                <div className="grid gap-2 sm:grid-cols-(--gtc-43)">
                                  <select
                                    aria-label={t("app.pipelineSettings.executionWorkspaceMode", { defaultValue: "Execution workspace mode" })}
                                  ...
                                  {stageExecutionWorkspacePreference === "reuse_existing" ? (
                                    <select
                                      aria-label={t("app.pipelineSettings.existingExecutionWorkspace", { defaultValue: "Existing execution workspace" })}
                                      value={stageExecutionWorkspaceId}
                                      onChange={(event) => handleAutomationExecutionWorkspaceIdChange(event.target.value)}
                                      className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm"
                                    >
                                      <option value="">{t("app.pipelineSettings.chooseAnExistingWorkspace", { defaultValue: "Choose an existing workspace" })}</option>
                                      {deduplicatedReusableWorkspaces.map((workspace) => (
                                        <option key={workspace.id} value={workspace.id}>
                                          {workspace.name} {t("app.pipelineSettings.text", { defaultValue: "· " })}{workspace.status} {t("app.pipelineSettings.text", { defaultValue: "· " })}{workspace.branchName ?? workspace.cwd ?? workspace.id.slice(0, 8)}
                                        </option>
                                      ))}
                                    </select>
                                  ) : (
                                    <div className="flex h-10 items-center rounded-md border border-dashed border-border px-3 text-sm text-muted-foreground">
                                      {stageExecutionWorkspacePreference === "isolated_workspace"
                                        ? t("app.pipelineSettings.aNewWorkspaceWillBeCreated", { defaultValue: "A new workspace will be created" })
                                        : t("app.pipelineSettings.projectDefaultWorkspace", { defaultValue: "Project default workspace" })}
                                    </div>
                                  )}
                                </div>
                                {stageExecutionWorkspacePreference === "reuse_existing" && selectedReusableExecutionWorkspace ? (
                                  <p className="mt-2 text-xs text-muted-foreground">
                                    {t("app.pipelineSettings.reusing", { defaultValue: "Reusing " })}{selectedReusableExecutionWorkspace.name} {t("app.pipelineSettings.from", { defaultValue: "from " })}{selectedReusableExecutionWorkspace.branchName ?? selectedReusableExecutionWorkspace.cwd ?? t("app.pipelineSettings.existingWorkspace", { defaultValue: "existing workspace" })}.
                                  </p>
                                ) : null}
                                {!canSaveAutomationWorkspace ? (
                                  <p className="mt-2 text-xs text-amber-700 dark:text-amber-300">
                                    {t("app.pipelineSettings.chooseAnExistingWorkspaceBeforeSavingReuseMode", { defaultValue: "Choose an existing workspace before saving reuse mode." })}</p>
                                ) : null}
                              </FieldRow>
                            ) : null}
                          </div>
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <span>{selectedAutomationAgent.name} {t("app.pipelineSettings.runsThisStepAutomatically", { defaultValue: "runs this step automatically." })}</span>
                          </div>
                          <FieldRow label={t("app.pipelineSettings.issueTitle", { defaultValue: "Issue title" })}>
                            <Input
                              ref={issueTitleTemplateInputRef}
                              aria-label={t("app.pipelineSettings.issueTitleTemplate", { defaultValue: "Issue title template" })}
                          ...
                          <AutomationVariableTokenHelper
                            ...
                            label={t("app.pipelineSettings.issueTitleVariables", { defaultValue: "Issue title variables" })}
                          />
                          {breakdownEnabled ? (
                            <div className="space-y-1">
                              <h3 className="text-sm font-semibold text-foreground">{t("app.pipelineSettings.whatShouldTheAgentDecide", { defaultValue: "What should the agent decide?" })}</h3>
                              <p className="text-sm text-muted-foreground">
                                {t("app.pipelineSettings.theMechanicsAreHandledBelowWriteOnlyTheJudgment", { defaultValue: "The mechanics are handled below. Write only the judgment." })}</p>
                            </div>
                          ) : null}
                          <div data-testid="stage-instructions-editor">
                            <MarkdownEditor
                              ...
                              placeholder={
                                breakdownEnabled
                                  ? t("app.pipelineSettings.describeTheJudgmentTheAgentShouldMakeWhatCountsAsAPieceWorthSplittingOut", { defaultValue: "Describe the judgment the agent should make — what counts as a piece worth splitting out?" })
                                  : t("app.pipelineSettings.tellTheAgentExactlyWhatToDoWhenAnItemEntersThisStep", { defaultValue: "Tell the agent exactly what to do when an item enters this step..." })
                              }
                              bordered={false}
                        ...
                        <EmptyState
                          icon={Pause}
                          message={t("app.pipelineSettings.nothingRunsHereAutomaticallyItemsWaitUntilAPersonMovesThemOrYouCanPickAnAgentToRunThisStep", { defaultValue: "Nothing runs here automatically. Items wait until a person moves them, or you can pick an agent to run this step." })}
                        />
                      )}
                      <div className="space-y-3">
                  ...
                  {activeStageSection === "advanced" ? (
                    <div className="w-full max-w-3xl space-y-8">
                      <div className="divide-y divide-border border-b border-border">
                        <div className="py-3">
                          <h3 className="text-sm font-semibold text-foreground">{t("app.pipelineSettings.transitions", { defaultValue: "Transitions" })}</h3>
                        </div>
                        <FieldRow label={t("app.pipelineSettings.strictMode", { defaultValue: "Strict mode" })}>
                          <div className="space-y-1.5">
                            <div className="flex items-center gap-3">
                              <ToggleSwitch
                                aria-label={t("app.pipelineSettings.strictlyEnforceTransitions", { defaultValue: "Strictly enforce transitions" })}
                              ...
                              <span className="text-sm font-medium text-foreground">
                                {t("app.pipelineSettings.strictlyEnforceTransitions", { defaultValue: "Strictly enforce transitions" })}</span>
                            </div>
                            <p className="max-w-2xl text-sm text-muted-foreground">
                              {strictTransitionsEnabled
                                ? t("app.pipelineSettings.itemsCanOnlyMoveToConfiguredNextStepsOperatorsCanForceAnOffPathMoveByGivingAReason", { defaultValue: "Items can only move to configured next steps. Operators can force an off-path move by giving a reason." })
                                : t("app.pipelineSettings.itemsCanMoveToAnyStepSavedAllowedNextStepChoicesAreKeptButTheyAreNotEnforced", { defaultValue: "Items can move to any step. Saved allowed-next-step choices are kept, but they are not enforced." })}
                            </p>
                          </div>
                        </FieldRow>
                      ...
                      {isPipelineTerminalStageKind(stageKind) ? null : breakdownEnabled ? (
                        <EmptyState
                          ...
                          message={t("app.pipelineSettings.advancedChildSettingsAreHiddenWhileBreakIntoSmallerPiecesIsEnabledConfigureThatWorkflowInAutomation", { defaultValue: "Advanced child settings are hidden while Break into smaller pieces is enabled. Configure that workflow in Automation." })}
                        />
                      ) : (
                        <div className="divide-y divide-border border-b border-border">
                          <div className="py-3">
                            <h3 className="text-sm font-semibold text-foreground">{t("app.pipelineSettings.children", { defaultValue: "Children" })}</h3>
                          </div>
                          <FieldRow label={t("app.pipelineSettings.blockChildren", { defaultValue: "Block children" })}>
                            <div className="space-y-1.5">
                              <div className="flex items-center gap-3">
                                <ToggleSwitch
                                ...
                                />
                                <span className="text-sm font-medium text-foreground">
                                  {t("app.pipelineSettings.blockUntilAllChildItemsAreDoneOrCancelled", { defaultValue: "Block until all child items are done or cancelled" })}</span>
                              </div>
                              <p className="max-w-2xl text-sm text-muted-foreground">
                                {t("app.pipelineSettings.whenOnThisStepCanTMoveForwardWhileAnyChildItemIsStillOpenWhenOffItemsCanMoveThroughEvenWithOpenChildren", { defaultValue: "When on, this step can't move forward while any child item is still open. When off, items can move through even with open children." })}</p>
                            </div>
                          </FieldRow>
                          <FieldRow label={t("app.pipelineSettings.advanceChildren", { defaultValue: "Advance children" })}>
                            <div className="space-y-3">
                              <div className="flex items-center gap-3">
                                <ToggleSwitch
                                ...
                                />
                                <span className="text-sm font-medium text-foreground">
                                  {t("app.pipelineSettings.advanceWhenTheLastChildIsDone", { defaultValue: "Advance when the last child is done" })}</span>
                              </div>
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-44)">
                                <span className="text-sm font-medium text-muted-foreground">{t("app.pipelineSettings.moveTo", { defaultValue: "Move to" })}</span>
                                <select
                                  aria-label={t("app.pipelineSettings.moveToStageWhenChildrenFinish", { defaultValue: "Move to stage when children finish" })}
                              ...
                              <p className="max-w-2xl text-sm text-muted-foreground">
                                {t("app.pipelineSettings.whenOnAndEveryChildIsDoneThisStepMovesTheItemForwardAutomaticallyWhenOffSomeoneHasToMoveIt", { defaultValue: "When on and every child is done, this step moves the item forward automatically. When off, someone has to move it." })}</p>
                            </div>
                          </FieldRow>
                        </div>
                      )}
                    ...
                    <div className="w-full space-y-3">
                      {stageEventsQuery.isLoading ? (
                        ...
                        <StageEventsList
                          events={stageEvents}
                          stages={stages}
                          emptyMessage={t("app.pipelineSettings.noStageActivityYet", { defaultValue: "No stage activity yet." })}
                        />
                      )}
                    </div>
                  ) : null}
              ...
              {stageDirty || saveStage.isPending ? (
                <div className="sticky bottom-0 z-10 -mx-6 mt-6 flex items-center justify-between gap-3 border-t border-border bg-background/95 px-6 py-3 backdrop-blur motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2">
                  <span className="text-sm text-muted-foreground">
                    {saveStage.isPending ? t("app.pipelineSettings.savingChanges", { defaultValue: "Saving changes…" }) : t("app.pipelineSettings.youHaveUnsavedChanges", { defaultValue: "You have unsaved changes." })}
                  </span>
                  <Button
                    type="submit"
                  ...
                  >
                    ...
                    {saveStage.isPending ? t("app.pipelineSettings.saving", { defaultValue: "Saving..." }) : t("app.pipelineSettings.saveStage", { defaultValue: "Save stage" })}
                  </Button>
                </div>
              ) : null}
            </form>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("app.pipelineSettings.deleteStage", { defaultValue: "Delete stage" })}</DialogTitle>
            <DialogDescription>
              {t("app.pipelineSettings.delete", { defaultValue: "Delete " })}{selectedStage?.name ?? t("app.pipelineSettings.thisStage", { defaultValue: "this stage" })} {t("app.pipelineSettings.fromThisPipelineConnectedStageTransitionsAreRemoved", { defaultValue: "from this pipeline. Connected stage transitions are removed." })}</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            {stages.length > 1 ? (
              <label className="block space-y-1.5 text-sm font-medium">
                <span>{t("app.pipelineSettings.moveExistingItemsTo", { defaultValue: "Move existing items to" })}</span>
                <select
                  aria-label={t("app.pipelineSettings.moveExistingItemsTo", { defaultValue: "Move existing items to" })}
              ...
              <p className="text-sm text-muted-foreground">
                {t("app.pipelineSettings.thisIsTheOnlyStageDeletionSucceedsOnlyIfItHasNoItems", { defaultValue: "This is the only stage. Deletion succeeds only if it has no items." })}</p>
            )}
            {deleteStage.error ? (
          ...
          <DialogFooter>
            ...
            >
              <Trash2 className="h-4 w-4" />
              {deleteStage.isPending ? t("app.pipelineSettings.deleting", { defaultValue: "Deleting..." }) : t("app.pipelineSettings.deleteStage", { defaultValue: "Delete stage" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("app.pipelineSettings.archivePipeline", { defaultValue: "Archive pipeline" })}</DialogTitle>
            <DialogDescription>
              {t("app.pipelineSettings.archivingHidesThisPipelineFromEverydayViewsItsStagesAndItemsAreKeptAndCanBeRestoredLater", { defaultValue: "Archiving hides this pipeline from everyday views. Its stages and items are kept and can be restored later." })}</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <label className="block space-y-1.5 text-sm font-medium">
              <span>{t("app.pipelineSettings.type", { defaultValue: "Type " })}{pipeline.name} {t("app.pipelineSettings.toConfirm", { defaultValue: "to confirm" })}</span>
              <Input
                aria-label={t("app.pipelineSettings.archiveConfirmation", { defaultValue: "Archive confirmation" })}
          ...
          <DialogFooter>
            ...
            >
              <Archive className="h-4 w-4" />
              {archivePipeline.isPending ? t("app.pipelineSettings.archiving", { defaultValue: "Archiving..." }) : t("app.pipelineSettings.archivePipeline", { defaultValue: "Archive pipeline" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
