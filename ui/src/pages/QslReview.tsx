...
function reviewStateBadge(state: string) {
  switch (state) {
    ...
    case "accepted_risk":
      return <Badge variant="outline" className="text-[10px] border-amber-500 text-amber-600">Accepted Risk</Badge>;
    case "escalated":
      return <Badge variant="destructive" className="text-[10px]">Escalated</Badge>;
    default:
