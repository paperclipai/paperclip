  ...
  switch (specifier) {
    ...
    case "sdk-ui":
      source = `
        ...
        const { usePluginData, usePluginAction, useHostContext, usePluginStream, usePluginToast, usePluginNavigate } = SDK;
        export { usePluginData, usePluginAction, useHostContext, usePluginStream, usePluginToast, usePluginNavigate };
      `;
      break;
  }
