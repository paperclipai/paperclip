  ...
  switch (specifier) {
    ...
    case "sdk-ui":
      source = `
        ...
        const IssueLink = SDK.IssueLink ?? missing("IssueLink");
        const IssueRow = SDK.IssueRow ?? missing("IssueRow");
        const ManagedRoutinesList = SDK.ManagedRoutinesList ?? missing("ManagedRoutinesList");
        export { usePluginData, usePluginAction, useHostContext, useHostLocation, useHostNavigation, usePluginStream, usePluginToast, MetricCard, StatusBadge, DataTable, TimeseriesChart, MarkdownBlock, MarkdownEditor, KeyValueList, ActionBar, LogView, JsonTree, Spinner, ErrorBoundary, FileTree, IssuesList, AssigneePicker, ProjectPicker, IssueLink, IssueRow, ManagedRoutinesList };
      `;
      break;
  }
