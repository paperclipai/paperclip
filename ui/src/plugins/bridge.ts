 ...
 * `useHostContext` from `@odysseus/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__odysseusPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Odysseus path to the active company scope.
 *
