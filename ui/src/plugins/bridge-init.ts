 ...
 *
 * This is placed on `globalThis.__aiteamcorpPluginBridge__` and consumed by
...
declare global {
  ...
  var __aiteamcorpPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__aiteamcorpPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__aiteamcorpPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
