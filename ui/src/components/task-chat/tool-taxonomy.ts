...
const EXACT_ACTIONS: Record<string, ExactAction> = {
  ...
  get_workspace_runtime: { action: "read", running: "Reading worktree status", completed: "Read worktree status" },
  control_workspace_service: { action: "run", running: "Controlling a worktree service", completed: "Controlled a worktree service" },
