  ...
  return (
    <div className="flex flex-col gap-2 py-2">
      <div className="flex items-center gap-2 px-1 text-xs text-muted-foreground">
        <span className="font-medium text-foreground">{t("localizationTaskRuntime.ui_Plan_8icj76")}</span>
        <span>{t("localizationTaskRuntime.planRevision", { number: plan.revision })}</span>
        <span className="ml-auto">
          {t("localizationTaskRuntime.planDone", { done, total: plan.entries.length })}
        </span>
      </div>
