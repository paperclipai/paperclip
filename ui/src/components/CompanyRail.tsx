...
import { Paperclip as ClipIcon, Plus } from "lucide-react";
...
import type { Company } from "@aiteamcorp/shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* AiTeamCorp logo - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <ClipIcon className="h-5 w-5 text-foreground" />
      </div>
