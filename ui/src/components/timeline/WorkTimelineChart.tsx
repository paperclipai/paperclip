    ...
    <div className="mt-2 border-t border-border bg-card px-3.5 py-2">
      ...
      >
        ...
        <MiniMapHandle
          ...
          label={t("app.workTimelineChart.dragLeftEdge", { defaultValue: "Drag left edge to resize visible range" })}
        ...
        <MiniMapHandle
          ...
          label={t("app.workTimelineChart.dragRightEdge", { defaultValue: "Drag right edge to resize visible range" })}
