    ...
    <>
      ...
      {collectingDownvoteReason ? (
        <div className="mt-2 rounded-md border border-border/60 bg-accent/20 p-3">
          <div className="mb-2 text-sm font-medium">{t("feedbackNote.placeholder")}</div>
          <Textarea
            value={downvoteReason}
            onChange={(event) => setDownvoteReason(event.target.value)}
            placeholder={t("feedbackNote.placeholder")}
          ...
          <div className="mt-3 flex items-center justify-end gap-2">
            ...
            >
              {isSaving ? t("feedbackNote.saving") : t("feedbackNote.save")}
            </Button>
          </div>
        </div>
      ) : null}
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("feedbackSharing.title")}</DialogTitle>
            <DialogDescription>
          ...
          <DialogFooter>
            ...
            >
              {isSaving ? t("feedbackNote.saving") : t("feedbackSharing.dontAllow")}
            </Button>
            <Button
              type="button"
              disabled={!pendingVote || isSaving}
            ...
            >
              {isSaving ? t("feedbackNote.saving") : t("feedbackSharing.alwaysAllow")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
