...
import { BrainCircuit, ChevronLeft, Github, KeyRound, MailPlus, MonitorCog, Settings, Shield, ShieldCheck, SlidersHorizontal } from "lucide-react";
    ...
    <aside className="w-full h-full min-h-0 border-r border-border/60 bg-background/90 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/75 flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/company/settings/authenticators" label="Authenticators" icon={ShieldCheck} end />
