...
export function Layout() {
  ...
  return (
    <GeneralSettingsProvider value={{ keyboardShortcutsEnabled }}>
      ...
      >
        {t("common.accessibility.skip_to_main")}
      </a>
      <WorktreeBanner />
      ...
      <div className={cn("min-h-0 flex-1", isMobile ? "w-full" : "flex overflow-hidden")}>
        {isMobile && sidebarOpen && (
          <button
            ...
            aria-label={t("common.accessibility.close_sidebar")}
          />
        )}
            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                >
                  ...
                  <span className="truncate">{t("common.navigation.documentation")}</span>
                </a>
                {health?.version && (
                  <Tooltip>
                ...
                <Button variant="ghost" size="icon-sm" className="text-muted-foreground shrink-0" asChild>
                  <Link
                    ...
                    aria-label={t("common.navigation.instance_settings")}
                    title={t("common.navigation.instance_settings")}
                    onClick={() => {
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={t("common.accessibility.switch_theme", { theme: nextTheme })}
                  title={t("common.accessibility.switch_theme", { theme: nextTheme })}
                >
