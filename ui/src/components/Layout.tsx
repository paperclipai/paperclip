...
export function Layout() {
  ...
  const themeToggleLabel = nextTheme === "dark" ? t("topbar.switchToDarkMode") : t("topbar.switchToLightMode");
            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                >
                  ...
                  <span className="truncate">{t("topbar.documentation")}</span>
                </a>
                {health?.version && (
                  <Tooltip>
                ...
                <Button variant="ghost" size="icon-sm" className="text-muted-foreground shrink-0" asChild>
                  <Link
                    ...
                    aria-label={t("topbar.instanceSettings")}
                    title={t("topbar.instanceSettings")}
                    onClick={() => {
