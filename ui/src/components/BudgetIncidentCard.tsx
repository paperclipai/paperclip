...
export function BudgetIncidentCard({
  ...
  return (
    <Card className="overflow-hidden border-red-200 bg-red-50/80 text-red-950 dark:border-red-500/30 dark:bg-red-950/35 dark:text-red-50">
      <CardHeader className="px-5 pt-5 pb-3">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <div className="text-[11px] uppercase tracking-[0.22em] text-red-700 dark:text-red-200/80">
            ...
            <CardDescription className="mt-1 text-red-800 dark:text-red-100/75">
      ...
      <CardContent className="space-y-4 px-5 pb-5 pt-0">
        <div className="flex items-start gap-2 rounded-xl border border-red-200 bg-white/70 px-3 py-2 text-sm text-red-900 dark:border-red-400/20 dark:bg-red-500/10 dark:text-red-50/90">
