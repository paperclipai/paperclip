...
describe("AppConnectionSidebar", () => {
  ...
  it("renders a back link and the connected app tabs (including Test)", async () => {
    ...
    expect(container.querySelectorAll("[data-to]").length).toBe(8);
    ...
    expect(sidebarNavItemMock).toHaveBeenCalledWith(expect.objectContaining({ to: "/apps/conn-1/grants", label: "Grants", end: true }));
    expect(sidebarNavItemMock).toHaveBeenCalledWith(expect.objectContaining({ to: "/apps/conn-1/usage", label: "Usage", end: true }));
  ...
  it("renders application-mode tabs under the not-connected app route", async () => {
    ...
    expect(sidebarNavItemMock).toHaveBeenCalledWith(expect.objectContaining({ to: "/apps/app/app-1/grants", label: "Grants", end: true }));
    expect(sidebarNavItemMock).toHaveBeenCalledWith(expect.objectContaining({ to: "/apps/app/app-1/usage", label: "Usage", end: true }));
    ...
    expect(container.querySelectorAll("[data-to]").length).toBe(7);
  });
