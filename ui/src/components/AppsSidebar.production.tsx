    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      <div className="flex flex-col gap-1 px-3 py-3 shrink-0">
        ...
        <div className="flex items-center gap-2 px-2 py-1">
          ...
          <span className="flex-1 truncate text-sm font-bold text-foreground">{t("localizationConnections.connectors16")}</span>
        </div>
      </div>

      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="px-3 pb-1 text-(length:--text-micro) font-semibold uppercase tracking-wide text-muted-foreground">{t("localizationConnections.connectors16")}</div>
