...
export function ProviderQuotaCard({
  ...
  const { t } = useTranslation("component.providerQuotaCard");
        ...
        {hasBudget && (
          <div className="space-y-3">
            <QuotaBar
              ...
              rightLabel={`${Math.round(budgetPct)}% ${t("ofAllocation")}`}
            ...
            <QuotaBar
              ...
              rightLabel={`~${formatCents(Math.round(weeklyBudgetShare))} ${t("perWk")}`}
            ...
            <div className="space-y-2">
              ...
              {subSharePct > 0 && (
                <>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {Math.round(subSharePct)}% {t("ofTokenUsageViaSubscription")}
                  </p>
                </>
              )}
            </div>
                  ...
                  <div key={`${row.provider}:${row.model}`} className="space-y-1.5">
                    ...
                    <div className="relative h-2 w-full border border-border overflow-hidden">
                      <div
                        ...
                        title={`${Math.round(tokenPct)}% ${t("ofProviderTokens")}`}
                      />
                      ...
                      <div
                        ...
                        style={{ width: `${costPct}%` }}
                        title={`${Math.round(costPct)}% ${t("ofProviderCost")}`}
                      />
                    </div>
                  </div>
                );
