...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter } from "@odysseus/shared";
...
// Canonical type lives in @odysseus/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@odysseus/adapter-utils";
