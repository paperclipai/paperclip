...
function RunCardRecoveryChip({ action }: { action: IssueRecoveryAction }) {
  ...
  return (
    <span
      ...
      title={t("components.activeAgentsPanel.recoveryChipTitle", {
        label: tone.label,
...
export function ActiveAgentsPanel({
  ...
  const { t } = useTranslation();
  const resolvedTitle = title ?? t("components.activeAgentsPanel.defaultTitle", { defaultValue: "Agents" });
  const resolvedEmptyMessage =
    emptyMessage ?? t("components.activeAgentsPanel.defaultEmptyMessage", { defaultValue: "No recent agent runs." });
