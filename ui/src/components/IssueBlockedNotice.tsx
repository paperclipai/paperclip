...
/**
 * Blue "Waiting on live work" variant (PAP-13202) — rendered in place of the
...
export function IssueBlockedNotice({
  ...
  // Blue "Waiting on live work" variant (PAP-13202): the blocker chain is a
  // healthy plan executing in order and something in it is live. `covered` is
