...
export function IssueProperties({
  ...
  const issueActualHumanSeconds = actualHumanSecondsForIssue(issue);
      ...
      <div className="space-y-1">
        ...
        <div className="mt-2 rounded-md border border-border/80 bg-muted/20 p-3">
          ...
          <PropertyRow label="Human time">
            <Clock className="h-3.5 w-3.5 shrink-0 text-muted-foreground" />
            <span className="text-sm tabular-nums text-foreground">{formatActualAiTime(issueActualHumanSeconds)}</span>
            <span className="text-xs text-muted-foreground">created to done/now</span>
          </PropertyRow>
