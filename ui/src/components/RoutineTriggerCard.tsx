...
const signingModes = ["bearer", "hmac_sha256", "github_hmac", "fireflies_hmac", "none"];
const SIGNING_MODES_WITHOUT_REPLAY_WINDOW = new Set(["bearer", "github_hmac", "fireflies_hmac", "none"]);
