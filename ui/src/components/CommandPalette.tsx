    ...
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandList>
        ...
        {visibleIssues.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("command.issues")}>
        ...
        {agents.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("command.agents")}>
