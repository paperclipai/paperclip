  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        <PropertyRow label={t("goalProperties.status", { defaultValue: "Status" })}>
          {onUpdate ? (
            <PickerButton
              current={goal.status}
        ...
        <PropertyRow label={t("goalProperties.level", { defaultValue: "Level" })}>
          {onUpdate ? (
            <PickerButton
              current={goal.level}
              options={GOAL_LEVELS}
        ...
        <PropertyRow label={t("goalProperties.owner", { defaultValue: "Owner" })}>
          {ownerAgent ? (
            <Link
        ...
        {goal.parentId && (
          <PropertyRow label={t("goalProperties.parentGoal", { defaultValue: "Parent Goal" })}>
            <Link
      ...
      <div className="space-y-1">
        <PropertyRow label={t("goalProperties.created", { defaultValue: "Created" })}>
          <span className="text-sm">{formatDate(goal.createdAt)}</span>
        </PropertyRow>
        <PropertyRow label={t("goalProperties.updated", { defaultValue: "Updated" })}>
