...
export function IssueSiblingNavigation({ navigation, linkState }: IssueSiblingNavigationProps) {
  ...
  return (
    <nav
      aria-label={t("localizationIssueChrome.subtaskNavigation")}
...
function SiblingLink({
  ...
  const label = t(direction === "previous" ? "localizationIssueChrome.previous" : "localizationIssueChrome.next");
  ...
  return (
    <Link
      ...
      aria-label={t(direction === "previous" ? "localizationIssueChrome.previousSubtask" : "localizationIssueChrome.nextSubtask", { identifier, title: issue.title })}
      className={cn(
