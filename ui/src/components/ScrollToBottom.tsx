...
export function ScrollToBottom() {
  ...
  return (
    <button
      onClick={scroll}
      className={cn(
        "fixed bottom-[calc(1.5rem+5rem+env(safe-area-inset-bottom))] right-6 z-40 flex h-9 w-9 items-center justify-center rounded-full border border-border bg-background hover:bg-accent transition-[background-color,right] duration-200 md:bottom-6",
