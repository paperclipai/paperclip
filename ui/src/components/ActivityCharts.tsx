...
import { translatePriority, translateStatus } from "../lib/locale";
...
export function PriorityChart({ issues }: { issues: { priority: string; createdAt: Date }[] }) {
  ...
  return (
    <div>
      ...
      <DateLabels days={days} />
      <ChartLegend items={priorityOrder.map((p) => ({ color: priorityColors[p], label: translatePriority(p) }))} />
    </div>
  );
}
...
const statusLabels: Record<string, string> = {
  todo: translateStatus("todo"),
  in_progress: translateStatus("in_progress"),
  in_review: translateStatus("in_review"),
  done: translateStatus("done"),
  blocked: translateStatus("blocked"),
  cancelled: translateStatus("cancelled"),
  backlog: translateStatus("backlog"),
};
