    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="border border-border">
          <div className="grid grid-cols-[80px_1fr_120px_110px_90px_90px_100px] gap-2 px-3 py-2 text-[11px] uppercase text-muted-foreground border-b border-border">
            <span>ID</span>
            <span>Title</span>
            <span>Assignee</span>
            <span>Sprint</span>
            ...
            .map((issue) => {
              ...
              return (
                <Link
                  key={issue.id}
                  to={issueUrl(issue)}
                  className="grid grid-cols-[80px_1fr_120px_110px_90px_90px_100px] gap-2 px-3 py-2 text-sm items-center border-b border-border last:border-b-0 hover:bg-accent/50"
                >
                  ...
                  <span className="text-xs">
                    {sprint ? (
                      <span className="inline-flex items-center px-1.5 py-0.5 bg-muted rounded-sm tabular-nums">
                        {sprint}
                      </span>
                    ) : (
