      ...
      >
        <div className="w-80 flex-1 flex flex-col min-w-(--sz-320px) min-h-0">
          <div className="flex items-center justify-between px-4 py-2 border-b border-border">
            <span className="text-sm font-medium">{t("issueProperties.properties")}</span>
      ...
      >
        {!isFixed && panelVisible ? (
          <div
            ...
            aria-label={t("issueProperties.resizePanel")}
          ...
          <div className="flex items-center justify-between gap-2 px-4 border-b border-border">
            ...
            <div className="flex items-center gap-1 py-2">
              <Button
                ...
                size="icon-xs"
                className="size-7"
                title={maximized ? t("issueProperties.restorePanel") : t("issueProperties.maximizePanel")}
                aria-label={maximized ? t("issueProperties.restorePanel") : t("issueProperties.maximizePanel")}
