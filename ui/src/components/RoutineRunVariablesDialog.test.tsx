...
import type { Agent, ExecutionWorkspace, Project } from "@odysseus/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/odysseus/project-1",
      effectiveLocalFolder: "/tmp/odysseus/project-1",
