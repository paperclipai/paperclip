...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@aiteamcorp/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative aiteamcorp-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("aiteamcorp-mdxeditor", !bordered && "aiteamcorp-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "aiteamcorp-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
