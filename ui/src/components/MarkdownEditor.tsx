...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor(
  ...
  imageUploadHandlerRef.current = imageUploadHandler; // eslint-disable-line react-hooks/refs
  ...
  const plugins = useMemo<RealmPlugin[]>(() => {
    ...
    if (imageHandler) {
      all.push(imagePlugin({ imageUploadHandler: imageHandler })); // eslint-disable-line react-hooks/refs
    }
    return all;
  }, [hasImageUpload]);
