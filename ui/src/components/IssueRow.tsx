  ...
  return (
    ...
    >
      ...
      <span className="flex shrink-0 items-center gap-1 pt-px sm:hidden">
        {mobileLeading ?? <StatusIcon status={issue.status} issueId={issue.id} blockerAttention={issue.blockerAttention} size="md" className={selectedStatusClass} />}
        {parkedBlockerIndicator}
      </span>
          ...
          {desktopMetaLeading ?? (
            <>
              <span className="hidden shrink-0 items-center gap-1 sm:inline-flex">
                <StatusIcon status={issue.status} issueId={issue.id} blockerAttention={issue.blockerAttention} size="md" className={selectedStatusClass} />
              </span>
              {checklistStep}
