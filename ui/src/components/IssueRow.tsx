  ...
  return (
    ...
    >
      <span className="shrink-0 pt-px sm:hidden">
        {mobileLeading ?? <StatusIcon status={issue.status} unresolvedBlockerCount={issue.unresolvedBlockerCount} className={selectedStatusClass} />}
      </span>
          ...
          {desktopMetaLeading ?? (
            <>
              <span className="hidden shrink-0 sm:inline-flex">
                <StatusIcon status={issue.status} unresolvedBlockerCount={issue.unresolvedBlockerCount} className={selectedStatusClass} />
              </span>
