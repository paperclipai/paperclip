...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("createAgentDialog.createIssueTitle"),
      description: t("createAgentDialog.createIssueDescription"),
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("createAgentDialog.title")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("createAgentDialog.recommendation")}
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                {t("createAgentDialog.askCeo")}
              </Button>
              ...
              <div className="text-center">
                ...
                >
                  {t("createAgentDialog.advancedConfig")}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                >
                  ...
                  {t("createAgentDialog.back")}
                </button>
                <p className="text-sm text-muted-foreground">
                  {t("createAgentDialog.chooseAdapter")}
                </p>
              </div>
                  ...
                  >
                    {opt.recommended && (
                      <span className="absolute -top-1.5 right-1.5 bg-green-500 text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none">
                        {t("createAgentDialog.recommended")}
                      </span>
                    )}
