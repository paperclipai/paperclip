...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      description: t("newAgent.askCeoDescription"),
    });
  }
  ...
  const createAgentInviteMutation = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("newAgent.failedInvite"),
        body: error instanceof Error ? error.message : t("newAgent.unknownError"),
        tone: "error",
      });
    },
  });
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("newAgent.addNewAgent")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between gap-3">
                    <h2 className="text-sm font-semibold">{t("newAgent.onboardingPrompt")}</h2>
                    {latestAgentPromptCopied ? (
