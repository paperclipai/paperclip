...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: "새 Jarvis 만들기",
      description: "(필요한 Jarvis 역할과 업무 범위를 입력하세요)",
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">새 Jarvis 추가</span>
          <Button
            variant="ghost"
            size="icon-xs"
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  CEO Jarvis에게 설정을 맡기는 것을 권장합니다. 조직 구조,
                  보고 체계, 권한, 실행 adapter를 함께 맞출 수 있습니다.
                </p>
              </div>
