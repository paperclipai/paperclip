...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: newAgent.ceoIssueTitle,
      description: newAgent.ceoIssueDescription,
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{newAgent.dialogHeader}</span>
          <Button
            variant="ghost"
            size="icon-xs"
