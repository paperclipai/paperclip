...
describe("Sidebar", () => {
  ...
  it("shows Skills directly below Artifacts in Work", async () => {
    ...
    const workSection = sections.find((section) => section.textContent?.includes("Work"));
    const companySection = sections.find((section) => section.textContent?.includes("Company"));
