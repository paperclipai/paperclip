...
describe("TaskChatThread runtime transcript selection", () => {
  ...
  ] as const)("hides a redundant cancelled continuation (%s, %s)", (runtimeMode, errorCode) => {
    render(<TaskChatThread comments={[]} onAdd={async () => {}} linkedRuns={[{
      runId: "connection-continuation-skipped", runtimeMode, status: "cancelled", errorCode, startedAt: null,
  ...
  it("keeps a cancellation visible when the run had already started", () => {
    render(<TaskChatThread comments={[]} onAdd={async () => {}} linkedRuns={[{
      runId: "started-cancellation", runtimeMode: "legacy", status: "cancelled",
      errorCode: "issue_terminal_status", agentId: "agent-1", agentName: "Runner",
      adapterType: "paperclip_runner", createdAt: "2026-09-07T18:00:00.000Z",
      startedAt: "2026-09-07T18:00:00.500Z", finishedAt: "2026-09-07T18:00:01.000Z",
    }]} />);
