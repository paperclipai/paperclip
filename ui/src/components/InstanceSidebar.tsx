...
import { Clock3, Cpu, FlaskConical, Puzzle, RefreshCw, Settings, SlidersHorizontal } from "lucide-react";
    ...
    >
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/instance/settings/updates" label="Updates" icon={RefreshCw} end />
