    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          <SidebarNavItem to="/instance/settings/profile" label={t("settings.profile")} icon={UserRoundPen} end />
          <SidebarNavItem to="/instance/settings/general" label={t("settings.general")} icon={SlidersHorizontal} end />
          <SidebarNavItem to="/instance/settings/access" label={t("settings.access")} icon={Shield} end />
          ...
          <SidebarNavItem to="/instance/settings/plugins" label={t("settings.plugins")} icon={Puzzle} />
          <SidebarNavItem to="/instance/settings/adapters" label={t("settings.adapters")} icon={Cpu} />
          {(plugins ?? []).length > 0 ? (
