...
import { BrainCircuit, Clock3, Cpu, FlaskConical, Puzzle, Settings, Shield, SlidersHorizontal, UserRoundPen } from "lucide-react";
    ...
    <aside className="w-full h-full min-h-0 border-r border-border/60 bg-background/90 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/75 flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/instance/settings/improvements" label="Improvements" icon={BrainCircuit} end />
