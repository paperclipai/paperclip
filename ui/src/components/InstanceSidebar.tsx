    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          <SidebarNavItem to="/instance/settings/profile" label={t("nav.instanceSidebar.profile")} icon={UserRoundPen} end />
          <SidebarNavItem to="/instance/settings/general" label={t("nav.instanceSidebar.general")} icon={SlidersHorizontal} end />
          <SidebarNavItem to="/instance/settings/access" label={t("nav.instanceSidebar.access")} icon={Shield} end />
          <SidebarNavItem to="/instance/settings/heartbeats" label={t("nav.instanceSidebar.heartbeats")} icon={Clock3} end />
          <SidebarNavItem to="/instance/settings/experimental" label={t("nav.instanceSidebar.experimental")} icon={FlaskConical} />
          <SidebarNavItem to="/instance/settings/plugins" label={t("nav.instanceSidebar.plugins")} icon={Puzzle} />
          <SidebarNavItem to="/instance/settings/adapters" label={t("nav.instanceSidebar.adapters")} icon={Cpu} />
