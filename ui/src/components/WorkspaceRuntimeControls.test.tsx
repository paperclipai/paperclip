...
function createRuntimeService(overrides: Partial<WorkspaceRuntimeService> = {}): WorkspaceRuntimeService {
  return {
    ...
    startedByAgentId: overrides.startedByAgentId ?? null,
    startedByUserId: overrides.startedByUserId ?? null,
    responsibleUserId: overrides.responsibleUserId ?? null,
    lastControlledByAgentId: overrides.lastControlledByAgentId ?? null,
    lastControlledByUserId: overrides.lastControlledByUserId ?? null,
    lastControlledByRunId: overrides.lastControlledByRunId ?? null,
    lastControlledAt: overrides.lastControlledAt ?? null,
