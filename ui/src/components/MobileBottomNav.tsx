...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      ...
      { type: "link", to: "/issues", label: t("app.pages.tasks", { defaultValue: "Tasks" }), icon: CircleDot },
      { type: "action", label: t("common.create", { defaultValue: "Create" }), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("app.pages.agents", { defaultValue: "Agents" }), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("app.pages.inbox", { defaultValue: "Inbox" }),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("app.mobileBottomNav.mobileNavigation", { defaultValue: "Mobile navigation" })}
    >
