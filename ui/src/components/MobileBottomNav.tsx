...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("nav.items.home"), icon: House },
      { type: "link", to: "/issues", label: t("nav.items.tasks"), icon: CircleDot },
      { type: "action", label: t("nav.items.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("nav.items.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
