...
export function SidebarStarredProjects() {
  ...
  return (
    <div className="flex flex-col gap-0.5" aria-label={t("localizationSidebar.starredProjects")}>
        ...
        const link = (
          ...
          >
            ...
            {!rail && project.pauseReason === "budget" ? (
              <BudgetSidebarMarker title={t("localizationSidebar.projectBudgetPaused")} />
            ) : null}
          </NavLink>
        );
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  >
                    ...
                    <span>{t("localizationSidebar.removeStar")}</span>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                    onClick={() => {
                  ...
                  >
                    ...
                    <span>{t("localizationSidebar.leaveProject")}</span>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ) : null}
