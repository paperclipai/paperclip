...
import { agentConfigHelp } from "../lib/i18n";

/* ---- Help text for (?) tooltips — backed by centralized copy in `agentConfigHelp` ---- */
export const help: Record<string, string> = agentConfigHelp;
