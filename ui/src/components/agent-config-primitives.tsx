...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: local CLI (Claude, Codex, GitHub Copilot, OpenCode), OpenClaw Gateway, spawned process, or generic HTTP webhook.",
  ...
  localCommand: "Override the path to the CLI command you want the adapter to call (e.g. /usr/local/bin/claude, codex, copilot, opencode).",
