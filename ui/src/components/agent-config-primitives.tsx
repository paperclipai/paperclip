...
export const help: Record<string, string> = {
  ...
  codingModel: "Model used when handing off to the coding CLI adapter.",
  allowLocalTools: "Allow the local planning model to run bash tools (off means plan-only).",
  localToolMode: "Local tool access for planning: off, read-only, or full.",
