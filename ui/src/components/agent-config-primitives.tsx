...
export const help: Record<string, string> = {
  ...
  cwd: "Deprecated legacy working directory fallback for local adapters. Existing agents may still carry this value, but new configurations should use project worktrees instead.",
  ...
  workspaceStrategy: "How Paperclip should realize an execution worktree for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  workspaceBaseRef: "Base git ref used when creating a worktree branch. Leave blank to use the resolved worktree ref or HEAD.",
  ...
  runtimeServicesJson: "Optional worktree runtime service definitions. Use this for shared app servers, workers, or other long-lived companion processes attached to the worktree.",
  ...
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Paperclip adds its standard wake and worktree fields.",
