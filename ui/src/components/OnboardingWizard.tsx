...
import type { AdapterEnvironmentTestResult } from "@odysseus/shared";
...
} from "@odysseus/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@odysseus/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@odysseus/adapter-gemini-local";
import { DEFAULT_OPENCODE_LOCAL_MODEL, isValidOpenCodeModelId } from "@odysseus/adapter-opencode-local";
...
export function OnboardingWizard() {
  ...
  const { data: adapterModels } = useQuery({
    ...
    // resolve against the local Odysseus host (environmentId = null).
