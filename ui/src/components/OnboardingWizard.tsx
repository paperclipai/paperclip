...
export function OnboardingWizard() {
  ...
  const [taskTitle, setTaskTitle] = useState(
    t("Hire your first engineer and create a hiring plan")
  );
  ...
  function reset() {
    ...
    setTaskTitle(t("Hire your first engineer and create a hiring plan"));
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            {t("Claude failed while ANTHROPIC_API_KEY is set. You can clear it in this CEO adapter config and retry the probe.")}
                          </p>
                          <Button
                            size="sm"
                            variant="outline"
