          ...
          >
            <div className="w-full max-w-md mx-auto my-auto px-8 py-12 shrink-0">
              ...
              <div className="flex items-center gap-0 mb-8 border-b border-border">
                {(
                  [
                    { step: 1 as Step, label: t("component.onboardingWizard.company"), icon: Building2 },
                    { step: 2 as Step, label: t("component.onboardingWizard.agent"), icon: Bot },
                    { step: 3 as Step, label: t("component.onboardingWizard.task"), icon: ListTodo },
                    { step: 4 as Step, label: t("component.onboardingWizard.launch"), icon: Rocket }
                  ] as const
              ...
              {step === 1 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("component.onboardingWizard.nameYourCompany")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("component.onboardingWizard.companyDescription")}
                      </p>
                    </div>
                  </div>
                  <div className="mt-3 group">
                    ...
                    >
                      {t("component.onboardingWizard.companyName")}
                    </label>
                    <input
                  ...
                  <div className="group">
                    ...
                    >
                      {t("component.onboardingWizard.missionGoal")}
                    </label>
                    <textarea
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50 resize-none min-h-[60px]"
                      placeholder={t("component.onboardingWizard.missionPlaceholder")}
                      value={companyGoal}
              ...
              {step === 2 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("component.onboardingWizard.createYourFirstAgent")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("component.onboardingWizard.howAgentWillRun")}
                      </p>
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t("component.onboardingWizard.agentName")}
                    </label>
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder={t("component.onboardingWizard.ceoPlaceholder")}
                      value={agentName}
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            {t("component.onboardingWizard.anthropicApiKeyOverride")}
                          </p>
                          <Button
                            size="sm"
                            variant="outline"
              ...
              {step === 3 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("component.onboardingWizard.giveItSomethingToDo")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("component.onboardingWizard.smallTaskToStart")}
                      </p>
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t("component.onboardingWizard.taskTitle")}
                    </label>
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder={t("component.onboardingWizard.taskTitlePlaceholder")}
                      value={taskTitle}
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t("component.onboardingWizard.descriptionOptional")}
                    </label>
                    <textarea
                      ref={textareaRef}
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50 resize-none min-h-[120px] max-h-[300px] overflow-y-auto"
                      placeholder={t("component.onboardingWizard.descriptionPlaceholder")}
              ...
              {step === 4 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("component.onboardingWizard.readyToLaunch")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("component.onboardingWizard.everythingSetUp")}
                      </p>
                    </div>
                  </div>
                  <div className="border border-border divide-y divide-border">
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("component.onboardingWizard.company")}</p>
                      </div>
                    ...
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("component.onboardingWizard.task")}</p>
                      </div>
                      <Check className="h-4 w-4 text-green-500 shrink-0" />
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  {step === 1 && (
                    ...
                    >
                      ...
                      {loading ? t("component.onboardingWizard.creating") : t("component.onboardingWizard.next")}
                    </Button>
                  )}
                  {step === 2 && (
                    <Button
                  ...
                  {step === 4 && (
                    <Button size="sm" disabled={loading} onClick={handleLaunch}>
                      ...
                      {loading ? t("component.onboardingWizard.creating") : t("component.onboardingWizard.createAndOpenIssue")}
                    </Button>
                  )}
                </div>
              </div>
