  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-base">{t("app.pathInstructionsModal.howToGetAFullPath", { defaultValue: "How to get a full path" })}</DialogTitle>
          <DialogDescription>
...
export function ChoosePathButton({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      >
        {t("app.pathInstructionsModal.choose", { defaultValue: "Choose" })}
      </button>
