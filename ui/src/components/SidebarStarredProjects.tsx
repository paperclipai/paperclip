      ...
      {starredProjects.map((project) => {
        ...
        const link = (
          <NavLink
            ...
            className={cn(
              "flex min-w-0 flex-1 items-center gap-2.5 mx-2 rounded-lg px-2 py-1.5 pl-6 pointer-coarse:py-1 pr-8 text-(length:--text-compact) font-medium transition-colors",
              isActive
