...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t("goals:levels.company"),
    team: t("goals:levels.team"),
    agent: t("goals:levels.agent"),
    task: t("goals:levels.task"),
  };
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("goals:newDialog.newSubGoal") : t("goals:newDialog.title")}</span>
          </div>
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("goals:newDialog.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("goals:newDialog.parent")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("common:creating") : newGoalDefaults.parentId ? t("goals:newDialog.createSubGoal") : t("goals:newDialog.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
