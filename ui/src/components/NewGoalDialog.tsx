...
const getLevelLabels = (): Record<string, string> => ({
  company: t("components.newGoalDialog.levelCompany", { defaultValue: "Company" }),
  team: t("components.newGoalDialog.levelTeam", { defaultValue: "Team" }),
  agent: t("components.newGoalDialog.levelAgent", { defaultValue: "Agent" }),
  task: t("components.newGoalDialog.levelTask", { defaultValue: "Task" }),
});
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("components.newGoalDialog.headerNewSubGoal", { defaultValue: "New sub-goal" }) : t("components.newGoalDialog.headerNewGoal", { defaultValue: "New goal" })}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("components.newGoalDialog.titlePlaceholder", { defaultValue: "Goal title" })}
            value={title}
        ...
        <div className="px-4 pb-2 overflow-y-auto max-h-[50vh]">
          <MarkdownEditor
            ...
            placeholder={t("components.newGoalDialog.descriptionPlaceholder", { defaultValue: "Add description..." })}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("components.newGoalDialog.parentGoal", { defaultValue: "Parent goal" })}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("components.newGoalDialog.creating", { defaultValue: "Creating…" }) : newGoalDefaults.parentId ? t("components.newGoalDialog.createSubGoal", { defaultValue: "Create sub-goal" }) : t("components.newGoalDialog.createGoal", { defaultValue: "Create goal" })}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
