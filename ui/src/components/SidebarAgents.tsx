...
const AGENT_SORT_CHOICES = (t: (k: string) => string): SidebarSectionRadioChoice[] => [
        ...
        {(agent.pauseReason === "budget" || runCount > 0) && (
          <span className="ml-auto flex items-center gap-1.5 shrink-0">
            {agent.pauseReason === "budget" ? (
              <BudgetSidebarMarker title={t('sidebar.agentPausedByBudget')} />
            ) : null}
            {runCount > 0 ? (
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            aria-label={t('common.openActionsFor', { name: agent.name })}
          >
        ...
        <DropdownMenuContent align="end" className="w-44">
          ...
          <DropdownMenuItem
            ...
            title={isBudgetPaused ? t('sidebar.agentPausedByBudget') : undefined}
          >
  ...
  return (
    <SidebarSection
      ...
      menu={{
        ...
        radioChoices: AGENT_SORT_CHOICES(t),
        radioValue: sortMode,
