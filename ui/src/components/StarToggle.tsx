...
export function StarToggle({
  ...
  const ariaLabel = t(starred ? "localizationCommonChrome.unstarNamed" : "localizationCommonChrome.starNamed", { name: resourceName });
  ...
  if (size === "button") {
    return (
      <Button
        ...
        disabled={pending}
        onClick={handleClick}
        title={error ? t("localizationCommonChrome.saveRetry") : undefined}
        className={cn(
          error
