  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-[220px]">
        <DropdownMenuLabel>{terms.pluralTitle}</DropdownMenuLabel>
        <DropdownMenuSeparator />
