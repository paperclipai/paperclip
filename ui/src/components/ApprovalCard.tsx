            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-5 text-muted-foreground">
                  {t("approvalCard.created", { defaultValue: "Approval request created {{when}}", when: timeAgo(approval.createdAt) })}
                </p>
              </div>
            </div>
          </div>
              ...
              <>
                ...
                >
                  {pendingAction === "approve"
                    ? t("approvalCard.approving", { defaultValue: "Approving..." })
                    : t("approvalCard.approve", { defaultValue: "Approve" })}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
                ...
                >
                  {pendingAction === "reject"
                    ? t("approvalCard.rejecting", { defaultValue: "Rejecting..." })
                    : t("approvalCard.reject", { defaultValue: "Reject" })}
                </Button>
              </>
            )}
          </div>
