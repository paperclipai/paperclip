          ...
          >
            ...
            <CollapsibleContent>
              {group.items.map((issue) => (
                  ...
                  className="group flex items-start gap-2 py-2.5 pl-2 pr-3 text-sm border-b border-border last:border-b-0 cursor-pointer hover:bg-accent/50 transition-colors no-underline text-inherit sm:items-center sm:py-2 sm:pl-1"
                >
