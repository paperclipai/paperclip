  ...
  if (error) {
    const message =
      error instanceof Error
        ? error.message
        : t("components.blockedInboxView.errorTitle", {
            defaultValue: "Couldn't load the Blocked tab.",
          });
    return (
      <div
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 space-y-1">
            ...
            <p className="text-xs opacity-80">
              {t("components.blockedInboxView.errorBody", {
                message,
          ...
          >
            {isFetching
              ? t("components.blockedInboxView.tryingButton", { defaultValue: "Trying…" })
              : t("components.blockedInboxView.tryAgainButton", { defaultValue: "Try again" })}
          </Button>
        </div>
      </div>
    );
      ...
      >
        ...
        <div className="space-y-1">
          <p className="text-sm font-medium text-foreground">
            {t("components.blockedInboxView.emptyTitle", {
              defaultValue: "No work is stopped.",
            })}
          </p>
          <p className="text-xs text-muted-foreground">
            {t("components.blockedInboxView.emptyBody", {
              defaultValue:
  ...
  if (groups.length === 0) {
    return (
      <div className="space-y-3">
        ...
        >
          {t("components.blockedInboxView.noSearchResults", {
            defaultValue: "No stopped items match your search.",
          })}
        </div>
      </div>
    );
