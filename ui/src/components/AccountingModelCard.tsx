...
const SURFACES = [
  {
    title: i18n.t("components.AccountingModelCard.title"),
    description: i18n.t("components.AccountingModelCard.description"),
    icon: Database,
  ...
  {
    title: i18n.t("components.AccountingModelCard.title_1"),
    description: i18n.t("components.AccountingModelCard.description_1"),
    icon: ReceiptText,
  ...
  {
    title: i18n.t("components.AccountingModelCard.title_2"),
    description: i18n.t("components.AccountingModelCard.description_2"),
    icon: Gauge,
    ...
    <Card className="relative overflow-hidden border-border/70">
      ...
      <CardHeader className="relative px-5 pt-5 pb-2">
        <CardTitle className="text-sm font-semibold uppercase tracking-[0.22em] text-muted-foreground">
          {i18n.t("components.AccountingModelCard.cardtitle")}</CardTitle>
        <CardDescription className="max-w-2xl text-sm leading-6">
          {i18n.t("components.AccountingModelCard.carddescription")}</CardDescription>
      </CardHeader>
