  ...
  return (
    <Dialog {...props}>
      <DialogHeader className="sr-only">
        <DialogTitle>{title ?? t("component.ui.commandPalette.title")}</DialogTitle>
        <DialogDescription>{description ?? t("component.ui.commandPalette.description")}</DialogDescription>
      </DialogHeader>
      <DialogContent
