...
function CommandDialog({
  ...
  const resolvedTitle = title ?? t("uiCommand.title", { defaultValue: "Command Palette" })
  const resolvedDescription =
    description ?? t("uiCommand.description", { defaultValue: "Search for a command to run..." })
  return (
    <Dialog {...props}>
      ...
      >
        ...
        {showCloseButton && (
          ...
          >
            <XIcon />
            <span className="sr-only">{t("uiCommand.close", { defaultValue: "Close" })}</span>
          </DialogPrimitive.Close>
        )}
      </DialogContent>
    </Dialog>
