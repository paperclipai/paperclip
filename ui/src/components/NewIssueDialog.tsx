...
import { issueCreateStatuses, issueStatusLabel } from "../lib/issue-status";
...
const statuses = issueCreateStatuses.map((status) => ({
  value: status,
  label: issueStatusLabel(status),
  color: issueStatusText[status] ?? issueStatusTextDefault,
}));
