      ...
      >
                  ...
                  <div className="space-y-2">
                    {stagedAttachments.map((file) => (
                      <div key={file.id} className="flex items-start justify-between gap-3 rounded-md border border-border/70 px-3 py-2">
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="shrink-0 text-muted-foreground inline-flex items-center justify-center text-[13px] leading-none" aria-hidden>🔥</span>
                            <span className="truncate text-sm">{file.file.name}</span>
                          </div>
        ...
        <div className="flex items-center gap-1.5 px-4 py-2 border-t border-border flex-wrap shrink-0">
          ...
          <button
            ...
            disabled={createIssue.isPending}
          >
            <span className="inline-flex items-center justify-center text-[11px] leading-none" aria-hidden>🔥</span>
            Upload
          </button>
