      ...
      >
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <textarea
            ...
            placeholder={t("issues:newDialog.issueTitlePlaceholder", "Issue title")}
            rows={1}
            value={title}
            onChange={(e) => {
        ...
        <div className="px-4 pb-2 shrink-0">
          <div className="overflow-x-auto overscroll-x-contain">
            <div className="inline-flex items-center gap-2 text-sm text-muted-foreground flex-wrap sm:flex-nowrap sm:min-w-max">
              <span>{t("issues:newDialog.for")}</span>
              <InlineEntitySelector
                ...
                disablePortal
                noneLabel={t("issues:newDialog.noAssignee")}
                searchPlaceholder={t("issues:newDialog.searchAssignees")}
                emptyMessage={t("issues:newDialog.noAssigneesFound")}
                onChange={(value) => {
              ...
              />
              <span>{t("issues:newDialog.in")}</span>
              <InlineEntitySelector
                ref={projectSelectorRef}
                value={projectId}
                options={projectOptions}
                placeholder={t("common:labels.project")}
                disablePortal
                noneLabel={t("issues:newDialog.noProject")}
                searchPlaceholder={t("issues:newDialog.searchProjects")}
                emptyMessage={t("issues:newDialog.noProjectsFound")}
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">{t("issues:newDialog.executionWorkspace", "Execution workspace")}</div>
        ...
        >
          ...
          >
            <MarkdownEditor
              ...
              placeholder={t("issues:detail.addDescription")}
              bordered={false}
            ...
            <div className="mt-4 space-y-3 rounded-lg border border-border/70 p-3">
              {stagedDocuments.length > 0 ? (
                <div className="space-y-2">
                  <div className="text-xs font-medium text-muted-foreground">{t("issues:detail.documents")}</div>
                  <div className="space-y-2">
              ...
              {stagedAttachments.length > 0 ? (
                <div className="space-y-2">
                  <div className="text-xs font-medium text-muted-foreground">{t("common:labels.attachments")}</div>
                  <div className="space-y-2">
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border shrink-0">
          ...
          >
            {t("issues:newDialog.discardDraft", "Discard Draft")}
          </Button>
          <div className="flex items-center gap-3">
            <div className="min-h-5 text-right">
              {createIssue.isPending ? (
                <span className="inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                  ...
                  {t("issues:newDialog.creatingIssue", "Creating issue...")}
                </span>
              ) : createIssue.isError ? (
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? t("common:creating") : t("issues:newDialog.createIssue", "Create Issue")}</span>
              </span>
            </Button>
          </div>
        </div>
