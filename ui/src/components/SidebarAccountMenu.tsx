...
export function SidebarAccountMenu({
  ...
  const secondaryLabel =
    session?.user.email?.trim() || (deploymentMode === "authenticated" ? t('accountMenu.signedIn') : t('accountMenu.localBoard'));
  const accountBadge = deploymentMode === "authenticated" ? t('accountMenu.accountBadge') : t('accountMenu.localBadge');
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              />
              <MenuAction
                label={theme === "dark" ? t('accountMenu.switchToLight') : t('accountMenu.switchToDark')}
                description={t('accountMenu.toggleAppearance')}
