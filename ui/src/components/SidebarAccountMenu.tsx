          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                ...
                description={t("accountMenu.viewProfileDescription")}
                icon={UserRound}
                href={profileHref}
              ...
              <MenuAction
                ...
                description={t("accountMenu.editProfileDescription")}
                icon={UserRoundPen}
              ...
              <MenuAction
                ...
                description={t("accountMenu.instanceSettingsDescription")}
                icon={Settings}
              ...
              <MenuAction
                ...
                description={t("accountMenu.documentationDescription")}
                icon={BookOpen}
                href={DOCS_URL}
                external
              ...
              <MenuAction
                ...
                description={t("accountMenu.toggleAppearanceDescription")}
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-xs text-muted-foreground">
                      {t("accountMenu.signOutDescription")}
                    </span>
                  </span>
                </button>
              ) : null}
