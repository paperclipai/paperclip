...
const projectStatuses = [
  { value: "backlog", label: t("newProject.statusBacklog") },
  { value: "planned", label: t("newProject.statusPlanned") },
  { value: "in_progress", label: t("newProject.statusInProgress") },
  { value: "completed", label: t("newProject.statusCompleted") },
  { value: "cancelled", label: t("newProject.statusCancelled") },
];
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border">
          {createProject.isError ? (
            <p className="text-xs text-destructive">{t("newProject.createFailed")}</p>
          ) : (
            <span />
          )}
          <Button
