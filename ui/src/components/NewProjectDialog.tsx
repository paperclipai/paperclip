...
const getProjectStatuses = (t: (k: string) => string) => [
  { value: "backlog", label: t('issues.backlog') },
  { value: "planned", label: t('projects.planned') },
  { value: "in_progress", label: t('issues.in_progress') },
  { value: "completed", label: t('issues.done') },
