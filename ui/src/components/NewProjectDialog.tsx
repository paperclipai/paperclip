...
function useProjectStatuses() {
  ...
  return [
    { value: "backlog", label: t("newProjectDialog.status.backlog", { defaultValue: "Backlog" }) },
    { value: "planned", label: t("newProjectDialog.status.planned", { defaultValue: "Planned" }) },
    { value: "in_progress", label: t("newProjectDialog.status.inProgress", { defaultValue: "In Progress" }) },
    { value: "completed", label: t("newProjectDialog.status.completed", { defaultValue: "Completed" }) },
    { value: "cancelled", label: t("newProjectDialog.status.cancelled", { defaultValue: "Cancelled" }) },
  ];
}
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{t("newProjectDialog.title", { defaultValue: "New project" })}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("newProjectDialog.namePlaceholder", { defaultValue: "Project name" })}
            value={name}
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("newProjectDialog.descriptionPlaceholder", { defaultValue: "Add description..." })}
            bordered={false}
          ...
          {selectedGoals.map((goal) => (
            ...
            >
              ...
              <button
                ...
                aria-label={t("newProjectDialog.removeGoal", { defaultValue: "Remove goal {{name}}", name: goal.title })}
                type="button"
              >
                <X className="h-3 w-3" />
              </button>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border">
          {createProject.isError ? (
            <p className="text-xs text-destructive">{t("newProjectDialog.createError", { defaultValue: "Failed to create project." })}</p>
          ) : (
            <span />
          )}
          <Button
          ...
          >
            {createProject.isPending
              ...
              : t("newProjectDialog.create", { defaultValue: "Create project" })}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
