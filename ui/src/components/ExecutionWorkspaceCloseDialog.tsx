          ...
          <div className="space-y-4">
            ...
            {blockingIssues.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("pages.executionWorkspaceClose.blockingIssues")}</h3>
            ...
            {otherLinkedIssues.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("pages.executionWorkspaceClose.otherLinkedIssues")}</h3>
                <div className="space-y-2">
                  ...
                  {readiness.runtimeServices.map((service) => (
                    <div key={service.id} className="rounded-xl border border-border bg-background px-4 py-3 text-sm">
                      ...
                      <div className="mt-1 break-words text-xs text-muted-foreground">
                        {service.url ?? service.command ?? service.cwd ?? t("pages.agentDetail.noAdditionalDetails")}
                      </div>
                    </div>
                  ))}
                </div>
