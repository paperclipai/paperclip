...
export interface ValadrienOsIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface ValadrienOsIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: ValadrienOsIssueRuntimeReassignment;
}

interface UseValadrienOsIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: ValadrienOsIssueRuntimeSendOptions) => Promise<void>;
...
export function useValadrienOsIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseValadrienOsIssueRuntimeOptions) {
