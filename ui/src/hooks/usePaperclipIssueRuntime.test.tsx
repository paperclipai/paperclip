...
describe("usePaperclipIssueRuntime", () => {
  ...
  it("keeps the external-store adapter stable across unrelated rerenders", async () => {
    ...
    act(() => {
      root.render(<HookHarness messages={messages} isRunning={false} onSend={firstOnSend} />);
    });
    ...
    act(() => {
      root.render(<HookHarness messages={messages} isRunning={false} onSend={secondOnSend} />);
    });
  ...
  it("rebuilds the adapter when thread data changes", () => {
    ...
    act(() => {
      root.render(<HookHarness messages={firstMessages} isRunning={false} onSend={onSend} />);
    });
    ...
    act(() => {
      root.render(<HookHarness messages={secondMessages} isRunning={false} onSend={onSend} />);
    });
