...
export interface OdysseusIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface OdysseusIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: OdysseusIssueRuntimeReassignment;
}

interface UseOdysseusIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: OdysseusIssueRuntimeSendOptions) => Promise<void>;
...
export function useOdysseusIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseOdysseusIssueRuntimeOptions) {
