...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="All Gas No Brakes API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. All Gas No Brakes persists a device key during onboarding so pairing approvals
