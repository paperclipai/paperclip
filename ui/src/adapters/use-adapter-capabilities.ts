...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  jcode_local: { supportsInstructionsBundle: true, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: true, supportsModelProfiles: false, supportsAcp: false },
