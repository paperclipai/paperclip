...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  hermes_profile: { supportsInstructionsBundle: false, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
