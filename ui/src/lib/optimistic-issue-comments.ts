...
// Retained for the existing live-update path; both reads and writes must use
// the same query shape as the detail-page cache.
export const ISSUE_COMMENT_THREAD_PAGE_SIZE = ISSUE_COMMENT_PAGE_SIZE;
