export const queryKeys = {
  ...
  access: {
    ...
    memberPermissions: (companyId: string, memberId: string) =>
      ["access", "member-permissions", companyId, memberId] as const,
    agentPermissions: (companyId: string, agentId: string) =>
      ["access", "agent-permissions", companyId, agentId] as const,
  },
  auth: {
