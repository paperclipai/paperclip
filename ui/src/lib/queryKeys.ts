export const queryKeys = {
  ...
  issues: {
    ...
    listWaitingForHuman: (companyId: string) => ["issues", companyId, "waiting-for-human"] as const,
  ...
  heartbeatStats: (companyId: string, periodDays?: number) => ["heartbeat-stats", companyId, periodDays] as const,
