export const queryKeys = {
  ...
  issues: {
    ...
    documentsWithSystem: (issueId: string) => ["issues", "documents", issueId, "with-system"] as const,
    validationHistory: (issueId: string) => ["issues", "validation-history", issueId] as const,
    treeObservability: (issueId: string) => ["issues", "tree-observability", issueId] as const,
  ...
  blueprints: {
    ...
    detail: (companyId: string, ref: string) =>
      ["blueprints", "detail", companyId, ref] as const,
  },
  approvals: {
