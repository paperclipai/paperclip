export const queryKeys = {
  ...
  roadmap: (companyId?: string | null) => ["roadmap", companyId ?? "__board__"] as const,
  ...
  issueExecutionSummaries: (companyId: string) => ["issue-execution-summaries", companyId] as const,
