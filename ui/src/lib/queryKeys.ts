export const queryKeys = {
  ...
  goals: {
    ...
    targets: (companyId: string) => ["goals", companyId, "targets"] as const,
    relations: (companyId: string) => ["goals", companyId, "relations"] as const,
    roadmap: (companyId: string) => ["goals", companyId, "roadmap"] as const,
  },
  artifacts: {
    list: (
      companyId: string,
