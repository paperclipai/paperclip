...
export const issueStatusIcon: Record<string, string> = {
  ...
  ready_for_qa: "text-fuchsia-600 border-fuchsia-600 dark:text-fuchsia-400 dark:border-fuchsia-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  ready_for_qa: "text-fuchsia-600 dark:text-fuchsia-400",
...
export const statusBadge: Record<string, string> = {
  ...
  ready_for_qa: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900/50 dark:text-fuchsia-300",
