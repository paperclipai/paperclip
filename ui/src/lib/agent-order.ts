import type { Agent } from "@aiteamcorp/shared";

export const AGENT_ORDER_UPDATED_EVENT = "aiteamcorp:agent-order-updated";
const AGENT_ORDER_STORAGE_PREFIX = "aiteamcorp.agentOrder";
