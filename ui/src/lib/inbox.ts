...
export const DISMISSED_KEY = "aiteamcorp:inbox:dismissed";
export const READ_ITEMS_KEY = "aiteamcorp:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "aiteamcorp:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "aiteamcorp:inbox:issue-columns";
export const INBOX_NESTING_KEY = "aiteamcorp:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "aiteamcorp:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "aiteamcorp:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "aiteamcorp:inbox:collapsed-groups";
