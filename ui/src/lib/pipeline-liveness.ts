...
const AUTO_RETRY_NOTE =
  "Cortex retries automatically once the blocker clears — you don't need to move the item by hand.";
...
const NO_ACTION_PATH_BODY =
  "Cortex can't see anything to work on next here — no automation, retry, blocker, or review. " +
  ...
  switch (liveness.reason) {
    ...
    case "permission_preflight_failed":
      return {
        ...
        retryLabel: "",
        helperNote:
          "Grant the access above to the configured responsible, then Cortex retries automatically.",
      };
