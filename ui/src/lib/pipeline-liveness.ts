...
function autoRetryNote() {
  return t("localizationActivityTail.autoRetryNote");
}
 ...
 */
function noActionPathBody() {
  return t("localizationActivityTail.noActionPathBody");
}
  ...
  switch (liveness.reason) {
    ...
    case "case_blocked":
      return {
        ...
        tone: "blocked",
        title: t("localizationActivityTail.blocked"),
    ...
    case "permission_preflight_failed":
      return {
        reason: liveness.reason,
        tone: "permission",
        title: t("localizationActivityTail.permission"),
        body: liveness.message,
        blockerLink: null,
        automationLink: automationLinkFromLiveness(liveness),
        ...
        retryLabel: "",
        helperNote:
          t("localizationActivityTail.grantAccess"),
      };
    ...
    case "automation_failed": {
      ...
      return {
        ...
        title: recovered ? t("localizationActivityTail.resolved") : t("localizationActivityTail.automationFailed"),
        body: liveness.message,
        blockerLink: null,
        automationLink: automationLinkFromLiveness(liveness),
        permissionKey: null,
        ...
        retryLabel: t("localizationActivityTail.retryNow"),
    ...
    case "breakdown_pending":
      return {
        reason: liveness.reason,
        tone: "attention",
        title: t("localizationActivityTail.breakdownPending"),
        body: liveness.message,
        blockerLink: null,
        automationLink: null,
        permissionKey: null,
        showRetry: true,
        retryKind: "stage",
        retryLabel: t("localizationActivityTail.rerunStage"),
        helperNote: null,
      };
    ...
    case "breakdown_incomplete":
      return {
        reason: liveness.reason,
        tone: "blocked",
        title: t("localizationActivityTail.breakdownIncomplete"),
    ...
    case "no_action_path":
      return {
        reason: liveness.reason,
        tone: "attention",
        title: t("localizationActivityTail.itemStuck"),
...
function missingPiecesBody(liveness: PipelineCaseLiveness): string {
  ...
  if (missing > 0) {
    return t("localizationActivityTail.missingPieces", { message: liveness.message, count: missing, value: new Intl.NumberFormat(i18n.resolvedLanguage).format(missing) });
  }
  return liveness.message;
}

/** True when the PAP-11238 t("localizationActivityTail.rerunStage") menu item must be disabled. */
