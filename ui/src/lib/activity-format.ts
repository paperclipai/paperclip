...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "agent.claude_login_run": "ran Claude login for",
  "cloud_upstream.connect_started": "started cloud upstream connection for",
  "cloud_upstream.connected": "connected cloud upstream for",
  "cloud_upstream.push_run_previewed": "previewed cloud upstream push for",
  "cloud_upstream.push_run_created": "pushed data to cloud upstream for",
  "cloud_upstream.push_run_cancelled": "cancelled cloud upstream push for",
  "cloud_upstream.push_run_activated": "activated cloud upstream entities for",
  "adapter.installed": "installed adapter",
  "adapter.enabled": "enabled adapter",
  "adapter.disabled": "disabled adapter",
  "adapter.override_paused": "paused adapter override for",
  "adapter.override_resumed": "resumed adapter override for",
  "adapter.removed": "removed adapter",
  "adapter.reloaded": "reloaded adapter",
  "adapter.reinstalled": "reinstalled adapter",
  "instance.database_backup_triggered": "triggered a database backup",
  "instance.dev_server_restart_requested": "requested a dev server restart",
  "instance.board_ownership_claimed": "claimed board ownership",
  "instance.first_admin_claimed": "claimed first instance admin",
  ...
  "instance.settings.issue_graph_liveness_auto_recovery_run": "ran issue graph liveness auto-recovery",
  "instance_admin.promoted": "promoted to instance admin",
  "instance_admin.demoted": "demoted from instance admin",
  "user.company_access_updated": "updated company access for",
  "cli_auth.challenge_created": "requested CLI access",
  "cli_auth.challenge_approved": "approved CLI access for",
  "cli_auth.challenge_cancelled": "cancelled a CLI access request",
  "smoke_lab.oauth_authorize_submitted": "submitted a smoke-lab OAuth login for",
  "smoke_lab.oauth_token_issued": "issued a smoke-lab OAuth token for",
  "smoke_lab.oauth_token_revoked": "revoked a smoke-lab OAuth token for",
};
