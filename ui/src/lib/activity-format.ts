...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "pipeline.stage_created": "added a stage to pipeline",
  "pipeline.stage_updated": "updated a stage on pipeline",
  "pipeline.stage_deleted": "deleted a stage from pipeline",
  "pipeline.transitions_replaced": "updated transitions on pipeline",
  "case.document_locked": "locked a case document",
  "case.document_unlocked": "unlocked a case document",
  "case.document_deleted": "deleted a case document",
  "join.requested": "requested to join",
  "join.request_replayed": "replayed a join request for",
  "join.approved": "approved a join request for",
  "join.rejected": "rejected a join request for",
  "invite.created": "created an invite for",
  "invite.revoked": "revoked an invite for",
  "issue.create_deduplicated": "de-duplicated a create for",
};

const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  "issue.created": "created the issue",
  "issue.create_deduplicated": "de-duplicated a create attempt",
