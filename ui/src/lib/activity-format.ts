...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "company.exported": "exported",
  "company.export_previewed": "previewed an export of",
  "company.import_previewed": "previewed an import into",
  "attachment.downloaded": "downloaded",
  "agent.configuration_read": "read configuration for",
  "agent.config_revisions_read": "read configuration history for",
  "agent.config_revision_read": "read a configuration revision for",
  "agent.instructions_read": "read instructions for",
  "agent.instructions_file_read": "read an instructions file for",
  "agent.key_metadata_read": "read API key metadata for",
  "heartbeat.log_read": "read logs for",
  "skill.source_read": "read source for",
  "tool_connection.read": "read",
  "tool_connection.activity_read": "read activity for",
  "tool.test_call_read": "read a tool test call for",
  "tool.decision_read": "read tool decisions for",
  "tool.audit_read": "read tool audit history for",
  "activity_log.read": "read activity for",
};
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "approval.approved": "approved",
  "approval.rejected": "rejected",
  "company.exported": "exported company data",
  "company.export_previewed": "previewed a company export",
  "company.import_previewed": "previewed a company import",
  "attachment.downloaded": "downloaded an attachment",
  "agent.configuration_read": "read agent configuration",
  "agent.config_revisions_read": "read agent configuration history",
  "agent.config_revision_read": "read an agent configuration revision",
  "agent.instructions_read": "read agent instructions",
  "agent.instructions_file_read": "read an agent instructions file",
  "agent.key_metadata_read": "read agent API key metadata",
  "heartbeat.log_read": "read heartbeat logs",
  "skill.source_read": "read skill source",
  "tool_connection.read": "read a tool connection",
  "tool_connection.activity_read": "read tool connection activity",
  "tool.test_call_read": "read a tool test call",
  "tool.decision_read": "read tool decisions",
  "tool.audit_read": "read the tool audit log",
  "activity_log.read": "read the activity log",
};
