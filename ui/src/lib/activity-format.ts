...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "issue.checkout_rejected_blocked": "tried to check out (blocked by dependencies)",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "issue.checkout_rejected_blocked": "tried to check out the issue but it was blocked by unresolved dependencies",
