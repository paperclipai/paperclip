...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "board_api_key.created": "created board API key for",
  "board_api_key.revoked": "revoked board API key for",
  "agent_api_key.claimed": "claimed agent API key for",
  "board_chat.requested": "requested board chat on",
  "board_chat.responded": "recorded board concierge reply on",
  "company.skill_policy_evaluated": "evaluated skill policy for",
  ...
  "cloud_upstream.push_cancelled": "cancelled cloud upstream push for",
  "cloud_upstream.activation_completed": "activated cloud upstream imports for",
  "instance.board_claimed": "claimed board access for",
  "instance.first_admin_claimed": "claimed first admin for",
  "user.profile_updated": "updated profile for",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "agent_api_key.claimed": "claimed an agent API key",
  "board_chat.requested": "requested board chat",
  "board_chat.responded": "recorded a board concierge reply",
  "company.skill_policy_evaluated": "evaluated the skill policy",
  "cloud_upstream.connect_started": "started a cloud upstream connection",
  "cloud_upstream.connected": "connected a cloud upstream target",
  "cloud_upstream.push_cancelled": "cancelled a cloud upstream push",
  "cloud_upstream.activation_completed": "activated imported cloud upstream entities",
  "instance.board_claimed": "claimed board access",
  "instance.first_admin_claimed": "claimed first admin access",
  "user.profile_updated": "updated the user profile",
};
