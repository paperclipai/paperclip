...
export const PROJECT_ORDER_UPDATED_EVENT = "valadrien-os:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "valadrien-os:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "valadrien-os.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "valadrien-os.projectSortMode";
