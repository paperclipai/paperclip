...
import { HiveBoardPage } from "./pages/HiveBoardPage";
...
import { InstanceGuardrailsSettings } from "./pages/InstanceGuardrailsSettings";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="board" element={<HiveBoardPage />} />
      ...
      <Route path="company/settings/instance/guardrails" element={<InstanceGuardrailsSettings />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="monitor" element={<UnprefixedBoardRedirect />} />
