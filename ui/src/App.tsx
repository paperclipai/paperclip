...
import { GofferAnalytics } from "./pages/GofferAnalytics";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="goffer-analytics" element={<GofferAnalytics />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="yard-proposals/demo" element={<UnprefixedBoardRedirect />} />
          <Route path="yard-proposals/demo-backyard" element={<UnprefixedBoardRedirect />} />
