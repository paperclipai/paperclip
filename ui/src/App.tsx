...
import { OrchestrationInjectionRunDetail } from "./pages/OrchestrationInjectionRunDetail";
...
import { RunDetailNarrativePreview } from "./pages/RunDetailNarrativePreview";
...
function boardRoutes() {
  return (
    <>
      ...
      {import.meta.env.DEV ? (
        <Route path="design-preview/run-detail-narrative" element={<RunDetailNarrativePreview />} />
      ) : null}
