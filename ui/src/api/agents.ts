...
export const agentsApi = {
  ...
  adapterModels: (companyId: string, type: string, localBaseUrl?: string) =>
    api.get<AdapterModel[]>(
      `/companies/${encodeURIComponent(companyId)}/adapters/${encodeURIComponent(type)}/models${localBaseUrl ? `?localBaseUrl=${encodeURIComponent(localBaseUrl)}` : ""}`,
    ),
