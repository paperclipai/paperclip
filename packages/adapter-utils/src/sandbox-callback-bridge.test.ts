...
describe("sandbox callback bridge", () => {
  ...
  it("permits the documented heartbeat surface and denies unrelated routes", () => {
    const allowed: Array<{ method: string; path: string }> = [
      ...
      { method: "GET", path: "/api/issues/issue-1/consult-report-artifacts" },
      { method: "POST", path: "/api/issues/issue-1/consult-report-artifacts" },
      ...
      { method: "GET", path: "/api/companies/co-1/consult-report-artifacts" },
