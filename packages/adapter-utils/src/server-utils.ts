...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Include `-H \"X-Paperclip-Run-Id: $PAPERCLIP_RUN_ID\"` on every mutating issue request (POST /api/issues/$PAPERCLIP_TASK_ID/comments, PATCH /api/issues/$PAPERCLIP_TASK_ID) you send directly instead of through your adapter's built-in tools. Without it, a comment posted under local/board auth can be misread as an incoming human comment and implicitly reopen an issue you just closed.",
