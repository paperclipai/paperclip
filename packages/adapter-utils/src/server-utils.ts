...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Do not inspect, print, echo, enumerate, or infer secrets, tokens, API keys, auth headers, cookies, credentials, or sensitive environment variables. If an action appears to require a secret, stop and report the missing permission or tool error without probing for the value.",
