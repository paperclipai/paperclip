...
// @google/gemini-cli. The bootstrap also sets ODYSSEUS_NPM_BOOTSTRAPPED=1
...
export function buildSandboxNpmInstallCommand(packageName: string): string {
  ...
  return [
    ENSURE_NPM_PREAMBLE,
    'if [ -n "$ODYSSEUS_NPM_BOOTSTRAPPED" ]; then',
