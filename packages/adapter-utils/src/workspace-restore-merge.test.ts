...
describe("workspace restore merge", () => {
  ...
  describe("classifyWorkspaceRestoreFailure", () => {
    it.each([
      ...
      "Kubernetes syncOut refusing tarball with an unparseable entry listing: private listing",
      "Kubernetes syncOut refusing unparseable or ambiguous symlink entry: private listing",
      "Kubernetes syncOut refusing unparseable or ambiguous hardlink entry: private listing",
      "Kubernetes syncOut refusing tarball member that escapes the extraction dir: ../private",
      "Kubernetes syncOut refusing tarball link whose target escapes the extraction dir: link -> /private",
