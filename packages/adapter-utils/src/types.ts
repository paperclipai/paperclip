...
export interface AdapterEnvironmentTestContext {
   ...
   *
   * If omitted (or `kind === "local"`), the adapter tests on the Odysseus
...
export interface AdapterRuntimeCommandSpec {
  /**
   * The command Odysseus should execute for this adapter in the current config.
   */
  command: string;
  /**
...
export interface ServerAdapterModule {
   ...
   * rather than reading config.odysseusRuntimeSkills.
   */
