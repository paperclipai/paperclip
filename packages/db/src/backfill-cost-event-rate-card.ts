...
// Same cutoff migration 0276 uses to reclassify rows whose cache-write tokens
// were folded into input_tokens before the column existed. Must stay in sync
// with `packages/db/src/migrations/0276_pricing_methodology.sql`.
...
export function resolveBackfill(row: {
  ...
  // Migration 0276 also relabels these rows' cost_status so dashboards can
