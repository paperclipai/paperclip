...
--
-- The motivation: migration 0198 added `cache_write_tokens` and
...
-- rows have a real lower bound (their existing rate_card_cents from the 0198
...
-- the 0198 backfill already moved subscription rows to 'derived').
UPDATE "cost_events"
