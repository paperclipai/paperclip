...
CREATE INDEX "project_permission_grants_company_idx" ON "project_permission_grants" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "companies_organization_idx" ON "companies" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "agents_owner_user_idx" ON "agents" USING btree ("owner_user_id");
