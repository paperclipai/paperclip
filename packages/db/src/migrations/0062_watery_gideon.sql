...
ALTER TABLE "issues" ADD COLUMN "routine_bound_run_id" text;--> statement-breakpoint
ALTER TABLE "issues" ADD COLUMN "routine_issue_role" text;--> statement-breakpoint
CREATE UNIQUE INDEX "issues_open_routine_execution_uq" ON "issues" USING btree ("company_id","origin_kind","origin_id") WHERE "issues"."origin_kind" = 'routine_execution'
          ...
          and "issues"."routine_issue_role" = 'canonical'
