...
export const companies = pgTable(
  "companies",
  {
    ...
    storageBackend: text("storage_backend").notNull().default("local_disk"),
    downloadUrlTtlSeconds: integer("download_url_ttl_seconds"),
    complianceMode: boolean("compliance_mode").notNull().default(false),
