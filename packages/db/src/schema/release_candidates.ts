...
export const releaseCandidates = pgTable(
  "release_candidates",
  {
    ...
    signatureBundleSha256: text("signature_bundle_sha256").notNull(),
    ...
    stagedSignatureBundleAssetId: uuid("staged_signature_bundle_asset_id").references(() => assets.id, { onDelete: "set null" }),
    stagedSignatureBundleSha256: text("staged_signature_bundle_sha256"),
...
export const releaseDeployAuthorizations = pgTable(
  "release_deploy_authorizations",
  {
    ...
    deployRecordReceiptHash: text("deploy_record_receipt_hash"),
    deployRecordReceiptReceivedAt: timestamp("deploy_record_receipt_received_at", { withTimezone: true }),
