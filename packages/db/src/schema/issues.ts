...
export const issues = pgTable(
  "issues",
  {
    ...
    quarantineHold: boolean("quarantine_hold").notNull().default(false),
  ...
  (table) => ({
    ...
    quarantineHoldIdx: index("issues_company_quarantine_hold_idx").on(table.companyId, table.quarantineHold),
