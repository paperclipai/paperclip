...
export const issues = pgTable(
  "issues",
  {
    ...
    releaseEvidence: jsonb("release_evidence").$type<Record<string, unknown>>(),
    releaseEvidenceValidatedAt: timestamp("release_evidence_validated_at", { withTimezone: true }),
    releaseEvidenceValidationError: text("release_evidence_validation_error"),
