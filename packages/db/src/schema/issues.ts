...
import { workCycles } from "./work_cycles.js";
...
export const issues = pgTable(
  "issues",
  {
    ...
    cycleId: uuid("cycle_id").references(() => workCycles.id, { onDelete: "set null" }),
    ...
    executionContract: jsonb("execution_contract").$type<Record<string, unknown>>(),
