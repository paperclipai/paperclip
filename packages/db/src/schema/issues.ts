...
export const issues = pgTable(
  "issues",
  {
    ...
    supersededByIssueId: uuid("superseded_by_issue_id").references((): AnyPgColumn => issues.id, { onDelete: "set null" }),
  ...
  (table) => ({
    ...
    supersededByIssueIdx: index("issues_superseded_by_issue_idx").on(table.supersededByIssueId),
