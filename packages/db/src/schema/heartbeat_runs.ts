...
export const heartbeatRuns = pgTable(
  "heartbeat_runs",
  {
    ...
    runIoMode: text("run_io_mode"),
    journalStdoutOffset: bigint("journal_stdout_offset", { mode: "number" }).notNull().default(0),
    journalStderrOffset: bigint("journal_stderr_offset", { mode: "number" }).notNull().default(0),
    processPreservable: boolean("process_preservable").notNull().default(false),
    lifecycleState: text("lifecycle_state"),
    adoptionMarkedAt: timestamp("adoption_marked_at", { withTimezone: true }),
    adoptionDowntimeMs: bigint("adoption_downtime_ms", { mode: "number" }).notNull().default(0),
