...
export const cloudUpstreamRuns = pgTable(
  "cloud_upstream_runs",
  {
    ...
    summary: jsonb("summary").$type<import("@valadrien-os/shared").CloudUpstreamSummaryCount[]>().notNull().default([]),
    warnings: jsonb("warnings").$type<import("@valadrien-os/shared").CloudUpstreamWarning[]>().notNull().default([]),
    conflicts: jsonb("conflicts").$type<import("@valadrien-os/shared").CloudUpstreamConflict[]>().notNull().default([]),
    events: jsonb("events").$type<import("@valadrien-os/shared").CloudUpstreamRunEvent[]>().notNull().default([]),
