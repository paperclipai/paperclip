...
export const completionContracts = pgTable("completion_contracts", {
  ...
  issueRevisionUq: uniqueIndex("completion_contracts_issue_revision_uq").on(table.issueId, table.revision),
  issueHashUq: uniqueIndex("completion_contracts_issue_hash_uq").on(table.issueId, table.canonicalSha256),
}));
