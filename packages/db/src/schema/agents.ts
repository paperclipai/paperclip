...
export const agents = pgTable(
  "agents",
  {
    ...
    statusChangedByAgentId: uuid("status_changed_by_agent_id"),
    statusChangedByUserId: text("status_changed_by_user_id"),
    statusChangedAt: timestamp("status_changed_at", { withTimezone: true }),
    managerChangedByAgentId: uuid("manager_changed_by_agent_id"),
    managerChangedByUserId: text("manager_changed_by_user_id"),
    managerChangedAt: timestamp("manager_changed_at", { withTimezone: true }),
