...
import { agentFolders } from "./agent_folders.js";
...
export const agents = pgTable(
  "agents",
  {
    ...
    folderId: uuid("folder_id").references(() => agentFolders.id, { onDelete: "set null" }),
  ...
  (table) => ({
    ...
    companyFolderIdx: index("agents_company_folder_idx").on(table.companyId, table.folderId),
  }),
);
