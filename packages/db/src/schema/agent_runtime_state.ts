...
export const agentRuntimeState = pgTable(
  "agent_runtime_state",
  {
    ...
    // Rolling count of consecutive terminal failures (reset on success) so a
    // stall-prone agent surfaces itself instead of only being findable by
    // hand-listing its recovery tickets.
