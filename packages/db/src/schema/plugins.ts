...
import type { PluginCategory, PluginStatus, AiTeamCorpPluginManifestV1 } from "@aiteamcorp/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<AiTeamCorpPluginManifestV1>().notNull(),
