...
import type { PluginCategory, PluginStatus, OdysseusPluginManifestV1 } from "@odysseus/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<OdysseusPluginManifestV1>().notNull(),
