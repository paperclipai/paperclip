...
import { usePluginData, usePluginToast } from "@valadrien-os/plugin-sdk/ui";
...
const FILE_SIDEBAR_WIDTH_STORAGE_KEY = "valadrien-os.workspace-diff.files-sidebar-width";
