...
const EXPANDED_STORAGE_KEY = `odysseus.plugin-llm-wiki:route-sidebar-expanded:v2:${COMPANY_ID}`;

type BridgeGlobal = typeof globalThis & {
  __odysseusPluginBridge__?: {
...
describe("WikiRouteSidebar", () => {
  ...
  beforeEach(() => {
    ...
    (globalThis as BridgeGlobal).__odysseusPluginBridge__ = {
      sdkUi: {
  ...
  afterEach(() => {
    ...
    container.remove();
    window.localStorage.clear();
    delete (globalThis as BridgeGlobal).__odysseusPluginBridge__;
  });
  ...
  it("keeps sidebar tree selection scoped to sidebar navigation", () => {
    ...
    expect(navigatedTo).toEqual({
      ...
      options: { state: { odysseusWikiSidebarTreePath: "wiki/concepts/sidebar-navigation.md" } },
    });
    ...
    hostLocation = {
      pathname: "/PAP/wiki/page/wiki/entities/odysseus.md",
      search: "",
      hash: "",
    };
    act(() => {
...
describe("WikiPage", () => {
  ...
  it("renders structured Odysseus source refs as text", () => {
    act(() => {
