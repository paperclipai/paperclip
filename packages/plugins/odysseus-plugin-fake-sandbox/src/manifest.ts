...
const PLUGIN_ID = "odysseus.fake-sandbox-provider";
...
const manifest: OdysseusPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Odysseus provider-plugin integration without external infrastructure.",
  author: "Odysseus",
