import type { PluginLauncherRegistration } from "@ironworksai/plugin-sdk";

export const PLUGIN_ID = "ironworks-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".ironworks-kitchen-sink-demo.txt",
} as const;
