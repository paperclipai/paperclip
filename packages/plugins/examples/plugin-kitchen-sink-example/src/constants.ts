import type { PluginLauncherRegistration } from "@odysseus/plugin-sdk";

export const PLUGIN_ID = "odysseus-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".odysseus-kitchen-sink-demo.txt",
} as const;
