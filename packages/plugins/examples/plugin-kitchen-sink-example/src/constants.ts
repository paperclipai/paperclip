import type { PluginLauncherRegistration } from "@valadrien-os/plugin-sdk";

export const PLUGIN_ID = "valadrien-os-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".valadrien-os-kitchen-sink-demo.txt",
} as const;
