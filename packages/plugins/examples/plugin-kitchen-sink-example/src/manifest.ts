...
const manifest: ValadrienOsPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current ValadrienOs plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "ValadrienOs",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the ValadrienOs domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
