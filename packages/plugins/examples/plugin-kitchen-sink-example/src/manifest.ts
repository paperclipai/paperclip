...
const manifest: OdysseusPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Odysseus plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Odysseus",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Odysseus domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
