# @odysseus/plugin-kitchen-sink-example
...
```sh
pnpm --filter @odysseus/plugin-kitchen-sink-example build
pnpm odysseus plugin install ./packages/plugins/examples/plugin-kitchen-sink-example
```
