...
} from "@valadrien-os/plugin-sdk/ui";
import { FileTree, usePluginAction, usePluginData } from "@valadrien-os/plugin-sdk/ui";
...
const PLUGIN_KEY = "valadrien-os-file-browser-example";
