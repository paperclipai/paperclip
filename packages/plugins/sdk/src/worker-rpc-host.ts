...
import type { OdysseusPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@odysseus/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: OdysseusPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@odysseus/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
