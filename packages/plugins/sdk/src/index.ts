 ...
 * import { definePlugin, runWorker, z } from "@aiteamcorp/plugin-sdk";
 *
...
// Manifest and constant types re-exported from @aiteamcorp/shared
 ...
 * @example
 * ```ts
 * import { z } from "@aiteamcorp/plugin-sdk";
 *
