 ...
 * channel.
 *
 * The AiTeamCorp plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@aiteamcorp/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all AiTeamCorp messages.
 */
...
/**
 * AiTeamCorp plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this AiTeamCorp instance. */
    instanceId: string;
    /** Semver version of the running AiTeamCorp host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
