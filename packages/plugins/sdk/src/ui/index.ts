/**
 * `@valadrien-os/plugin-sdk/ui` — ValadrienOs plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@valadrien-os/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@valadrien-os/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@valadrien-os/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate ValadrienOs-internal links through the host router
