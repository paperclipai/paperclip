/**
 * `@odysseus/plugin-sdk/ui` — Odysseus plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@odysseus/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@odysseus/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@odysseus/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Odysseus-internal links through the host router
