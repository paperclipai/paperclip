 ...
 *
 * The worker-side SDK is available from `@aiteamcorp/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@aiteamcorp/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@aiteamcorp/plugin-sdk/ui";
 *
