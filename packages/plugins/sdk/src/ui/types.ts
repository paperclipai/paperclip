/**
 * ValadrienOs plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@valadrien-os/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed ValadrienOs navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a ValadrienOs-internal path using the active company prefix.
   *
