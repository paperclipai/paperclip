/**
 * Odysseus plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@odysseus/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Odysseus navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Odysseus-internal path using the active company prefix.
   *
