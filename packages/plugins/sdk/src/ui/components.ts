 ...
 *
 * These components are exported from `@odysseus/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@odysseus/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function OdysseusSdkUiComponent(props: TProps) {
...
/**
 * Renders Odysseus's shared Markdown editor.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
 ...
 * @example
 * ```tsx
 * import { FileTree, type FileTreeNode } from "@odysseus/plugin-sdk/ui";
 *
...
/**
 * Renders Odysseus's native issue list component for company-scoped plugin
...
/**
 * Renders Odysseus's native managed routines list for plugin settings pages.
 */
