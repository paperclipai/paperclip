 ...
 *
 * These components are exported from `@aiteamcorp/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@aiteamcorp/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function AiTeamCorpSdkUiComponent(props: TProps) {
