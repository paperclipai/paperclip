      ...
      managed: {
        ...
        async reconcile(agentKey, companyId) {
          ...
          const created: Agent = {
            ...
            pauseReason: null,
            pausedAt: null,
            permissions: { canCreateAgents: Boolean(declaration.permissions?.canCreateAgents), canManageSkills: Boolean(declaration.permissions?.canManageSkills ?? declaration.permissions?.canCreateAgents) },
