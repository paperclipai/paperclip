      ...
      managed: {
        ...
        async reset(skillKey, companyId) {
          ...
          const skill = {
            ...
            riskTier: existing.skill?.riskTier ?? 2,
            riskTierSource: existing.skill?.riskTierSource ?? "unclassified",
            riskTierRationale: existing.skill?.riskTierRationale ?? null,
            riskTierUpdatedByAgentId: existing.skill?.riskTierUpdatedByAgentId ?? null,
            riskTierUpdatedByUserId: existing.skill?.riskTierUpdatedByUserId ?? null,
            riskTierUpdatedAt: existing.skill?.riskTierUpdatedAt ?? null,
