/**
 * Bundling presets for ValadrienOs plugins.
 *
 ...
 * to match the ValadrienOs plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@valadrien-os/plugin-sdk/ui",
    "@valadrien-os/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node20",
    sourcemap,
    external: ["@valadrien-os/plugin-sdk"],
  };
