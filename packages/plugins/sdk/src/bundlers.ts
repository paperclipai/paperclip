/**
 * Bundling presets for AiTeamCorp plugins.
 *
 ...
 * to match the AiTeamCorp plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@aiteamcorp/plugin-sdk/ui",
    "@aiteamcorp/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@aiteamcorp/plugin-sdk"],
  };
