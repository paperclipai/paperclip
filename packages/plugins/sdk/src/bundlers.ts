/**
 * Bundling presets for Odysseus plugins.
 *
 ...
 * to match the Odysseus plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@odysseus/plugin-sdk/ui",
    "@odysseus/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
