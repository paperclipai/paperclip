/**
 * `definePlugin` — the top-level helper for authoring a Odysseus plugin.
 *
...
// ---------------------------------------------------------------------------
// OdysseusPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface OdysseusPlugin {
 ...
 * @returns A sealed `OdysseusPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@odysseus/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): OdysseusPlugin {
