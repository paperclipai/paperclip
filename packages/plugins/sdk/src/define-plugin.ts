/**
 * `definePlugin` — the top-level helper for authoring a ValadrienOs plugin.
 *
...
// ---------------------------------------------------------------------------
// ValadrienOsPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface ValadrienOsPlugin {
 ...
 * @returns A sealed `ValadrienOsPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@valadrien-os/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): ValadrienOsPlugin {
