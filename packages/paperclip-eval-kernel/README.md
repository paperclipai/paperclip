...
`@paperclipai/paperclip-eval-kernel` is the generic, provider-neutral matrix
orchestrator owned by Paperclip Evals. It contains no Paperclip scenario corpus,
provider configuration, product fixture, scorer, or report template.
