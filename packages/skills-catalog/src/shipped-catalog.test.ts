...
const SKILL_FRONTMATTER_ROOTS = [
  ...
  // Fork-local: REPO_ROOT/skills is excluded from the prompt-budget sweep — it
  // carries the ThinkStack operational skill pack whose descriptions are
  // intentionally rich (they drive lane routing) and are attached per-agent,
  // not bulk-injected like the shipped catalog.
