...
Use when:
- You want Odysseus to run Cursor Agent CLI locally as the agent runtime
...
- Odysseus auto-injects local skills into "~/.cursor/skills" when missing, so Cursor can discover "$odysseus" and related skills on local runs.
- Odysseus auto-adds --yolo unless one of --trust/--yolo/-f is already present in extraArgs.
