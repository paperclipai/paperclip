...
- fastMode (boolean, optional): enable Codex Fast mode; currently supported on GPT-5.5 only and consumes credits faster
...
- Fast mode is currently supported on GPT-5.5 only. When enabled, Paperclip applies \`service_tier="fast"\` and \`features.fast_mode=true\`.
