...
export const GROK_SUPPORTED_EFFORTS = ["low", "medium", "high", "xhigh"] as const;
export type GrokEffort = (typeof GROK_SUPPORTED_EFFORTS)[number];
export { grokModelSupportsXhigh, resolveGrokReasoningEffort } from "./effort.js";

export const models = [
  { id: "grok-4.6", label: "Grok 4.6" },
  { id: "grok-4.5", label: "Grok 4.5" },
  { id: "grok-build", label: "grok-build (alias)" },
];
...
- model (string, optional): Grok model id. Defaults to grok-4.6. Built-in options: grok-4.6, grok-4.5. \`grok-build\` remains accepted as a host alias.
