...
import type { AdapterExecutionTarget } from "@valadrien-os/adapter-utils/execution-target";
...
const {
  ...
  return {
    ...
    prepareAdapterExecutionTargetRuntime: vi.fn(async () => ({
      target: null,
      workspaceRemoteDir: "/remote/workspace/.valadrien-os-runtime/runs/test/workspace",
      runtimeRootDir: "/remote/workspace/.valadrien-os-runtime/runs/test/workspace/.valadrien-os-runtime/opencode",
      assetDirs: {
        xdgConfig: "/remote/workspace/.valadrien-os-runtime/runs/test/workspace/.valadrien-os-runtime/opencode/xdgConfig",
      },
      restoreWorkspace,
    })),
  };
...
describe("opencode remote environment diagnostics", () => {
  ...
  it("stages remote runtime config assets for sandbox hello probes", async () => {
    ...
    const probeCall = runAdapterExecutionTargetProcess.mock.calls[0] as unknown as
      ...
      | undefined;
    expect(probeCall?.[4].cwd).toBe("/remote/workspace/.valadrien-os-runtime/runs/test/workspace");
    expect(probeCall?.[4].env.XDG_CONFIG_HOME).toBe(
      "/remote/workspace/.valadrien-os-runtime/runs/test/workspace/.valadrien-os-runtime/opencode/xdgConfig",
    );
  });
});
