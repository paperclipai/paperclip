...
// Fork (62cb685b8): bare "unauthorized" / "authentication required" /
// "invalid api key" only count when followed by a login hint, so tool-level
// auth text inside a run does not flip the classifier.
