...
Use when:
- You want Odysseus to run Pi (the AI coding agent) locally as the agent runtime
...
- Odysseus requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/odysseuss/ and resumed with --session.
