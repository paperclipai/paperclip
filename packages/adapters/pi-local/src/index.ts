...
Use when:
- You want Ironworks to run Pi (the AI coding agent) locally as the agent runtime
...
- Ironworks requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/ironworkss/ and resumed with --session.
