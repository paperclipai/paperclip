# Phase 4b Live Console

## Scope

This is the browser layer of Phase 4b. It adds a **Live console** mode to the
existing standalone devtool in `devtools/browser/`. It builds on the
[protocol and demo server](phase-04b-protocol-server.md) and follows the
approved [interaction map](design/phase-4b-interaction-map.md) and
[component decision record](design/phase-4b-component-decisions.md).
...
| --- | --- | --- |
| `PAPERCLIP_PHASE4B_DRIVER` | `demo` | `codex` starts the real `codex app-server` driver behind the same routes |
| `PAPERCLIP_PHASE4B_CHUNK_DELAY_MS` | `45` | Milliseconds between streamed chunks in the demo driver |
...
`GET /api/phase4b/manifests`. Each manifest names the scenario it proves and
...
pnpm --filter @paperclipai/paperclip-runner exec vitest run \
  src/mock-core/phase4b-scripted-driver.test.ts \
...
See the [verification record](../knowledge/evidence/2026-08-08-phase-04b-live-console-verification.md)
and the [tutorial](tutorials/phase-04b-live-console.md).
