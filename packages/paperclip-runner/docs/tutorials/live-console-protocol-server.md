...
```sh
pnpm --filter @paperclipai/paperclip-runner record:live-console
```
...
- `packages/paperclip-runner/knowledge/evidence/live-console-real-codex-server.json`
