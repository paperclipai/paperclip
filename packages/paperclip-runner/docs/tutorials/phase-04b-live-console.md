# Phase 4b: Run the Live Codex Protocol Console

## What this is

This tutorial runs the Phase 4b browser console. The
[protocol demo server](phase-04b-protocol-server.md) tutorial used `curl`. This
...
- [Phase 4b live console reference](../phase-04b-live-console.md)
- [Phase 4b interaction map](../design/phase-4b-interaction-map.md)
