# Phase 4b Interaction Map — Live Codex Protocol Web UI

Status: **approved for implementation** (UX gate PAP-16832, 2026-08-08).
Owner: UXDesigner. Implementer: browser tracer owner (PAP-16834).
Companion record: [component decisions](phase-4b-component-decisions.md).
Mockups: [`mockups/`](mockups/) (annotated desktop + mobile renders).

This map is the interaction contract for the Phase 4b live console required by
...
**Live console** mode next to the existing Phase 1–3 modes. Do not build a
...
5. Never offer "start new session" as the recovery path for a drop — resume
   the exact session (Phase 4 rule: never replace a lost session).
