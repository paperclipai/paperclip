...
| skill:skills/paperclip/SKILL.md:issue-worktree-runtime-controls:448 | optional_agent_tool | skills/paperclip/SKILL.md:448 |
...
| skill:skills/paperclip/references/issue-worktrees.md:issue-worktree-runtime-controls:1 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:1 |
| skill:skills/paperclip/references/issue-worktrees.md:discover-the-worktree:5 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:5 |
| skill:skills/paperclip/references/issue-worktrees.md:control-services:23 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:23 |
| skill:skills/paperclip/references/issue-worktrees.md:start-all-configured-services-waits-for-configured-readiness-checks:28 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:28 |
| skill:skills/paperclip/references/issue-worktrees.md:restart-all-configured-services:36 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:36 |
| skill:skills/paperclip/references/issue-worktrees.md:stop-all-running-services:44 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:44 |
| skill:skills/paperclip/references/issue-worktrees.md:read-the-url:63 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:63 |
| skill:skills/paperclip/references/issue-worktrees.md:mcp-tools:72 | optional_agent_tool | skills/paperclip/references/issue-worktrees.md:72 |
