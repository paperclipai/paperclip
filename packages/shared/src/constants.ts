...
// TWX fork keeps the full model-profile tiering (standard/premium/flagship);
// upstream reduced this to ["cheap"]. Fork routing + model-routing.test.ts depend on the tiers.
