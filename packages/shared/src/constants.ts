...
export const MESSAGE_TYPES = ["text", "request", "response", "notification", "decision"] as const;
...
export const PROPOSAL_TYPES = ["strategy", "knowledge", "policy", "action", "resource"] as const;
export type ProposalType = (typeof PROPOSAL_TYPES)[number];

export const PROPOSAL_STATUSES = ["draft", "open", "passed", "rejected", "vetoed", "expired"] as const;
export type ProposalStatus = (typeof PROPOSAL_STATUSES)[number];

export const QUORUM_TYPES = ["majority", "supermajority", "unanimous", "board_approval"] as const;
