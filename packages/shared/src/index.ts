...
export type {
  ...
  AttentionWorktreeRef as AttentionWorkspaceRef,
...
export type {
  ...
  ProjectWorktree,
  ProjectWorktree as ProjectWorkspace,
  ...
  ExecutionWorktree,
  ExecutionWorktree as ExecutionWorkspace,
  ExecutionWorktreeSummary,
  ExecutionWorktreeSummary as ExecutionWorkspaceSummary,
  ExecutionWorktreeConfig,
  ExecutionWorktreeConfig as ExecutionWorkspaceConfig,
  ExecutionWorktreeCloseAction,
  ExecutionWorktreeCloseAction as ExecutionWorkspaceCloseAction,
  ExecutionWorktreeCloseActionKind,
  ExecutionWorktreeCloseActionKind as ExecutionWorkspaceCloseActionKind,
  ExecutionWorktreeCloseGitReadiness,
  ExecutionWorktreeCloseGitReadiness as ExecutionWorkspaceCloseGitReadiness,
  ExecutionWorktreeCloseLinkedIssue,
  ExecutionWorktreeCloseLinkedIssue as ExecutionWorkspaceCloseLinkedIssue,
  ExecutionWorktreeCloseReadiness,
  ExecutionWorktreeCloseReadiness as ExecutionWorkspaceCloseReadiness,
  ExecutionWorktreeCloseReadinessState,
  ExecutionWorktreeCloseReadinessState as ExecutionWorkspaceCloseReadinessState,
  ExecutionWorktreeDeliveryState,
  ExecutionWorktreeDeliveryState as ExecutionWorkspaceDeliveryState,
  WorktreeOverviewItem,
  WorktreeOverviewItem as WorkspaceOverviewItem,
  WorktreeOverviewLinkedIssue,
  WorktreeOverviewLinkedIssue as WorkspaceOverviewLinkedIssue,
  WorktreeOverviewPrimaryService,
  WorktreeOverviewPrimaryService as WorkspaceOverviewPrimaryService,
  WorktreeOverviewResponse,
  WorktreeOverviewResponse as WorkspaceOverviewResponse,
  ProjectWorktreeRuntimeConfig,
  ProjectWorktreeRuntimeConfig as ProjectWorkspaceRuntimeConfig,
  WorktreeCommandDefinition,
  WorktreeCommandDefinition as WorkspaceCommandDefinition,
  WorktreeCommandKind,
  WorktreeCommandKind as WorkspaceCommandKind,
  WorktreeRuntimeControlTarget,
  WorktreeRuntimeControlTarget as WorkspaceRuntimeControlTarget,
  WorktreeRuntimeService,
  WorktreeRuntimeService as WorkspaceRuntimeService,
  WorktreeRuntimeServiceStateMap,
  WorktreeRuntimeServiceStateMap as WorkspaceRuntimeServiceStateMap,
  WorktreeOperation,
  WorktreeOperation as WorkspaceOperation,
  WorktreeOperationPhase,
  WorktreeOperationPhase as WorkspaceOperationPhase,
  WorktreeOperationStatus,
  WorktreeOperationStatus as WorkspaceOperationStatus,
  WorktreeLoginHandoffTicketResponse,
  WorktreeLoginHandoffTicketResponse as WorkspaceLoginHandoffTicketResponse,
  WorktreeReadiness,
  WorktreeReadiness as WorkspaceReadiness,
  WorktreeReadinessProbeResult,
  WorktreeReadinessProbeResult as WorkspaceReadinessProbeResult,
  WorktreeReadinessState,
  WorktreeReadinessState as WorkspaceReadinessState,
  WorktreeSeedReadinessState,
  WorktreeSeedReadinessState as WorkspaceSeedReadinessState,
  NormalizedWorktreeFileAvailabilityQuery,
  NormalizedWorktreeFileAvailabilityQuery as NormalizedWorkspaceFileAvailabilityQuery,
  WorktreeFileAvailabilityQuery,
  WorktreeFileAvailabilityQuery as WorkspaceFileAvailabilityQuery,
  WorktreeFileAvailabilityRequest,
  WorktreeFileAvailabilityRequest as WorkspaceFileAvailabilityRequest,
  WorktreeFileAvailabilityResponse,
  WorktreeFileAvailabilityResponse as WorkspaceFileAvailabilityResponse,
  WorktreeFileAvailabilityResult,
  WorktreeFileAvailabilityResult as WorkspaceFileAvailabilityResult,
  WorktreeFileContent,
  WorktreeFileContent as WorkspaceFileContent,
  WorktreeFileContentEncoding,
  WorktreeFileContentEncoding as WorkspaceFileContentEncoding,
  WorktreeFileListDirectoryItem,
  WorktreeFileListDirectoryItem as WorkspaceFileListDirectoryItem,
  WorktreeFileListFileItem,
  WorktreeFileListFileItem as WorkspaceFileListFileItem,
  WorktreeFileListItem,
  WorktreeFileListItem as WorkspaceFileListItem,
  WorktreeFileListMode,
  WorktreeFileListMode as WorkspaceFileListMode,
  WorktreeFileListResponse,
  WorktreeFileListResponse as WorkspaceFileListResponse,
  WorktreeFilePreviewKind,
  WorktreeFilePreviewKind as WorkspaceFilePreviewKind,
  WorktreeFileRef,
  WorktreeFileRef as WorkspaceFileRef,
  WorktreeFileResourceKind,
  WorktreeFileResourceKind as WorkspaceFileResourceKind,
  WorktreeFileSelector,
  WorktreeFileSelector as WorkspaceFileSelector,
  WorktreeFileWorktreeKind,
  WorktreeFileWorktreeKind as WorkspaceFileWorkspaceKind,
  ResolvedWorktreeResource,
  ResolvedWorktreeResource as ResolvedWorkspaceResource,
  WorktreeRuntimeDesiredState,
  WorktreeRuntimeDesiredState as WorkspaceRuntimeDesiredState,
  WorktreeRealizationRecord,
  WorktreeRealizationRecord as WorkspaceRealizationRecord,
  WorktreeRealizationRequest,
  WorktreeRealizationRequest as WorkspaceRealizationRequest,
  ExecutionWorktreeStrategyType,
  ExecutionWorktreeStrategyType as ExecutionWorkspaceStrategyType,
  ExecutionWorktreeMode,
  ExecutionWorktreeMode as ExecutionWorkspaceMode,
  SharedWorktreeConcurrency,
  SharedWorktreeConcurrency as SharedWorkspaceConcurrency,
  ExecutionWorktreeProviderType,
  ExecutionWorktreeProviderType as ExecutionWorkspaceProviderType,
  ExecutionWorktreeStatus,
  ExecutionWorktreeStatus as ExecutionWorkspaceStatus,
  ExecutionWorktreeStrategy,
  ExecutionWorktreeStrategy as ExecutionWorkspaceStrategy,
  ProjectExecutionWorktreePolicy,
  ProjectExecutionWorktreePolicy as ProjectExecutionWorkspacePolicy,
  ProjectExecutionWorktreeDefaultMode,
  ProjectExecutionWorktreeDefaultMode as ProjectExecutionWorkspaceDefaultMode,
  IssueExecutionWorktreeSettings,
  IssueExecutionWorktreeSettings as IssueExecutionWorkspaceSettings,
  IssueWorkProduct,
  ...
  GitWorktreeBranchAncestryVerdict as GitWorkspaceBranchAncestryVerdict,
  GitWorktreeBranchIncoherenceEvidence,
  GitWorktreeBranchIncoherenceEvidence as GitWorkspaceBranchIncoherenceEvidence,
  GitWorktreeInProgressOperation,
  GitWorktreeInProgressOperation as GitWorkspaceInProgressOperation,
  HeartbeatRun,
  HeartbeatRunEvent,
  ...
  CompanyPortabilityProjectWorktreeManifestEntry,
  CompanyPortabilityProjectWorktreeManifestEntry as CompanyPortabilityProjectWorkspaceManifestEntry,
...
export {
  ...
  listWorktreeCommandDefinitions as listWorkspaceCommandDefinitions,
  listWorktreeServiceCommandDefinitions,
  listWorktreeServiceCommandDefinitions as listWorkspaceServiceCommandDefinitions,
...
export {
  getClosedIsolatedExecutionWorktreeMessage,
...
export {
  ...
  createProjectSchema,
  updateProjectSchema,
  createProjectWorktreeSchema,
  createProjectWorktreeSchema as createProjectWorkspaceSchema,
  updateProjectWorktreeSchema,
  updateProjectWorktreeSchema as updateProjectWorkspaceSchema,
  type CreateProject,
  type UpdateProject,
  type CreateProjectWorktree,
  type CreateProjectWorktree as CreateProjectWorkspace,
  type UpdateProjectWorktree,
  type UpdateProjectWorktree as UpdateProjectWorkspace,
  projectExecutionWorktreePolicySchema,
  projectExecutionWorktreePolicySchema as projectExecutionWorkspacePolicySchema,
  ...
  issueExecutionWorktreeSettingsSchema as issueExecutionWorkspaceSettingsSchema,
  checkoutIssueSchema,
  ...
  reconcileExecutionWorktreeBranchSchema,
  reconcileExecutionWorktreeBranchSchema as reconcileExecutionWorkspaceBranchSchema,
  updateExecutionWorktreeSchema,
  updateExecutionWorktreeSchema as updateExecutionWorkspaceSchema,
  worktreeOverviewQuerySchema,
  worktreeOverviewQuerySchema as workspaceOverviewQuerySchema,
  executionWorktreeDeliveryStateSchema,
  executionWorktreeDeliveryStateSchema as executionWorkspaceDeliveryStateSchema,
  executionWorktreeStatusSchema,
  executionWorktreeStatusSchema as executionWorkspaceStatusSchema,
  executionWorktreeCloseActionKindSchema,
  executionWorktreeCloseActionKindSchema as executionWorkspaceCloseActionKindSchema,
  executionWorktreeCloseActionSchema,
  executionWorktreeCloseActionSchema as executionWorkspaceCloseActionSchema,
  executionWorktreeCloseGitReadinessSchema,
  executionWorktreeCloseGitReadinessSchema as executionWorkspaceCloseGitReadinessSchema,
  executionWorktreeCloseLinkedIssueSchema,
  executionWorktreeCloseLinkedIssueSchema as executionWorkspaceCloseLinkedIssueSchema,
  executionWorktreeCloseReadinessSchema,
  executionWorktreeCloseReadinessSchema as executionWorkspaceCloseReadinessSchema,
  executionWorktreeCloseReadinessStateSchema,
  executionWorktreeCloseReadinessStateSchema as executionWorkspaceCloseReadinessStateSchema,
  resolvedWorktreeResourceSchema,
  resolvedWorktreeResourceSchema as resolvedWorkspaceResourceSchema,
  worktreeFileContentSchema,
  worktreeFileContentSchema as workspaceFileContentSchema,
  worktreeFileListModeSchema,
  worktreeFileListModeSchema as workspaceFileListModeSchema,
  worktreeFileListQuerySchema,
  worktreeFileListQuerySchema as workspaceFileListQuerySchema,
  worktreeFilePreviewKindSchema,
  worktreeFilePreviewKindSchema as workspaceFilePreviewKindSchema,
  worktreeFileRefSchema,
  worktreeFileRefSchema as workspaceFileRefSchema,
  worktreeFileResourceKindSchema,
  worktreeFileResourceKindSchema as workspaceFileResourceKindSchema,
  worktreeFileResourceQuerySchema,
  worktreeFileResourceQuerySchema as workspaceFileResourceQuerySchema,
  worktreeFileSelectorSchema,
  worktreeFileSelectorSchema as workspaceFileSelectorSchema,
  worktreeFileWorktreeKindSchema,
  worktreeFileWorktreeKindSchema as workspaceFileWorkspaceKindSchema,
  ...
  type ReconcileExecutionWorktreeBranch as ReconcileExecutionWorkspaceBranch,
  type UpdateExecutionWorktree,
  type UpdateExecutionWorktree as UpdateExecutionWorkspace,
  type WorktreeOverviewQuery,
  type WorktreeOverviewQuery as WorkspaceOverviewQuery,
  normalizedWorktreeFileAvailabilityQuerySchema,
  normalizedWorktreeFileAvailabilityQuerySchema as normalizedWorkspaceFileAvailabilityQuerySchema,
  worktreeFileAvailabilityRequestSchema,
  worktreeFileAvailabilityRequestSchema as workspaceFileAvailabilityRequestSchema,
  worktreeFileAvailabilityResponseSchema,
  worktreeFileAvailabilityResponseSchema as workspaceFileAvailabilityResponseSchema,
  worktreeFileAvailabilityResultSchema,
  worktreeFileAvailabilityResultSchema as workspaceFileAvailabilityResultSchema,
  type WorktreeFileAvailabilityRequestInput,
  type WorktreeFileAvailabilityRequestInput as WorkspaceFileAvailabilityRequestInput,
  type WorktreeFileListQuery,
  type WorktreeFileListQuery as WorkspaceFileListQuery,
  type WorktreeFileResourceQuery,
  type WorktreeFileResourceQuery as WorkspaceFileResourceQuery,
...
export { LEGACY_WORKSPACE_WIRE, LEGACY_WORKSPACE_ENV_KEYS } from "./legacy-wire/workspaces.js";
