...
export const crewbriefEnvSchema = z.object({
  ...
  CREWBRIEF_POSTHOG_HOST: z.string().default("https://app.posthog.com").optional(),
  CREWBRIEF_UMAMI_URL: z.string().default("http://127.0.0.1:3456"),
  CREWBRIEF_UMAMI_WEBSITE_ID: z.string().default("e69396ab-6b76-4d2b-8e4a-778337f8bca4"),
