...
const strandedRecoveryOwnerAgentIdSchema = z.string().guid().nullable().optional();
const workProductsRootSchema = z.string().min(1).nullable().optional();
...
export const updateCompanySchema = objectWithoutDefaults(
  createCompanySchema
    ...
    .extend({
      ...
      workProductsRoot: workProductsRootSchema,
