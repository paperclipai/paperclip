...
export const instanceExperimentalSettingsSchema = z.object({
  ...
  productivityReviewNoCommentStreakRuns: z
    .number()
    .int()
    .min(MIN_PRODUCTIVITY_REVIEW_NO_COMMENT_STREAK_RUNS)
    .max(MAX_PRODUCTIVITY_REVIEW_NO_COMMENT_STREAK_RUNS)
    .default(DEFAULT_PRODUCTIVITY_REVIEW_NO_COMMENT_STREAK_RUNS),
}).strict();
