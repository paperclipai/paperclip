...
const createIssueBaseSchema = z.object({
  ...
  workItemType: z.enum(ISSUE_WORK_ITEM_TYPES).optional().default("ai_task"),
...
type CreateChildIssueSchemaOutput = Omit<
  z.output<typeof createIssueBaseSchema>,
  "parentId" | "inheritExecutionWorkspaceFromIssueId" | "watchdogDiscovery"
> & {
  acceptanceCriteria?: string[];
  blockParentUntilDone: boolean;
};

export const createChildIssueSchema: z.ZodType<CreateChildIssueSchemaOutput, z.ZodTypeDef, unknown> = withCreateIssueStatusDefault(createIssueBaseSchema
  .omit({
    parentId: true,
...
type CreateAcceptedPlanDecompositionSchemaOutput = {
  acceptedPlanRevisionId: string;
  children: CreateChildIssueSchemaOutput[];
};

export const createAcceptedPlanDecompositionSchema: z.ZodType<
  CreateAcceptedPlanDecompositionSchemaOutput,
  z.ZodTypeDef,
  unknown
> = z.object({
