...
const createIssueBaseSchema = z.object({
  ...
  reviewBy: z.coerce.date().optional().nullable(),
  estimatedReviewMinutes: z.number().int().min(1).max(8 * 60).optional().nullable(),
...
export const suggestedTaskDraftSchema = z.object({
  ...
  neededAt: z.coerce.date().nullable().optional(),
  reviewBy: z.coerce.date().nullable().optional(),
