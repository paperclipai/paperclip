...
export const workspaceRuntimeServiceSchema = z.object({
  ...
  actualState: z.enum(["provisioning", "starting", "running", "stopped", "failed"]),
  desiredState: z.enum(["running", "stopped", "manual"]).nullable(),
  ...
  workspaceCommandId: z.string().nullable().optional(),
  latestFailure: z.object({
    operationId: z.string().uuid(),
    operationLogPath: z.string(),
    code: z.string(),
    message: z.string(),
    remediation: z.string(),
    details: z.object({
      port: z.number().int().optional(),
      attemptedPortCount: z.number().int().nonnegative().optional(),
      conflictingExecutionWorkspaceId: z.string().uuid().optional(),
      conflictingProjectWorkspaceId: z.string().uuid().optional(),
    }).strict().nullable(),
