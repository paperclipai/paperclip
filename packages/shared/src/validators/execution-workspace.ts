...
export const workspaceRuntimeServiceSchema = z.object({
  ...
  lastControlledByAgentId: z.string().uuid().nullable(),
  lastControlledByUserId: z.string().nullable(),
  lastControlledByRunId: z.string().uuid().nullable(),
  lastControlledAt: z.coerce.date().nullable(),
