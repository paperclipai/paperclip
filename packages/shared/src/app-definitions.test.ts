...
describe("AppDefinition catalog",()=>{
 ...
 it("contains thirteen reviewed providers",()=>expect(APP_DEFINITIONS.map((app)=>app.slug)).toEqual(["zapier","github","slack","notion","linear","google-sheets","context7","composio","oauth-generic","api-key-generic","sentry","vercel","anthropic"]));
