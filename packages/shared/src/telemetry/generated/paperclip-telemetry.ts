...
resolution_reason?: ("accepted" | "rejected" | "stale_target" | "superseded_by_comment" | "superseded_by_interaction" | "expired" | "cancelled" | "other")
...
export const PAPERCLIP_ENUM_DESCRIPTIONS = {
  ...
  "interaction.resolved": {
    ...
    "resolution_reason": {
      ...
      "superseded_by_interaction": "A newer decision-surface interaction displaced the pending one on the same issue.",
