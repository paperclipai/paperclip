...
export interface IssueExternalWait {
  owner: string;
  action: string;
  nextCheckAt: string;
  monitorOwner: string;
...
export interface IssueExecutionPolicy {
  ...
  externalWait?: IssueExternalWait | null;
...
export interface AskUserQuestionsResult {
  ...
  expirationReason?: "superseded_by_comment" | "stale_issue_state" | "superseded_by_newer_interaction";
...
export interface RequestItemVerdictsResult {
  version: 1;
  outcome: "resolved" | "superseded_by_comment" | "stale_target" | "stale_issue_state" | "cancelled" | "withdrawn" | "issue_closed" | "addressee_deleted";
  reason?: string | null;
  complete: boolean;
