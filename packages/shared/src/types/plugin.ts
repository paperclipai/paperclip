...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AiTeamCorpPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the AiTeamCorp host.
 *
...
export interface AiTeamCorpPluginManifestV1 {
   ...
   */
  minimumAiTeamCorpVersion?: PluginMinimumHostVersion;
