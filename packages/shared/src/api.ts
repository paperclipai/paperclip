...
export const API = {
  ...
  channelRead: `${API_PREFIX}/companies/:companyId/channels/:channelId/read`,
  channelMember: `${API_PREFIX}/companies/:companyId/channels/:channelId/member`,
  channelMessageThread: `${API_PREFIX}/companies/:companyId/channels/:channelId/messages/:messageId/thread`,
  channelMessageIssue: `${API_PREFIX}/companies/:companyId/channels/:channelId/messages/:messageId/issue`,
