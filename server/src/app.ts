...
import { issueRunRoutes } from "./routes/issue-runs.js";
import { mcDispatchFallbackRoutes } from "./routes/mc-dispatch-fallback.js";
...
export async function createApp(
  ...
  api.use(issueRunRoutes(db));
  api.use(mcDispatchFallbackRoutes(db));
