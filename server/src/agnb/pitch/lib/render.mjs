...
import {
  industryHero, allIntegrationLogos, brandAsset, assetUrl
} from "./finn-data.mjs";
...
function shotPanel(file) {
  ...
  return `<div class="visual shot" style="width:${frameW}px;height:${frameH}px;">
    <iframe class="snap" style="width:${frameW}px;height:${frameH}px;" src="${assetUrl("snaps/" + file)}" scrolling="no" loading="lazy"></iframe>
  </div>`;
}
