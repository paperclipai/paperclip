...
export type CreateLocalAgentJwtOptions = {
  access?: "read_only";
...
export function createLocalAgentJwt(
  ...
  adapterType: string,
  runId: string,
  responsibleUserIdOrOptions?: string | CreateLocalAgentJwtOptions | null,
  ...
  const options =
    typeof responsibleUserIdOrOptions === "object" && responsibleUserIdOrOptions !== null
      ? responsibleUserIdOrOptions
      : {};
  const responsibleUserId =
    typeof responsibleUserIdOrOptions === "string"
      ? responsibleUserIdOrOptions
      : options.responsibleUserId;
  const resolvedKeyScope = options.keyScope ?? keyScope;
  ...
  const claims: LocalAgentJwtClaims = {
    ...
    ...(resolvedKeyScope.kind === "standard" ? {} : { key_scope: resolvedKeyScope }),
    iat: now,
