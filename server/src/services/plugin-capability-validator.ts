...
const OPERATION_CAPABILITIES: Record<string, readonly PluginCapability[]> = {
  ...
  "issue.interactions.accept": ["issue.interactions.resolve"],
  "issue.interactions.reject": ["issue.interactions.resolve"],
  "issue.interactions.respond": ["issue.interactions.resolve"],
