...
const ACTIVITY_ACTION_TO_PLUGIN_EVENT: Readonly<Record<string, PluginEventType>> = {
  ...
  issue_thread_interaction_accepted: "issue.thread_interaction.accepted",
  issue_thread_interaction_rejected: "issue.thread_interaction.rejected",
  issue_thread_interaction_answered: "issue.thread_interaction.answered",
  issue_thread_interaction_cancelled: "issue.thread_interaction.cancelled",
  issue_thread_interaction_expired: "issue.thread_interaction.expired",
