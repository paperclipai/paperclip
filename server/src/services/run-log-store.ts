...
import { resolveOdysseusInstanceRoot } from "../home-paths.js";
...
export function getRunLogStore() {
  ...
  const basePath = process.env.RUN_LOG_BASE_PATH ?? path.resolve(resolveOdysseusInstanceRoot(), "data", "run-logs");
