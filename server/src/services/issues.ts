...
const issueListSelect = {
  ...
  workflowRole: issues.workflowRole,
  reviewAgentId: issues.reviewAgentId,
  qaAgentId: issues.qaAgentId,
  sourceIssueId: issues.sourceIssueId,
  completionRequires: issues.completionRequires,
