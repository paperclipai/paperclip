...
describe("issueThreadInteractionService", () => {
  ...
  it("requires capability preflight proof when a factory agent pauses for a user decision", async () => {
    const { assertFactoryInteractionCapabilityPreflight } = await import("./issue-thread-interactions.js");
    const executionPolicy = {
      ...
      factory: {
        ...
        controlIssueId: "11111111-1111-4111-8111-111111111111",
        coordinator: { type: "agent", agentId: "22222222-2222-4222-8222-222222222222" },
    ...
    const interaction = {
      ...
      payload: { version: 1, prompt: "May I stop here?", allowDeclineReason: true },
    } as const;

    expect(() => assertFactoryInteractionCapabilityPreflight({
      executionPolicy,
      interaction,
      actor: { agentId: "33333333-3333-4333-8333-333333333333" },
    })).toThrowError(expect.objectContaining({
      status: 422,
      details: expect.objectContaining({ code: "capability_preflight_required" }),
    }));
    ...
    expect(() => assertFactoryInteractionCapabilityPreflight({
      ...
      interaction: {
        ...
        payload: {
          ...
          capabilityPreflight: {
            version: 1,
            reasonKind: "policy_approval",
            checks: [{
              capability: "production approval",
              status: "not_applicable",
              evidence: "Company policy reserves final production authorization for the board.",
            }],
            alternativesConsidered: ["Complete all non-production verification first."],
            minimumDecision: "Approve or reject production deployment.",
          },
        },
      },
      actor: { agentId: "33333333-3333-4333-8333-333333333333" },
        ...
        factory: {
          ...
          policySnapshot: {
            ...
            productionAuthority: {
              ...
              requireCapabilityPreflightBeforeEscalation: false,
