  ...
  return {
    ...
    create: async (
      ...
      input: {
        ...
        value?: string | null;
        key?: string | null;
        managedMode?: "valadrien_os_managed" | "external_reference";
        description?: string | null;
      ...
      const managedMode = input.managedMode ?? "valadrien_os_managed";
      ...
      if (managedMode === "valadrien_os_managed" && input.externalRef?.trim()) {
        throw unprocessable("Managed secrets cannot override externalRef");
      }
      if (managedMode === "valadrien_os_managed" && !input.value?.trim()) {
      ...
      try {
        ...
        if (managedMode === "valadrien_os_managed") {
    ...
    update: async (
      ...
      if (deleting && secret.managedMode === "valadrien_os_managed") {
      ...
      if (
        secret.managedMode === "valadrien_os_managed" &&
        patch.providerConfigId !== undefined &&
        patch.providerConfigId !== secret.providerConfigId
      ) {
        throw unprocessable(
