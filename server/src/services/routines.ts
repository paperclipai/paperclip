...
function routineRevisionSnapshotRoutine(routine: RoutineRow): RoutineRevisionSnapshotV1["routine"] {
  return {
    ...
    expectedChildCount: routine.expectedChildCount,
      ...
      return db.transaction(async (tx) => {
        ...
        const [created] = await txDb
          ...
          .values({
            ...
            expectedChildCount: input.expectedChildCount ?? null,
            variables,
            createdByAgentId: actor.agentId ?? null,
            createdByUserId: actor.userId ?? null,
    ...
    update: async (id: string, patch: UpdateRoutine, actor: Actor): Promise<Routine | null> => {
      ...
      return db.transaction(async (tx) => {
        ...
        const candidate: RoutineRow = {
          ...
          expectedChildCount: patch.expectedChildCount === undefined ? locked.expectedChildCount : patch.expectedChildCount,
        ...
        const [updated] = await txDb
          ...
          .set({
            ...
            expectedChildCount: candidate.expectedChildCount,
      ...
      return db.transaction(async (tx) => {
        ...
        const [restoredRoutine] = await txDb
          ...
          .set({
            ...
            expectedChildCount: routineSnapshot.expectedChildCount,
