...
function routineRevisionSnapshotRoutine(routine: RoutineRow): RoutineRevisionSnapshotV1["routine"] {
  return {
    ...
    carryStateIssueId: routine.carryStateIssueId,
    title: routine.title,
      ...
      const createdRoutine = await db.transaction(async (tx) => {
        ...
        const [created] = await txDb
          ...
          .values({
            ...
            carryStateIssueId: input.carryStateIssueId ?? null,
            title: input.title,
    ...
    update: async (id: string, patch: UpdateRoutine, actor: Actor): Promise<Routine | null> => {
      ...
      const updatedRoutine = await db.transaction(async (tx) => {
        ...
        const candidate: RoutineRow = {
          ...
          carryStateIssueId: patch.carryStateIssueId === undefined ? locked.carryStateIssueId : patch.carryStateIssueId,
          title: nextTitle,
        ...
        const [updated] = await txDb
          ...
          .set({
            ...
            carryStateIssueId: candidate.carryStateIssueId,
      ...
      const result = await db.transaction(async (tx) => {
        ...
        const [restoredRoutine] = await txDb
          ...
          .set({
            ...
            carryStateIssueId: routineSnapshot.carryStateIssueId,
