...
const REPO_ONLY_CWD_SENTINEL = "/__odysseus_repo_only__";
      ...
      if (existingBinding) {
        ...
        if (existingProject) {
          ...
          return {
            ...
            project: project as import("@odysseus/shared").Project | null,
        ...
        return {
          ...
          project: hydrated as import("@odysseus/shared").Project | null,
          status: "relinked",
        };
      }
