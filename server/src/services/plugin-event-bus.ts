/**
 * PluginEventBus — typed in-process event bus for the AiTeamCorp plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@aiteamcorp/shared";
import type { PluginEvent, EventFilter } from "@aiteamcorp/plugin-sdk";
