/**
 * PluginEventBus — typed in-process event bus for the Odysseus plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@odysseus/shared";
import type { PluginEvent, EventFilter } from "@odysseus/plugin-sdk";
