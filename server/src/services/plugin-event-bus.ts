/**
 * PluginEventBus — typed in-process event bus for the ValadrienOs plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@valadrien-os/shared";
import type { PluginEvent, EventFilter } from "@valadrien-os/plugin-sdk";
