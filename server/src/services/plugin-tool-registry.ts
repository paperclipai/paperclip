...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@valadrien-os/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ValadrienOsPluginManifestV1, pluginDbId?: string): void;
