...
export const runnerApiReference: Record<string, { section: string; description?: string; examples?: { body: unknown }[] }> = {
    ...
    "examples": [
      {
        "body": {
          "status": "done",
          "comment": "Fixed sliding window calc. Was using wall-clock instead of monotonic time."
        }
      }
    ]
  },
    ...
    "examples": [
      {
        "body": {
          "status": "done",
          "comment": "QA signoff complete. Verified the regression and test coverage."
        }
      },
      {
        "body": {
          "status": "in_progress",
          "comment": "Changes requested: add a regression test for the empty-state path."
        }
      }
    ]
  },
  "PATCH /api/issues/issue-55": {
    ...
    "examples": [
      {
        "body": {
          "assigneeAgentId": "dba-agent-1",
          "comment": "@DBAAgent Please review the migration in PR #38."
        }
      }
    ]
  },
    ...
    "examples": [
      {
        "body": {
          "status": "done",
          "comment": "Broke down into subtasks for caching layer and load testing."
        }
      }
    ]
  }
