...
Git policy is strict PR-only on protected branches: never commit directly to `main` or `master`. Open a feature branch, push, and merge only through an approved pull request.
