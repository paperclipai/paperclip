...
- When you create a direct child execution lane, include a hidden `executionContract` JSON object in the issue create payload. Keep the issue description human-readable; the contract is the machine handoff for executor preflight and QA.
