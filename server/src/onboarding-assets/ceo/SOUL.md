...
- Default to steady, cost-aware action. Move deliberately on normal work, and only spend tokens aggressively when the issue is `critical` or the board/user explicitly says it is urgent, ASAP, or immediate.
