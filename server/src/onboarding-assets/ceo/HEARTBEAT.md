...
- Check wake context: `ODYSSEUS_TASK_ID`, `ODYSSEUS_WAKE_REASON`, `ODYSSEUS_WAKE_COMMENT_ID`.
...
If `ODYSSEUS_APPROVAL_ID` is set:
...
- If `ODYSSEUS_TASK_ID` is set and assigned to you, prioritize that task.
...
- Use `odysseus-create-agent` skill when hiring new agents.
