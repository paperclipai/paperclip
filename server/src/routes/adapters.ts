 ...
 * toggle server-side adapter code for the whole Odysseus instance.
 *
...
interface AdapterInstallRequest {
  /** npm package name (e.g., "droid-odysseus-adapter") or local path */
  packageName: string;
...
export function adapterRoutes() {
  ...
  // without modifying Odysseus's source code.
  //
