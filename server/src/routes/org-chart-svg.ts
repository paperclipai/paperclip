/**
 * Server-side SVG renderer for RealTycoon2 org charts.
...
// RealTycoon2 logo: scaled icon (~16px) + wordmark (13px), vertically centered
const RT2_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="12" font-weight="600" fill="currentColor">RealTycoon2</text>
</g>`;
...
export function renderOrgChartSvg(orgTree: OrgNode[], style: OrgChartStyle = "warmth", overlay?: OrgChartOverlay): string {
  ...
  const logoX = TARGET_W - 135 - LOGO_PADDING;
