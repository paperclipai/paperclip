...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@paperclipai_dld/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@paperclipai_dld/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@paperclipai_dld/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@paperclipai_dld/plugin-hello-world-example",
  ...
  {
    packageName: "@paperclipai_dld/plugin-file-browser-example",
  ...
  {
    packageName: "@paperclipai_dld/plugin-kitchen-sink-example",
