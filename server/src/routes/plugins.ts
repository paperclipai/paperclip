...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  ...
  {
    packageName: "@paperclipai/plugin-google-drive-context-example",
    pluginKey: "paperclip.google-drive-context-example",
    displayName: "Google Drive Context (Example)",
    description: "Example connector that syncs Google Docs, Sheets, Slides, files, and folders into project context sources.",
    localPath: "packages/plugins/examples/plugin-google-drive-context-example",
    tag: "example",
  },
];
