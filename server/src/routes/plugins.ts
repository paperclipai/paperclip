...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@ironworksai/db";
import type {
  PluginStatus,
...
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@ironworksai/plugin-sdk";
...
type PluginLauncherDeclaration = NonNullable<IronworksPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @ironworks/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@ironworksai/plugin-hello-world-example",
    pluginKey: "ironworks.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the Ironworks dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@ironworksai/plugin-file-browser-example",
    pluginKey: "ironworks-file-browser-example",
  ...
  {
    packageName: "@ironworksai/plugin-kitchen-sink-example",
    pluginKey: "ironworks-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current Ironworks plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "ironworks.claude-usage",
