...
registry.registerPath({
  ...
  responses: {
    200: r.ok(z.object({
      ...
      runtime: z.object({
        runtimeRole: z.enum(["primary", "api-only", "scheduler-only", "staged"]),
        heartbeatSchedulerEnabled: z.boolean(),
        routineSchedulerEnabled: z.boolean(),
        pluginSchedulerEnabled: z.boolean(),
        pluginWorkersEnabled: z.boolean(),
        pluginAutoInstallEnabled: z.boolean(),
        databaseBackupSchedulerEnabled: z.boolean(),
        startupRecoveryEnabled: z.boolean(),
        startupReconciliationEnabled: z.boolean(),
        migrationMode: z.enum(["apply", "refuse"]),
      }).optional(),
