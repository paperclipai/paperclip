        ...
        companyIds.map((companyId) =>
          logActivity(db, {
            ...
            details: {
              ...
              boardEscalationsCreated: result.boardEscalationsCreated,
              existingBoardEscalations: result.existingBoardEscalations,
              skippedOutsideLookback: result.skippedOutsideLookback,
              escalationIssueIds: result.escalationIssueIds,
              boardInteractionIds: result.boardInteractionIds,
            },
          }),
        ),
      );
