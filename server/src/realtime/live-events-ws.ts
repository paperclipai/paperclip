...
import { agentApiKeys, companyMemberships, instanceUserRoles } from "@odysseus/db";
...
interface IncomingMessageWithContext extends IncomingMessage {
  odysseusUpgradeContext?: UpgradeContext;
}
...
export function setupLiveEventsWebSocketServer(
  ...
  wss.on("connection", (socket: WsSocket, req: IncomingMessage) => {
    const context = (req as IncomingMessageWithContext).odysseusUpgradeContext;
    if (!context) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    void authorizeUpgrade(db, req, companyId, url, {
      ...
      .then((context) => {
        ...
        reqWithContext.odysseusUpgradeContext = context;
