...
import * as serverUtils from "@odysseus/adapter-utils/server-utils";
export type { RunProcessResult } from "@odysseus/adapter-utils/server-utils";
...
export const buildOdysseusEnv = serverUtils.buildOdysseusEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "ODYSSEUS_RESOLVED_COMMAND"] =
