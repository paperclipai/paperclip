...
import { estateRoutes, type S3VaultClient } from "../routes/estate.js";
...
function createApp(db: Db, s3VaultClient?: S3VaultClient | null) {
  const app = express();
  ...
  app.use(estateRoutes(db, undefined, s3VaultClient));
