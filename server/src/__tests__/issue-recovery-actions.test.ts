...
describeEmbeddedPostgres("issue recovery actions", () => {
  ...
  it("cancels a routine execution lost to transient infrastructure instead of blocking it", async () => {
    ...
    expect(updatedRun?.failureReason).toContain("acpx_turn_failed");
