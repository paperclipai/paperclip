...
import { models as openCodeFallbackModels } from "@odysseus/adapter-opencode-local";
...
function registerModuleMocks() {
  vi.doMock("@odysseus/adapter-opencode-local/server", async () => {
    const actual = await vi.importActual<typeof import("@odysseus/adapter-opencode-local/server")>("@odysseus/adapter-opencode-local/server");
    return {
      ...actual,
