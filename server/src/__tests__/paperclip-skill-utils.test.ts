...
describe("paperclip skill utils", () => {
  ...
  it("removes stale maintainer-only symlinks from a shared skills home", async () => {
    ...
    await createDirectoryLink(runtimeSkill, path.join(skillsHome, "paperclip"));
    await createDirectoryLink(customSkill, path.join(skillsHome, "release-notes"));
    await createDirectoryLink(staleMaintainerSkill, path.join(skillsHome, "release"));
