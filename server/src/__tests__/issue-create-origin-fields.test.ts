...
// Partial-mock every service module (spread the actual exports, override the
// factories under test) so constants and helpers added to these modules later
// keep resolving without this test enumerating them.
function partialMock(modulePath: string, overrides: Record<string, unknown>) {
...
function registerRouteMocks() {
  partialMock("../services/access.js", {
    accessService: () => mockAccessService,
  });
  partialMock("../services/activity-log.js", {
    logActivity: mockLogActivity,
  });
  partialMock("../services/agents.js", {
    agentService: () => mockAgentService,
  });
  partialMock("../services/execution-workspaces.js", {
    executionWorkspaceService: () => mockExecutionWorkspaceService,
  });
  partialMock("../services/feedback.js", {
    feedbackService: () => mockFeedbackService,
  });
  partialMock("../services/heartbeat.js", {
    heartbeatService: () => mockHeartbeatService,
  });
  partialMock("../services/instance-settings.js", {
    instanceSettingsService: () => mockInstanceSettingsService,
  });
  partialMock("../services/issues.js", {
    issueService: () => mockIssueService,
  });
  partialMock("../services/routines.js", {
    routineService: () => mockRoutineService,
  });
  partialMock("../services/index.js", {
    companyService: () => ({
  ...
  partialMock("../services/external-objects.js", {
