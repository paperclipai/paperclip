...
describe("buildInviteOnboardingTextDocument", () => {
  it("renders a plain-text onboarding doc with expected endpoint references", () => {
    ...
    expect(text).toContain("Ironworks OpenClaw Gateway Onboarding");
    ...
    expect(text).toContain("Suggested Ironworks base URLs to try");
    ...
    expect(text).toContain("~/.openclaw/workspace/ironworks-claimed-api-key.json");
    expect(text).toContain("IRONWORKS_API_KEY");
