...
import { agents, companies, createDb, executionWorkspaces, issues, projectWorkspaces, projects } from "@paperclipai/db";
...
describeEmbeddedPostgres("workspace runtime service authz helper", () => {
  ...
  async function seedAgent(companyId: string, input: { role?: string; reportsTo?: string | null; name?: string } = {}) {
