...
describe("agent issue mutation checkout ownership", () => {
  ...
  it.each([{}, { assigneeId: "00000000-0000-0000-0000-000000000000" }])(
    "denies company-wide issue list routes for task bridge keys with query %j", async (query) => {
      ...
      const res = await request(app).get(`/api/companies/${companyId}/issues`).query(query);
