...
describe("buildPaperclipEnv", () => {
  ...
  it("keeps the primary runtime URL when discovery only yields loopback", () => {
    process.env.PAPERCLIP_RUNTIME_API_URL = "http://localhost:3100";
    process.env.PAPERCLIP_RUNTIME_API_CANDIDATES_JSON = JSON.stringify(["http://localhost:3100"]);
