...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local AiTeamCorp state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".aiteamcorp/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/aiteamcorp",
      ),
    ).toBe(false);
