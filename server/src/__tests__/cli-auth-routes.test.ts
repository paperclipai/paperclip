...
describe("cli auth routes", () => {
  ...
  it("lists bundled skills including optional approval and plugin helpers for board users", async () => {
  ...
  it("serves approval-gate skill markdown for board users", async () => {
    const app = await createApp({
      type: "board",
      userId: "user-1",
      source: "session",
