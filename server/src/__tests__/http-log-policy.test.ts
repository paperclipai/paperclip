...
describe("shouldSilenceHttpSuccessLog", () => {
  ...
  it("silences successful polling endpoints", () => {
    ...
    expect(
      shouldSilenceHttpSuccessLog("GET", "/api/companies/5cbe79ee-acb3-4597-896e-7662742593cd/heartbeat-runs", 200),
    ).toBe(true);
    expect(
    ...
    expect(
      shouldSilenceHttpSuccessLog("HEAD", "/api/companies/5cbe79ee-acb3-4597-896e-7662742593cd/sidebar-badges", 200),
    ).toBe(true);
    expect(
      shouldSilenceHttpSuccessLog(
        "GET",
    ...
    expect(
      shouldSilenceHttpSuccessLog("GET", "/api/companies/5cbe79ee-acb3-4597-896e-7662742593cd/activity", 200),
    ).toBe(true);
  });
