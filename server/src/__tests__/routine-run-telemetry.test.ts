...
vi.mock("@aiteamcorp/shared/telemetry", async () => {
  const actual = await vi.importActual<typeof import("@aiteamcorp/shared/telemetry")>(
    "@aiteamcorp/shared/telemetry",
  );
  return {
    ...actual,
...
describeEmbeddedPostgres("routine run telemetry", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("aiteamcorp-routine-telemetry-");
