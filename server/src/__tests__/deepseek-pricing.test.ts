...
import { DeepseekCaller } from "../../../packages/plugins/plugin-ck-office/src/meeting/llm.js";
...
describe("DeepseekCaller pricing", () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });

  it("prices v4-flash with separate cache-hit and cache-miss prompt tokens", async () => {
