...
import { printJcodeStreamEvent } from "@paperclipai/adapter-jcode-local/cli";
...
const jcodeLocalCLIAdapter: CLIAdapterModule = {
  type: "jcode_local",
  formatStdoutEvent: printJcodeStreamEvent,
};
