...
const BASE = process.env.AITEAMCORP_E2E_BASE_URL ?? "http://127.0.0.1:3105";
...
function createBootstrapInvite() {
  if (!DATA_DIR) {
    throw new Error("AITEAMCORP_E2E_DATA_DIR or AITEAMCORP_HOME is required for authenticated bootstrap tests");
  }
